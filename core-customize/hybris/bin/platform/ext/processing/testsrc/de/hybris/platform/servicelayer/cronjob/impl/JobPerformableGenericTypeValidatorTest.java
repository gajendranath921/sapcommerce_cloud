...
public class JobPerformableGenericTypeValidatorTest
{
	...
	public void testCronJobModelWithTheSameSpecificPerformable() throws InterceptorException
	{
		...
		{
			Assert.fail(
					"Validation for the CronJobModel where assigned performable BasePerformable is more specific type CronJobModel should  not fail ");
		}
	...
	public void testCronJobModelWithMoreSpecificPerformable() throws InterceptorException
	{
		...
		try
		{
			validator.onValidate(cronJob, interceptorContext);
			Assert.fail(
					"Validation for the CronJobModel where assigned performable AdvancedPerformable is more specific type AdvancedCronJobModel should  fail ");
		}
		catch (final InterceptorException e)
		{
			//fine here
	...
	public void testCronJobModelWithEvenMoreSpecificPerformable() throws InterceptorException
	{
		...
		try
		{
			validator.onValidate(cronJob, interceptorContext);
			Assert.fail(
					"Validation for the CronJobModel where assigned performable MoreAdvancedPerformable is more specific type AdvancedCronJobModel should  fail ");
		}
		catch (final InterceptorException e)
		{
			//fine here
	...
	public void testAdvancedCronJobModelWithLessSpecificPerformable() throws InterceptorException
	{
		...
		{
			Assert.fail(
					"Validation for the AdvancedCronJobModel where assigned performable BasePerformable is less specific type CronJobModel and should not fail ");
		}
	...
	public void testAdvancedCronJobModelWithTheSameSpecificPerformable() throws InterceptorException
	{
		...
		{
			Assert.fail(
					"Validation for the AdvancedCronJobModel where assigned performable AdvancedPerformable is less specific type AdvancedCronJobModel and should not fail ");
		}
	}
	...
	public void testAdvancedCronJobModelWithMoreSpecificPerformable() throws InterceptorException
	{
		...
		try
		{
			validator.onValidate(cronJob, interceptorContext);
			Assert.fail(
					"Validation for the AdvancedCronJobModel where assigned performable MoreAdvancedPerformable is less specific type MoreAdvancedCronJobModel and should  fail ");
		}
		catch (final InterceptorException e)
		{
			//ok here
	...
	public void testMoreAdvancedCronJobModelWithEvenLessSpecificPerformable() throws InterceptorException
	{
		...
		{
			Assert.fail(
					"Validation for the MoreAdvancedCronJobModel where assigned performable BasePerformable is less specific type CronJobModel and should not fail ");
		}
	...
	public void testMoreAdvancedCronJobModelWithLessSpecificPerformable() throws InterceptorException
	{
		...
		{
			Assert.fail(
					"Validation for the MoreAdvancedCronJobModel where assigned performable AdvancedPerformable is less specific type AdvancedCronJobModel and should not fail ");
		}
	...
	public void testMoreAdvancedCronJobModelWithTheSameSpecificPerformable() throws InterceptorException
	{
		...
		{
			Assert.fail(
					"Validation for the MoreAdvancedCronJobModel where assigned performable MoreAdvancedPerformable is less specific type MoreAdvancedCronJobModel and should not fail ");
		}
