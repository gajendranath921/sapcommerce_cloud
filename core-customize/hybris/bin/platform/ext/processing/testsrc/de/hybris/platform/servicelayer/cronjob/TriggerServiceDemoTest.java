...
public class TriggerServiceDemoTest extends ServicelayerBaseTest
{
	 ...
	 *
	 * @param parentJaloClass The Jalo class of the parent type.
	 * @param typeCode        Type code of the new type. Must be unique.
	 * @param jaloClass       The Jalo class of the new type.
	 * @return The new type instance.
	 * @throws JaloTypeException     Thrown if the code is not unique in the type system.
	 * @throws IllegalStateException If a type with the same type code and a different Jalo class already exists in the type system.
	 */
	 ...
	 * @param modelClass         Model class for the type.
	 * @param attributeQualifier Qualifier to identify the attribute.
	 * @param writable           New writable status.
