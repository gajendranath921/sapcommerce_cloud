...
public class DefaultTaskServiceIntegrationTest extends AbstractTaskTest
{
	...
	class TaskModelArgumentMatcher implements ArgumentMatcher<TaskModel>
	{
		...
		@Override
		public boolean matches(final TaskModel taskModel)
		{
			return taskModel.getPk().equals(expectedTask.getPk());
		}
	}
}
