...
public class ProcessActionTest extends HybrisJUnit4Test
{
	...
	public void setUp() throws Exception
	{
		...
		((AbstractApplicationContext) applicationContext).getBeanFactory()
		                                                 .registerSingleton(ACTION_BEANID, testProcessActionBean);
	...
	public void testProcessAction()
	{
		...
		assertEquals(actionModel,
				getProcessParameter(testProcessActionBean.process, ProcessActionExecutionStrategy.ACTION_PARAM));
		...
		assertEquals(actionModel,
				getProcessParameter(testProcessActionBean.process, ProcessActionExecutionStrategy.ACTION_PARAM));
		assertEquals(argument2,
				getProcessParameter(testProcessActionBean.process, ProcessActionExecutionStrategy.ARGUMENT_PARAM));
	...
	public void testErrorProcessAction() throws RetryLaterException
	{
		try
		{
			TestUtils.disableFileAnalyzer("Error process action test", 400);
