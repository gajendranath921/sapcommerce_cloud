...
public interface ClassificationClassesResolverStrategy
{
	 ...
	 *
	 * @param item the {@link ProductModel} for which all connected {@link ClassificationClassModel}s should be returned
	 ...
	 * {@link ClassificationSystemVersionModel}s.
	 *
	 * @param item the {@link CategoryModel} for which all connected {@link ClassificationClassModel}s should be returned
	 * @return a set with the found ClassificationClassModels or an empty set if nothing was found
	 */
	 ...
	 *
	 * @param item          the {@link ProductModel} for which all connected {@link ClassificationClassModel}s should be returned
	 * @param systemVersion the kind of the classification system
	 * @return a set with the found ClassificationClassModels or an empty set if nothing was found
	 */
	 ...
	 *
	 * @param item           the {@link ProductModel} for which all connected {@link ClassificationClassModel}s should be returned
	 * @param systemVersions a collection of classification systems
	 * @return a set with the found ClassificationClassModels or an empty set if nothing was found
	 */
	 ...
	 *
	 * @param classificationClasses if using the resolve methods of this service the set is a {@link LinkedHashSet}
