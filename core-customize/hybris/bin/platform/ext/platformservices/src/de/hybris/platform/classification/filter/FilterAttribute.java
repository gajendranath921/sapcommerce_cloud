...
public class FilterAttribute implements Comparable<FilterAttribute>
{
	 ...
	 *
	 * @param attributeAssignment the attribute assignment
	 * @param possibleValues      the possible values
	 */
	public FilterAttribute(final ClassAttributeAssignmentModel attributeAssignment,
	                       final List<FilterAttributeValue> possibleValues)
	{
		super();
