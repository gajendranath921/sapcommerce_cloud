...
public interface CategoryService
{
	 ...
	 * @throws IllegalArgumentException if the <code>catalogVersion</code> is <code>null</code>.
	 */
	Collection<CategoryModel> getRootCategoriesForCatalogVersion(CatalogVersionModel catalogVersion);

	/**
	 * @param code the code of the to be found {@link CategoryModel}
	 ...
	 * @throws de.hybris.platform.servicelayer.exceptions.UnknownIdentifierException   if no category with the specified code can be found.
	 * @throws de.hybris.platform.servicelayer.exceptions.AmbiguousIdentifierException if more than one category with the specified <code>code</code> and <code>catalogVersion</code> was
	 *                                                                                 found.
	 * @throws IllegalArgumentException                                                if parameter <code>code</code> is <code>null</code>.
	 */
	 ...
	 *
	 * @param catalogVersion the {@link CatalogVersionModel} where the returned category should be found
	 * @param code           the code of the {@link CategoryModel}
	 * @return the {@link CategoryModel} with the specified <code>code</code> and belonging to the
	 * {@link CatalogVersionModel}
	 * @throws de.hybris.platform.servicelayer.exceptions.UnknownIdentifierException   if no category with the specified code and catalogVersion can be found.
	 * @throws de.hybris.platform.servicelayer.exceptions.AmbiguousIdentifierException if more than one category with the specified <code>code</code> and <code>catalogVersion</code> was
	 *                                                                                 found.
	 * @throws IllegalArgumentException                                                if parameter <code>code</code> or <code>catalogVersion</code> is <code>null</code>.
	 */
	CategoryModel getCategoryForCode(CatalogVersionModel catalogVersion, String code);

	/**
	 * @param category the {@link CategoryModel}
	 * @return the first found path for this category
	 * @throws IllegalArgumentException if parameter <code>category</code> is <code>null</code>.
	 ...
	 * @param includeOnlyCategories classes which limits resulting path
	 ...
	 * @throws IllegalArgumentException                                                if parameter <code>category</code> is <code>null</code>.
	 * @throws de.hybris.platform.servicelayer.exceptions.AmbiguousIdentifierException if more than one path was found.
	 */
	 ...
	 *
	 * @param category the (sub){@link CategoryModel}
	 ...
	 *
	 * @param category      the category where the principals will be applied to
	 * @param newPrincipals the list with the new allowed principals of the category
	 * @throws IllegalArgumentException if parameter <code>category</code> is <code>null</code> or <code>newPrincipals</code> is
	 *                                  <code>null</code>.
	 ...
	 *
	 * @param category the category for which subcategories should be obtained
	 ...
	 *
	 * @param category the category for which supercategories should be obtained
