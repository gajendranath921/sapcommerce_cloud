...
public interface CatalogTypeService
{
	 ...
	 * aware.
	 *
	 * @param typeCode the typeCode of ComposedType
	 * @return <code>false</code> if the <code>typeCode</code> is not a catalog item type.
	 * @throws IllegalArgumentException                                              if the <code>typeCode</code> is null.
	 * @throws de.hybris.platform.servicelayer.exceptions.UnknownIdentifierException if the <code>typeCode</code> does not correspond to a valid type.
	 */
	 ...
	 *
	 * @param typeCode the typeCode of the target {@link ComposedTypeModel}
	 * @return the catalog version attribute qualifier
	 * @throws IllegalArgumentException                                                if <ul> <li>the <code>typeCode</code> is null <b>OR</b></li> <li>corresponding type has no catalog
	 *                                                                                 version container attribute</li> </ul>
	 * @throws de.hybris.platform.servicelayer.exceptions.AmbiguousIdentifierException - when more than one composed type for given <code>typeCode</code> is found.
	 * @throws de.hybris.platform.servicelayer.exceptions.UnknownIdentifierException   - when no composed type for given <code>typeCode</code> is found.
	 */
	 ...
	 *
	 * @param typeCode the ComposedType's code
	 ...
	 *
	 * @param version         the {@link CatalogVersionModel}
	 * @param typeCode        String typeCode of the {@link ComposedTypeModel}
	 * @param uniqueKeyValues a map with <b>ALL</b> unique catalog key attribute and their values to be searched for. Any non-unique
	 ...
	 *                                                                                 </ul>
	 * @throws de.hybris.platform.servicelayer.exceptions.UnknownIdentifierException   if:
	 *                                                                                 <ul>
	 *                                                                                 <li>the given <code>typeCode</code> does not correspond to a system type</li>
	 *                                                                                 </ul>
	 * @throws de.hybris.platform.servicelayer.exceptions.AmbiguousIdentifierException if:
	 *                                                                                 <ul>
	 *                                                                                 <li>the given <code>typeCode</code> corresponds to more than one system type</li>
	 *                                                                                 </ul>
	 * @throws CatalogAwareObjectResolvingException                                    if
	 ...
	 * </li>
	 *
	 * @param supertypesOnly if set to true only root types will be returned.
	 ...
	 *
	 * @param type target {@link ComposedTypeModel}
	 ...
	 *
	 * @param model the target item model
	 * @return boolean value
	 ...
	 * @param model the target item model
	 * @throws IllegalArgumentException if <code>model<code> is null
	 * @throws IllegalStateException    if <ul> <li>catalog version attribute was of unexpected type, or</li> <li>the model given is not
