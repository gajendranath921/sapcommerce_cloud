...
public interface CalculationService
{
	 ...
	 * @throws CalculationException if a pricefactory error occurred.
	 */
	 ...
	 *
	 * @param order target {@link AbstractOrderModel}
	 * @param date  assumes a given date to perform calculations for - be careful with that since this method will calculate
	 ...
	 *
	 * @param order target {@link AbstractOrderModel}
	 * @param date  the date to calculate prices for
	 * @throws CalculationException if a pricefactory error occurred
	 */
	 ...
	 *
	 * @param order       target {@link AbstractOrderModel}
	 * @param recalculate forces setting total even if order is marked as calculated
	 */
	 ...
	 * @param recalculate forces the recalculation of the abstract order entry.
	 */
