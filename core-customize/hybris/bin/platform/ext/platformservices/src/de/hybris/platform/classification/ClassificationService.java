...
public interface ClassificationService
{
	 ...
	 *
	 * @param product the product to load the features for
	 * @return the list of features
	 * @throws IllegalArgumentException thrown when <code>product</code> is null or is not persisted
	 */
	 ...
	 *
	 * @param item the item to load the features for
	 * @return the features
	 ...
	 *
	 * @param product the item to load the features for
	 * @return the features
	 * @throws IllegalArgumentException thrown when <code>product</code> is null or is not persisted, <code>assignment</code> is null
	 */
	 ...
	 * @throws UnknownIdentifierException   when a attribute with a given code cannot be found
	 * @throws AmbiguousIdentifierException when there's more than one attribute with a given code
	 */
	 ...
	 * @param featureList the FeatureList object
	 * @throws IllegalArgumentException thrown when <code>product</code> is null or is not persisted, <code>featureList</code> is null
	 */
	 ...
	 * @param featureList contains the features with new/changed feature values. Or features with the same feature values which
	 ...
	 * @throws IllegalArgumentException thrown when <code>product</code> is null or is not persisted, <code>feature</code> is null
	 */
	 ...
	 *
	 * @param systemVersion the system version of the classification
