...
public interface VariantsService
{
	 ...
	 *
	 * @param code the variant type code. Must exists in the system and must be not null.
	 * @return a VariantTypeModel for the given code.
	 * @throws de.hybris.platform.servicelayer.exceptions.UnknownIdentifierException if there is no VariantTypeModel for given code
	 * @throws IllegalArgumentException                                              if given <code>code</code> is null
	 */
	 ...
	 *
	 * @param variantProductType the variant type code. Must exists in the system and must be a variant type.
	 * @return an empty set if for the given <code>variantProductType</code> no variant attributes were found.
	 * @throws de.hybris.platform.servicelayer.exceptions.UnknownIdentifierException if the given <code>variantProductType</code> does not exists or is not a variant type
	 */
	 ...
	 * @throws de.hybris.platform.servicelayer.exceptions.SystemException if the attribute couldn't be read
	 */
	 ...
	 * @throws de.hybris.platform.servicelayer.exceptions.SystemException if the attribute couldn't be written
	 */
	 ...
	 *
	 * @param baseProduct the base product for all variants
	 ...
	 *
	 * @param baseProduct  the base product to get variants for
	 * @param filterValues the variant attribute values (attribute qualifier->value map) to match. if <code>null or empty</code> an
	 ...
	 *
	 * @param variantType   the variant type
	 * @param newAttributes the attributes which should be assigned
	 * @throws IllegalArgumentException if given variantType is new
	 */
