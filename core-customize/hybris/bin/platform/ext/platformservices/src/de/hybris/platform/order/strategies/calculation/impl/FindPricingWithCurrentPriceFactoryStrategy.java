		...
		FindDiscountValuesStrategy, FindTaxValuesStrategy, UserNetCheckingStrategy, ApplicationContextAware
{
	...
	{
		final Product productItem = getModelService().getSource(priceCriteria.getProduct()); 
	...
	private static final class ProductDateNet
	{
		...
		public ProductDateNet(final Product product, final Date date, final Boolean net) 
		{
			super();
