...
public interface ProductReferenceService
{
	 ...
	 *
	 * @param source        the source {@link ProductModel}
	 * @param referenceType the type of the reference - {@link ProductReferenceTypeEnum}. If this argument is
	 *                      <code>null<code>, the productReferences of all types will be returned.
	 * @param activeOnly    - if <code>true<code>, only active product references will be returned.
	 * @return a collection of {@link ProductReferenceModel}s or an empty list if there are no source references for the
	 * given product
	 * @throws IllegalArgumentException if <code>source<code> product is null.
	 */
	 ...
	 *
	 * @param target        the target {@link ProductModel}
	 * @param referenceType the type of the reference - {@link ProductReferenceTypeEnum}. If this argument is
	 *                      <code>null<code>, the productReferences of all types will be returned.
	 * @param activeOnly    - if <code>true<code>, only active product references will be returned.
	 * @return a collection of {@link ProductReferenceModel}s or empty list if there are no target references for the
	 * given product.
	 * @throws IllegalArgumentException if <code>target<code> product is null.
	 */
	 ...
	 * @throws IllegalArgumentException if either <code>source<code> or <code>target<code> product is null.
	 */
	 ...
	 * <p/>
	 *
	 * @param qualifier  the desired {@link ProductReferenceModel#QUALIFIER}. If this argument is
