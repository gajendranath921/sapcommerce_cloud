...
public final class CatalogUtils
{
	 ...
	 * @throws IllegalArgumentException if <code>catalogVersion<code> is null.
	 */
	 ...
	 *
	 * @param catalogVersions the collection with the catalog versions
	 * @return an empty string if the collection contains nothing.
	 * @throws IllegalArgumentException if <code>catalogVersions<code> is null.
	 */
