...
public interface OrderService extends AbstractOrderService<OrderModel, OrderEntryModel>
{
	 ...
	 * @throws InvalidCartException if the cart is invalid according to the used {@link CartValidator}.
	 */
	 ...
	 *
	 * @param cart            the {@link CartModel}
	 * @param deliveryAddress the delivery {@link AddressModel} for the current session user. Can be <code>null</code>.
	 * @param paymentAddress  the payment {@link AddressModel} for the current session user. Can be <code>null</code>.
	 * @param paymentInfo     the {@link PaymentInfoModel} for the current session user. Can be <code>null</code>.
	 ...
	 * @throws AmbiguousIdentifierException if there is already entry with the requested number.
