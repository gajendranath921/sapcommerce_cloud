...
public interface CloneAbstractOrderStrategy
{
	 ...
	 *
	 * @param orderType type of newly created order
	 * @param entryType type of order entry of newly created order
	 * @param original  original order
	 * @param code      code of created order
	 */
	<T extends AbstractOrderModel> T clone(ComposedTypeModel orderType, ComposedTypeModel entryType, AbstractOrderModel original,
	                                       String code, final Class abstractOrderClassResult,
	 ...
	 *
	 * @param entriesType type of cloned entries
	 * @param original    original abstractOrder
