...
public interface OrderDao
{
	 ...
	 *
	 * @param entryTypeCode - entries of this specific type will be searched. I.e 'OrderEntry', 'CartEntry'
	 * @param number        - requested entry number
	 ...
	 * @param entryTypeCode - entries of this specific type will be searched. I.e 'OrderEntry', 'CartEntry'
	 * @param order         - target order
	 * @param start         lower range limit
	 * @param end           upper range limit
	 * @return List of matching order entries, or {@link Collections#EMPTY_LIST} in case if no entries were found.
	 ...
	 *
	 * @param entryTypeCode - entries of this specific type will be searched. I.e 'OrderEntry', 'CartEntry'
	 * @param product       - requested {@link ProductModel}
	 * @param order         - target order
	 * @return List of matching order entries, or {@link Collections#EMPTY_LIST} in case if no entries were found.
	 ...
	 * @throws IllegalStateException    if currency is not persisted.
	 */
	 ...
	 *
	 * @param deliveryMode target {@link DeliveryModeModel}
	 * @return {@link List} of {@link AbstractOrderModel} - matched orders
	 * @throws IllegalArgumentException if deliveryMode is null
	 * @throws IllegalStateException    if deliveryMode is not persisted.
	 */
	 ...
	 *
	 * @param paymentMode target {@link PaymentModeModel}
	 * @return {@link List} of {@link AbstractOrderModel} - matched orders
	 * @throws IllegalArgumentException if paymentMode is null
	 * @throws IllegalStateException    if paymentMode is not persisted.
	 */
