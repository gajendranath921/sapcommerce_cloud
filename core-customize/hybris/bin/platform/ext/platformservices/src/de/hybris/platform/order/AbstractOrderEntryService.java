...
public interface AbstractOrderEntryService<E extends AbstractOrderEntryModel>
{
	 ...
	 *
	 * @param abstractOrder target order
	 ...
	 *
	 * @param abstractOrder target order
	 * @param entryType     create entry of this specific type
	 ...
	 * price.
	 *
	 * @param discountValue discount value to add
	 * @param entry         target {@link AbstractOrderEntryModel}
	 ...
	 *
	 * @param discountValue discount value to remove
	 * @param entry         target {@link AbstractOrderEntryModel}
	 * @throws IllegalArgumentException if either <code>order<code> or <code>discountValue<code> is null.
	 * @see CalculationService#calculate(AbstractOrderModel)
	 */
	 ...
	 *
	 * @param taxValue tax value to add
	 * @param entry    target {@link AbstractOrderEntryModel}
	 ...
	 *
	 * @param taxValue tax value to remove
	 * @param entry    target {@link AbstractOrderEntryModel}
	 * @throws IllegalArgumentException if either <code>order<code> or <code>taxValue<code> is null.
	 * @see CalculationService#calculate(AbstractOrderModel)
	 */
