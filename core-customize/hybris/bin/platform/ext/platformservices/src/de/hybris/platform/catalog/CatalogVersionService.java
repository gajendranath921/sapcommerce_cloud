...
public interface CatalogVersionService
{
	 ...
	 *
	 * @param catalogId          the id of the Catalog the CatalogVersion belongs to
	 * @param catalogVersionName the name of the Catalog version
	 * @throws de.hybris.platform.servicelayer.exceptions.UnknownIdentifierException if no CatalogVersion with the specified catalog id and version exists
	 * @throws AmbiguousIdentifierException                                          if more than one CatalogVersion is found with the specified catalog id and version
	 * @throws IllegalArgumentException                                              if <code>catalogId</code> or <code>catalogVersionName</code> is <code>null</code>
	 */
	 ...
	 *
	 * @param catalogVersions the catalogVersions to be set as active session CatalogVersions
	 * @throws IllegalArgumentException if catalogVersions is <code>null</code>
	 */
	 ...
	 *
	 * @param catalogVersion CatalogVersion to add
	 * @throws IllegalArgumentException if <code>catalogVersion</code> is <code>null</code>
	 */
	 ...
	 *
	 * @param catalogId          the id for the catalog
	 * @param catalogVersionName the version string for the catalog version
	 ...
	 *
	 * @param catalogId the Catalog id the CatalogVersion belongs to
	 ...
	 * @throws IllegalArgumentException     if <code>catalogId</code> is null
	 * @throws AmbiguousIdentifierException if more than one {@link CatalogVersionModel} can be found in the session with the specified
	 *                                      <code>catalogId</code>
	 */
	 ...
	 *
	 * @param catalogVersion target {@link CatalogVersionModel}
	 * @param user           target {@link UserModel}
	 */
	 ...
	 *
	 * @param <T> This could be a {@link ClassificationSystemVersionModel} or a {@link CatalogVersionModel}
	 * @return an empty collection if no {@link CatalogVersionModel}s or {@link ClassificationSystemVersionModel} were
	 * found.
	 * @throws IllegalArgumentException if <code>versionType</code> is <code>null</code>
	 */
