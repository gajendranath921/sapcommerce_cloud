...
public class ProductFilter
{
	 ...
	 *
	 * @param assignment the assigment of the attribute
	 ...
	 *
	 * @param attributeCode the code of the filter attribute
	 * @param value         the value of the filter attribute
	 * @see de.hybris.platform.classification.ClassificationService#getProductsByFilter(ProductFilter)
	 */
	 ...
	 *
	 * @param start the start index of the filter result
	 */
	 ...
	 *
	 * @param count the maximum amount of filered items
	 */
