...
public interface ProductService
{
	 ...
	 * @throws de.hybris.platform.servicelayer.exceptions.UnknownIdentifierException   if no Product with the specified code is found
	 * @throws de.hybris.platform.servicelayer.exceptions.AmbiguousIdentifierException if more than one Product with the specified code is found
	 * @throws IllegalArgumentException                                                if parameter code is <code>null</code>
	...
	/**
	 * @param catalogVersion the CatalogVersion of the Product
	 * @param code           the code of the Product
	 * @return the Product matching the specified code and CatalogVersion.
	 * @throws de.hybris.platform.servicelayer.exceptions.UnknownIdentifierException   if no Product with the specified code and Catalog is found.
	 * @throws de.hybris.platform.servicelayer.exceptions.AmbiguousIdentifierException if more than one Product with the specified code and Catalog is found
	 ...
	 *
	 * @param product the {@link ProductModel}
	 ...
	 * @throws de.hybris.platform.servicelayer.exceptions.ModelNotFoundException if no {@link UnitModel} was found for the given <code>product</code>
	 */
	 ...
	 * @throws IllegalArgumentException if parameter category is null
	...
	/**
	 * @param category the category the returned Products belong to
	 * @param start    index position of the first Product, which will be included in the returned List
	 * @param count    number of Products which will be returned in the List
	 ...
	 *
	 * @param catalogVersion the CatalogVersion of the Products
