...
public interface AddToCartStrategy
{
	 ...
	 *
	 * @param cart     the cart, must exist
	 * @param product  the product which is added to the cart
	 * @param quantity the quantity of the product
	 * @param unit     if <code>null</code> {@link ProductService#getOrderableUnit(ProductModel)} is used to determine the unit
	 * @throws InvalidCartException if the <code>product</code> is a base product OR the quantity is less 1 or no usable unit was found
