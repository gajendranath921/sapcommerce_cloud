...
public interface CatalogService
{
	 ...
	 * @param catalogVersionName the version of the Catalog version
	 ...
	 * system
	 *
	 * @param <T> This could be a {@link ClassificationSystemModel} or a {@link CatalogModel}
	 * @return an empty collection if no {@link ClassificationSystemModel}s or {@link CatalogModel} were found.
	 * @throws IllegalArgumentException if <code>catalogType</code> is <code>null</code>
	 */
	 ...
	 * @throws de.hybris.platform.servicelayer.exceptions.UnknownIdentifierException if no Catalog with the specified <code>id</code> is found
	 * @throws AmbiguousIdentifierException                                          if more than one Catalog is found with the specified <code>id</code>
