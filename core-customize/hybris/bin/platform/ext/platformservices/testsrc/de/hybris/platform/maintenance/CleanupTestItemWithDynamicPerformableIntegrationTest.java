...
public class CleanupTestItemWithDynamicPerformableIntegrationTest extends ServicelayerTransactionalTest
{
	...
	public void testDynamicPerformableWithFalseJob()
	{
		...
		{
			assertEquals("The job must be a DynamicMaintenanceCleanupJobModel. Cannot execute the beanshell search",
					e.getMessage());
		}
	}
	...
	private String getCleanupCode()
	{
		...
		buffer.append(
				" ((de.hybris.platform.core.model.test.TestItemModel)elements.get(i)).setTestDumpProperty(\"changed_\"+ (i < 10 ? \"0\" : \"\")+i);}");
