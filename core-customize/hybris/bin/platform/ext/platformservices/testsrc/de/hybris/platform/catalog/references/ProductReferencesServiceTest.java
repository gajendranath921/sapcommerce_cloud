...
public class ProductReferencesServiceTest extends ServicelayerTransactionalTest
{
	...
	public void testGetProductReferences()
	{
		...
		final Collection<ProductReferenceModel> nullQualifier = productReferenceService.getProductReferences(null, camera1,
				tripod,
				true);
		...
		final Collection<ProductReferenceModel> tripodlense1 = productReferenceService.getProductReferences("tripodlense1",
				tripod,
				lense, true);
		...
		final Collection<ProductReferenceModel> tripodlense2 = productReferenceService.getProductReferences("tripodlense2",
				tripod,
				lense, true);
	...
	private void assertCollectionHasReferenceOfTypeForProduct(final Collection<ProductReferenceModel> referencesToTest,
	                                                          final ProductModel product, final ProductReferenceTypeEnum type,
	...
	private void assertCollectionHasReference(final Collection<ProductReferenceModel> referencesToTest,
	                                          final ProductModel sourceProduct, final ProductModel targetProduct,
	                                          final ProductReferenceTypeEnum type)
	{
	...
	private void assertSingleReference(final Collection<ProductReferenceModel> referencesToCheck,
	                                   final ProductModel expectedSource, final ProductModel expectedTarget,
	                                   final ProductReferenceTypeEnum expectedType)
	{
