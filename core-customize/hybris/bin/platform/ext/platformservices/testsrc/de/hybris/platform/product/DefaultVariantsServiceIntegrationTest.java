...
public class DefaultVariantsServiceIntegrationTest extends ServicelayerTransactionalTest
{
	...
	public void testSetVariantAttributesForVariantTypeValidAttributeList()
	{
		...
		//next attempt - new attributes with 3 elements - but one of them already exists
	...
	public void testSetVariantAttributesForVariantTypeVariantTypeIsNotSaved()
	{
		...
		try
		{
			...
			Assert.fail("Settting variant attributes for not saved " + testVariantTypeModel + " should fail");
		}
	 ...
	 *
	 * @param variantType        the variantType to find the current attributes to compare.
	 * @param expectedAttributes the attribute to list to compare.
	 */
