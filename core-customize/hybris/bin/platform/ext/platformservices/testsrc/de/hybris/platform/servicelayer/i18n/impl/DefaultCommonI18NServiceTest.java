...
public class DefaultCommonI18NServiceTest
{
	...
	public void testGetLocaleIsocodeSplitting()
	{
		...
		languageModel.setIsocode("de-DE-");
		Assert.assertTrue(
				"The locale: " + service.getLocaleForLanguage(languageModel) + " should be the same as locale: " + deloc,
	...
	public void testGetAllCurrencies()
	{
		...
		Assert.assertEquals(
				"Language list returned from service.getAllCurrencies  should be the same as from dao.findCurrencies.",
