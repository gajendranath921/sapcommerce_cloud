...
public class CalculationServiceMixedTaxTest extends ServicelayerTransactionalTest
{
	...
	{
		addEntry(order, productA, unit1, 1, 20.0, new TaxValue("VAT_FULL", 19, false, null),
				new TaxValue("CUSTOM", 2, false, null));
	...
	private OrderEntryModel addEntry(final OrderModel orderModel, final ProductModel productModel, final UnitModel unitModel,
	                                 final long quantity,
