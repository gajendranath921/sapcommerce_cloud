...
public class ProductPriceDiffFinderTest
{
	...
	public void testProcessSearchesWithNullPriceInformation()
	{
		...
		Mockito.when(priceService.getPriceInformationsForProduct(Mockito.any(ProductModel.class)))
		       .thenReturn(null); //null price information
	...
	public void testProcessSearchesWithDifferentSizePriceTheSamePriceValueInformation()
	{
		...
		{
			@Override
			public boolean matches(final ProductCatalogVersionDifferenceModel difference)
			{
