...
public class ProductReferencesDaoTest extends ServicelayerTest
{
	...
	public void testFindProductReferences()
	{
		...
		assertThat(
				productReferencesDao.findProductReferences(null, null, null, ProductReferenceTypeEnum.CROSSELLING, Boolean.TRUE))
		...
		//not matching cases
		assertThat(
				productReferencesDao.findProductReferences(null, product2, null, ProductReferenceTypeEnum.MANDATORY,
						Boolean.TRUE))
				.isEmpty();
		assertThat(
				productReferencesDao
						.findProductReferences("test", product2, null, ProductReferenceTypeEnum.CROSSELLING,
		...
		assertThat(
				productReferencesDao.findProductReferences("testReference2-3", product2, product3,
						ProductReferenceTypeEnum.CROSSELLING, Boolean.TRUE)).hasSize(1)
		                                                                    .contains(
				                                                                    productReference2);
		...
		assertThat(
				productReferencesDao.findProductReferences(null, product2, product1, ProductReferenceTypeEnum.ACCESSORIES, null))
	...
	private ProductReferenceModel prepareProductReference(final ProductModel source, final ProductModel target,
	                                                      final ProductReferenceTypeEnum type, final String qualifier,
