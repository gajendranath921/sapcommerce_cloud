...
public class VelocityTemplateRendererTest
{
	...
	public void testWhenVelocityEvaluationThrowsException() throws Exception
	{
		...
		doThrow(new ParseErrorException("")).doThrow(new ResourceNotFoundException(""))
		                                    .doThrow(new IOException())
		                                    .doThrow(new MethodInvocationException(null, null, null, null, 0, 0))
		                                    .when(rendererWithMockedEvaluateMethod)
	...
	{
		public MockContextClass(final Map<String, Object> values)
		{
			super(values);
		}
	}
