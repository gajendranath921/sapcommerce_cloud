...
public class ZoneDeliveryModeValueDaoTest extends ServicelayerTest
{
	...
	public void testFindZoneDeliveryModeValuesByCurrency()
	{
		...
		final Collection<ZoneDeliveryModeValueModel> gbpResult = zoneDeliveryModeValueDao.findZoneDeliveryModeValuesByCurrency(
				gbp);
		...
		final Collection<ZoneDeliveryModeValueModel> usdResult = zoneDeliveryModeValueDao.findZoneDeliveryModeValuesByCurrency(
				usd);
		Assert.assertEquals("unexpected returned collection size", 3, usdResult.size());


		final Collection<ZoneDeliveryModeValueModel> plnResult = zoneDeliveryModeValueDao.findZoneDeliveryModeValuesByCurrency(
				pln);
	...
	public void testFindZoneDeliveryModeValuesByZone()
	{
		...
		final Collection<ZoneDeliveryModeValueModel> worldResult = zoneDeliveryModeValueDao.findZoneDeliveryModeValuesByZone(
				world);
