...
public class DefaultClassificationServiceDemoTest extends ServicelayerTransactionalTest
{
	...
	private ClassificationAttributeUnitModel kg, g;
	...
	public void shouldModifyExistingValuesForFeature()
	{
		...
		assertThat(featureAfter.getValues()).isNot(new Condition<>()
		{
			@Override
			public boolean matches(final List<? extends FeatureValue> featureValues)
			{
