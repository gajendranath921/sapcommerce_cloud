...
public class HybrisTransactionManagerExceptionsTest extends ServicelayerBaseTest
{
	...
	public void testCommitNoTxRunningExceptions()
	{
		...
		catch (final TransactionException springEc)
		{
			...
			System.err
					.println(
							"HybrisTransactionManager.doCommit() with not tx running: should throw IllegalTransactionStateException instead of TransactionException, should be improved");
		}
	...
	public void testCommitRollbackOnlyExceptions()
	{
		...
		catch (final TransactionException e)
		{
			...
			System.err
					.println(
							"HybrisTransactionManager.doCommit() + Jalo rollback-only: should throw UnexpectedRollbackException instead of TransactionException -> improve");
		}
		catch (final Exception e)
		{
	...
	public void testRollbackNoTxRunningExceptions()
	{
		...
		catch (final TransactionException springEc)
		{
			...
			System.err
					.println(
							"HybrisTransactionManager.doRollback() with not tx running: should throw IllegalTransactionStateException instead of TransactionException, should be improved");
		}
		catch (final Exception e)
		{
