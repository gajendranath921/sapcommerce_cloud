...
public class SimpleTypeColumnAlternationTest extends AbstractColumnAlternationTest
{
	...
	{
		checkTypeChange(new ColumnDefinitionImpl("INT"), new ColumnDefinitionImpl("FLOAT"), Integer.valueOf(1),
				Integer.valueOf(2),
	...
	public void alterInt2Medint() throws SQLException, UpdateModelException
	{
		...
		if (Config.isMySQLUsed())
		{
			checkTypeChange(new ColumnDefinitionImpl("INT"), new ColumnDefinitionImpl("MEDIUMINT"),
					new ColumnDefinitionImpl("INT"),
					Integer.valueOf(1), Integer.valueOf(2), Integer.valueOf(3), Integer.valueOf(4), Integer.valueOf(45),
					Integer.valueOf(5), Integer.valueOf(6456), Integer.valueOf(Integer.MAX_VALUE),
	...
	public void alterInt2Smallint() throws SQLException, UpdateModelException
	{
		...
		{
			checkTypeChange(new ColumnDefinitionImpl("INT"), new ColumnDefinitionImpl("SMALLINT"),
					new ColumnDefinitionImpl("INT"),
					Integer.valueOf(1), Integer.valueOf(2), Integer.valueOf(3), Integer.valueOf(4), Integer.valueOf(45),
					Integer.valueOf(5), Integer.valueOf(6456), Integer.valueOf(Integer.MAX_VALUE),
					Integer.valueOf(Integer.MIN_VALUE));
	...
	public void alterIntRange() throws SQLException, UpdateModelException
	{
		...
		catch (final Exception e)
		{
			if (Config.isMySQLUsed())
			{
				Assert.assertTrue(e.getClass().getName().endsWith("MysqlDataTruncation"));
			}
		}
	}
	...
	public void alterInt() throws SQLException, UpdateModelException
	{
		...
		else
		{
			checkTypeChange(new ColumnDefinitionImpl("TINYINT"),
					(!Config.isHSQLDBUsed() ? new ColumnDefinitionImpl("INT",
							Integer.valueOf(10)) : new ColumnDefinitionImpl(
							"INT")),
					Integer.valueOf(-127), Integer.valueOf(-23), Integer.valueOf(0), Integer.valueOf(1),
					Integer.valueOf(2),
	...
	public void alterFloat() throws SQLException, UpdateModelException
	{
		if (Config.isSQLServerUsed())
		{
			...
			checkTypeChange(new ColumnDefinitionImpl("FLOAT"), new ColumnDefinitionImpl("REAL"), Float.valueOf(-1.34535f),
					Float.valueOf(2.3453f), Float.valueOf(32435f), Float.valueOf(0.000043f),
					Float.valueOf(4537846734.323f),
