...
public class UserPasswordChangeAuditPrepareInterceptorTest extends ServicelayerTransactionalBaseTest
{
	...
	public void shouldRecordPasswordChanges()
	{
		...
		assertThat(allAudit).extracting(UserPasswordChangeAuditModel.ENCODEDPASSWORD).containsOnly("pass_no4", "pass_no3",
				"pass_no2", "pass_no1");
		...
		assertThat(userAudit).extracting(UserPasswordChangeAuditModel.ENCODEDPASSWORD).containsOnly("pass_no4", "pass_no3",
				"pass_no2", "pass_no1");
	}
	...
	public void shouldKeepAuditDataAfterUserDeletion()
	{
		...
		assertThat(audit).extracting(UserPasswordChangeAuditModel.ENCODEDPASSWORD).containsOnly("pass_no1");
	}
	...
	public void shouldCorrectlyAuditUserWithUidChange()
	{
		...
		assertThat(userAuditData).extracting(UserPasswordChangeAuditModel.ENCODEDPASSWORD).containsOnly("pass_no3", "pass_no2",
				"pass_no1");
	}
