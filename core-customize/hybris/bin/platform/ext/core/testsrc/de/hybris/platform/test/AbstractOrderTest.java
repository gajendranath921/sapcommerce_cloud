...
public class AbstractOrderTest extends HybrisJUnit4Test
{
	...
	public void testSearchByDate()
	{
		try
		{
			...
			GenericCondition genericCondition = GenericCondition.equals(new GenericSearchField(otCode, AbstractOrder.DATE),
					totest);
	...
	public void testRoundingError()
	{
		final Order order = OrderManager.getInstance().createOrder(jaloSession.getUser(),
				jaloSession.getSessionContext().getCurrency(), new Date(),
				false);
		...
		assertTrue("expected '13.9' or '13.90...' but got '" + totalStr + "'",
				"13.9".equals(totalStr) || totalStr.startsWith("13.90"));
	}
}
