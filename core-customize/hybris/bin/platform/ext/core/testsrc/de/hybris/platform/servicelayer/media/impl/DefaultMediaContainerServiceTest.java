...
public class DefaultMediaContainerServiceTest
{
	...
	public void setUp()
	{
		...
		Mockito.lenient().when(mediaModel2.getCode()).thenReturn("media2");
	...
	public void testAddMediaWithUniqueFormatToContainer()
	{
		...
		Mockito.verify(modelService).save(Mockito.argThat(new ArgumentMatcher<MediaContainerModel>()
		{
			...
			@Override
			public boolean matches(final MediaContainerModel mediaContainerModel)
			{
				assertThat(mediaContainerModel.getMedias() != null);
				assertThat(mediaContainerModel.getMedias().size() == 3);
				assertThat(mediaContainerModel.getMedias().contains(existingFooMedia));
				assertThat(mediaContainerModel.getMedias().contains(existingBarMedia));
				assertThat(mediaContainerModel.getMedias().contains(newGooMedia));
				return true;
			}
		}));
	...
	public void testAddMediaWithNonUniqueFormatToContainer()
	{
		...
		Mockito.verify(modelService).save(Mockito.argThat(new ArgumentMatcher<MediaContainerModel>()
		{
			...
			{
				assertThat(mediaContainerModel.getMedias() != null);
				assertThat(mediaContainerModel.getMedias().size() == 2);
				assertThat(mediaContainerModel.getMedias().contains(existingFooMedia));
				assertThat(!mediaContainerModel.getMedias().contains(existingBarMedia));
				assertThat(mediaContainerModel.getMedias().contains(newGooMedia));
				return true;
	...
	public void testAddMediaWithNonUniqueAsMediasFormatToContainer()
	{
		...
		Mockito.verify(modelService).save(Mockito.argThat(new ArgumentMatcher<MediaContainerModel>()
		{
			...
			public boolean matches(final MediaContainerModel mediaContainerModel)
			{
				...
				assertThat(!mediaContainerModel.getMedias().contains(existingBarMedia));
				assertThat(!mediaContainerModel.getMedias().contains(newGooMedia));
				assertThat(!mediaContainerModel.getMedias().contains(newRooMedia));
				return true;
			}
		}));
	...
	{
		final List<MediaContainerModel> result = Mockito.mock(List.class);
		Mockito.lenient().when(Integer.valueOf(result.size())).thenReturn(Integer.valueOf(0));
