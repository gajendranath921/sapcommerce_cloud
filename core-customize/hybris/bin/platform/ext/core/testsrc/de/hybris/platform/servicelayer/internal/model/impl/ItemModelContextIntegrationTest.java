...
public class ItemModelContextIntegrationTest extends ServicelayerBaseTest
{
	...
	public void testModelAttributeLifeCycleForLocalizedProperty()
	{
		...
		checkModelAttributeForLocalizedProperty(loadedModelChangedViaModel, loadedModelChangedViaCtx, currentLocale,
				ProductModel.NAME);
	...
	private void checkModelAttributeForNonLocalizedProperty(final ProductModel newModelChangedViaModel,
	                                                        final ProductModel newModelChangedViaCtx, final String attribute)
	{
	...
	private void checkModelAttributeForLocalizedProperty(final ProductModel newModelChangedViaModel,
	                                                     final ProductModel newModelChangedViaCtx, final Locale locale,
	...
	private void checkFlagsAfterRemove(final boolean loadedOnDemand, final ProductModel model, final String attribute,
	...
	private void checkLocalizedFlagsAfterRemove(final boolean loadedOnDemand, final ProductModel model, final Locale locale,
	                                            final String attribute,
	                                            final Object expectedValue)
	{
	...
	private void checkFlagsAfterSave(final boolean loadedOnDemand, final ProductModel model, final String attribute,
	                                 final Object expectedValue)
	{
		Assert.assertEquals(expectedValue, getOriginalValue(model, attribute));
		Assert.assertFalse(model.getItemModelContext().getDirtyAttributes().contains(attribute));
	...
	private void checkLocalizedFlagsAfterSave(final boolean loadedOnDemand, final ProductModel model, final Locale locale,
	                                          final String attribute,
	                                          final Object expectedValue)
	{
		Assert.assertEquals(expectedValue, getOriginalValue(model, attribute, locale));
	...
	private void checkFlagsAfterChange(final boolean loadedOnDemand, final ProductModel model, final String attribute,
	                                   final Object expectedValue)
	{
		Assert.assertEquals(expectedValue, getOriginalValue(model, attribute));
	...
	private void checkLocalizedFlagsAfterChange(final boolean loadedOnDemand, final ProductModel model, final Locale locale,
	                                            final String attribute,
	                                            final Object expectedValue)
	{
		Assert.assertEquals(expectedValue, getOriginalValue(model, attribute, locale));
