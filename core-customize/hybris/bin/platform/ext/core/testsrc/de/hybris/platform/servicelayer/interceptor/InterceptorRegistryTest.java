...
public class InterceptorRegistryTest
{
	 ...
	 *
	 * @param name         name of TestLoadInterceptors
	 * @param typecode     type for TestLoadInterceptors
	 * @param order        the order for TestLoadInterceptors
	 * @param replacements those Interseptors are replaced
