...
public class EJBToolsTest extends HybrisJUnit4TransactionalTest
{
	...
	public void testPkStringCollection() throws Exception
	{
		...
		assertEquals(C + pk1s + C + pk2s + C,
				EJBTools.addPKToPKCollectionString(C + pk1s + C, EJBTools.getPK(new ItemDummy(pk2))));
		assertEquals(C + pk1s + C + pk1s + C,
				EJBTools.addPKToPKCollectionString(C + pk1s + C, EJBTools.getPK(new ItemDummy(pk1))));
		...
		assertEquals(C + pk1s + C + pk2s + C + pk4s + C,
				removePKFromPKCollectionString(C + pk1s + C + pk2s + C + pk4s + C + pk5s + C,
						EJBTools.getPK(new ItemDummy(pk5))));
		assertEquals(
				null,
				removePKFromPKCollectionString(C + pk1s + C + pk2s + C + pk3s + C + pk4s + C + pk5s + C,
