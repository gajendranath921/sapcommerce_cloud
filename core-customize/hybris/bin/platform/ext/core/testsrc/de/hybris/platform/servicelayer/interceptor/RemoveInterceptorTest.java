...
public class RemoveInterceptorTest extends ServicelayerTransactionalBaseTest
{
	...
	private final List<ItemModel> gotRegionInterceptors = new ArrayList<>();
	...
	public void setUp() throws Exception
	{
		...
		DefaultInterceptorRegistry reg = (DefaultInterceptorRegistry) ((DefaultModelService) modelService).getInterceptorRegistry();
	...
	public void testRemovePartOfAttributes()
	{
		...
		final Collection<RegionModel> beforeCollection = new HashSet<>(germany.getRegions());
	...
	public void testRemovalScheduling()
	{
		...
		final Map<Object, Object[]> containments = new HashMap<>();
		...
		final List<Object> notified = new ArrayList<>();
	...
	private static class MockInterceptorRegistry implements InterceptorRegistry
	{
		...
		{
			if (type.equals(RemoveInterceptorTest.SOME_TEST_TYPE))
			{
	...
	static class TestItem extends AbstractItemModel
	{
	...
	private class DummyModelConverter implements ModelConverter
	{
		...
		@Override
		public Set<String> getPartOfAttributes(final TypeService typeService)
		{
			throw new RuntimeException();
		}
	...
	class MockModelConverter extends DummyModelConverter
	{
		...
		public String getType(final Object model)
		{
			return RemoveInterceptorTest.SOME_TEST_TYPE;
		}
	...
	private class MockModelService extends DefaultModelService
	{
		...
		public MockModelService(final RemoveInterceptor mockRemoveInterceptor, final ModelConverter mockConverter)
		{
			...
			this.mockRemoveInterceptor = mockRemoveInterceptor;
			this.mockConverter = mockConverter;
			setModelExtractor(defaultModelExtractor);
			setCascader(cascader);
			setModelContext(Mockito.mock(ModelContext.class));
		}
