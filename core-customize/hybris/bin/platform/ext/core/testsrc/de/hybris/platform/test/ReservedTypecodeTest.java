...
public class ReservedTypecodeTest extends HybrisJUnit4Test
{
	...
	private final static List<Integer> exclusions = Arrays.asList(
			//
			Integer.valueOf(10001), Integer.valueOf(10002), Integer.valueOf(10004), Integer.valueOf(10005),
			Integer.valueOf(10007),
			Integer.valueOf(10008), Integer.valueOf(10009), Integer.valueOf(10010), Integer.valueOf(10012),
			Integer.valueOf(10013),
			Integer.valueOf(10017), Integer.valueOf(10018), Integer.valueOf(10021), Integer.valueOf(10022),
			Integer.valueOf(10023),
			Integer.valueOf(10025), Integer.valueOf(10027), Integer.valueOf(10028), Integer.valueOf(10030),
			Integer.valueOf(10031),
			Integer.valueOf(10032), Integer.valueOf(10033), Integer.valueOf(10034), Integer.valueOf(10035),
			Integer.valueOf(10036),
			Integer.valueOf(10037), Integer.valueOf(10038), Integer.valueOf(10039), Integer.valueOf(10040),
			Integer.valueOf(10041),
			Integer.valueOf(10042), Integer.valueOf(10123),

			Integer.valueOf(13101), Integer.valueOf(13102), Integer.valueOf(13113), Integer.valueOf(13211),
			Integer.valueOf(13212),
			Integer.valueOf(13213), Integer.valueOf(13214), Integer.valueOf(13215),

			Integer.valueOf(20340),

			Integer.valueOf(23401), Integer.valueOf(23402), Integer.valueOf(23403), Integer.valueOf(23404),
			Integer.valueOf(23405),
			Integer.valueOf(23406), Integer.valueOf(23407), Integer.valueOf(23409), Integer.valueOf(23410),
			Integer.valueOf(23411),
			Integer.valueOf(23412), Integer.valueOf(23413), Integer.valueOf(23414), Integer.valueOf(23420),
			Integer.valueOf(23421),
			Integer.valueOf(23423), Integer.valueOf(23425), Integer.valueOf(23426), Integer.valueOf(23427),
			Integer.valueOf(23428),
			Integer.valueOf(23429), Integer.valueOf(23430), Integer.valueOf(23431), Integer.valueOf(23432),
			Integer.valueOf(23451),
			Integer.valueOf(23452), Integer.valueOf(23460), Integer.valueOf(23461), Integer.valueOf(23462),
			Integer.valueOf(23463),
			Integer.valueOf(23464), Integer.valueOf(23465), Integer.valueOf(23466), Integer.valueOf(23467),
			Integer.valueOf(23904),


			Integer.valueOf(24242), Integer.valueOf(24401), Integer.valueOf(24402), Integer.valueOf(24403),
			Integer.valueOf(24404),
			Integer.valueOf(24441), Integer.valueOf(24500), Integer.valueOf(24600), Integer.valueOf(24601),
			Integer.valueOf(24602),
			Integer.valueOf(24603), Integer.valueOf(24604), Integer.valueOf(24605), Integer.valueOf(24606),
			Integer.valueOf(24607),
			Integer.valueOf(24608), Integer.valueOf(24609), Integer.valueOf(24610), Integer.valueOf(24611),
			Integer.valueOf(24612),
			...
			//hyend2
			Integer.valueOf(32000), Integer.valueOf(32001), Integer.valueOf(32003), Integer.valueOf(32004),
			Integer.valueOf(32005),
			Integer.valueOf(32007), Integer.valueOf(32008), Integer.valueOf(32009), Integer.valueOf(32010),
			Integer.valueOf(32011),
			Integer.valueOf(32012), Integer.valueOf(32013), Integer.valueOf(32015), Integer.valueOf(32016),
			Integer.valueOf(32017),
			Integer.valueOf(32019), Integer.valueOf(32020), Integer.valueOf(32021), Integer.valueOf(32022),
			Integer.valueOf(32023),
			Integer.valueOf(32024), Integer.valueOf(32025), Integer.valueOf(32026), Integer.valueOf(32027),
			Integer.valueOf(32028),
