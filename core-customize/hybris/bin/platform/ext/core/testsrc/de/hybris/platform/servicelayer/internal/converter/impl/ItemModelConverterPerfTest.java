...
public class ItemModelConverterPerfTest extends ServicelayerBaseTest
{
	...
	public void prepare()
	{
		...
		freshConverter = new ItemModelConverter(modelService, i18nService, commonI18NService, "Title", TitleModel.class,
				originalConverter.getSerializationStrategy(),
				originalConverter.getSourceTransformer(), selfHealingService)
		{
			@Override
	...
	//
	//		final Map<String, Map<Locale, Object>> localizedattributesFieldValue = (Map<String, Map<Locale, Object>>) ReflectionUtils
	...
	//
	//		final Map<Locale, Object> locals = localizedattributesFieldValue.get("name");
	...
	//		void modify(final ItemModel tm)
	//		{
	//			final Map<String, LocMap<Locale, Object>> localizedattributesFieldValue = (Map<String, LocMap<Locale, Object>>) ReflectionUtils
	//					.getField(allLocField, tm);
	//			getConverter().preLoadLocAttribute(localizedattributesFieldValue, tm, "name", Locale.ENGLISH, value);
	//		}
	//
	//	}
