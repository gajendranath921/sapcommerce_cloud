...
public class InvalidationSetTest
{
	...
	public void testInvalidateRelationItem()
	{
		...
		final PassThroughTestInvalidationProcessor processor = new PassThroughTestInvalidationProcessor(target);
		final InvalidationSet set = new InvalidationSet(processor);
		final Object[] key = new Object[]{"Relation", "A", "B", PK.NULL_PK };
		set.delayInvalidation(key, 3,1);

		assertThat(set.isInvalidated(key)).isTrue();
	}
	...
	public void testInvalidateRelation()
	{
		...
		final PassThroughTestInvalidationProcessor processor = new PassThroughTestInvalidationProcessor(target);
		final InvalidationSet set = new InvalidationSet(processor);
		final Object[] keyRelation = new Object[]{"Relation", "A"};
		final Object[] keyItem = new Object[]{"Relation", "A", "B", PK.NULL_PK };
		set.delayInvalidation(keyRelation, 3,1);

		assertThat(set.isInvalidated(keyItem)).isTrue();
	}
	...
	public void testShouldNotInvalidateAnotherRelationItem()
	{
		...
		final InvalidationSet set = new InvalidationSet(processor);
		final Object[] key = new Object[]{"Relation", "A", "B", PK.NULL_PK };
		final Object[] differentKey = new Object[]{"Relation", "A", "B", PK.BIG_PK };
		set.delayInvalidation(key, 3,1);

		assertThat(set.isInvalidated(differentKey)).isFalse();
	}
	...
	public void testShouldNotInvalidateItemFromAnotherRelation()
	{
		...
		final PassThroughTestInvalidationProcessor processor = new PassThroughTestInvalidationProcessor(target);
		final InvalidationSet set = new InvalidationSet(processor);
		final Object[] keyRelation = new Object[]{"Relation", "C"};
		final Object[] keyItem = new Object[]{"Relation", "A", "B", PK.NULL_PK };
		set.delayInvalidation(keyRelation, 3,1);

		assertThat(set.isInvalidated(keyItem)).isFalse();
	}
