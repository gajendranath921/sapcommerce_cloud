...
class CacheBaseStub
{
	private static final Logger LOG = Logger.getLogger(CacheBaseStub.class.getName());
	...
	protected void clearCacheMap()
	{
		if (isYMap)
		{
			...
			((YMap<AbstractCacheUnit, AbstractCacheUnit>) this.cacheMap).clear(//
					...
					{
						@Override
						public void handleClearedEntry(
								final Entry<AbstractCacheUnit, AbstractCacheUnit> entry)
						{
