...
public class LazyLoadItemListTest extends HybrisJUnit4Test
{
	...
	public void testLazyLoadOnRemovedItem() throws ConsistencyCheckException
	{
		...
		final LazyLoadItemList<Country> list = new LazyLoadItemList<Country>(null, Collections.singletonList(myCountry.getPK()),
				2);
	...
	public void testLazyList() throws IOException, ClassNotFoundException
	{
		...
		final LazyLoadItemList l4 = new LazyLoadItemList(null, Collections.singletonList(PK.createFixedUUIDPK(1, 123456789l)),
				-1);
		l4.get(0);

		final LazyLoadItemList l5 = new LazyLoadItemList(null, Collections.singletonList(PK.createFixedUUIDPK(1, 123456789l)),
				-100);
		l5.get(0);
