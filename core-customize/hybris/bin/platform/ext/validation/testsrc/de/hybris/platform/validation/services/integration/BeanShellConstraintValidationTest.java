...
public class BeanShellConstraintValidationTest extends AbstractConstraintTest
{
	...
	private static final String exampleHelloScript = "print(\"hello!\");";
	...
	public void testSimplePrintlnInvalidScript()
	{
		...
		{
			Assert.assertEquals("Should be thrown RT exception during validation ", ValidationViolationException.class,
					e.getCause()
					 .getClass());
		}
	}
