...
public class AttributeConstraintInterceptorTest
{
	...
	public void testValidatorItemModelOK() throws InterceptorException
	{
		...
		given(Boolean.valueOf(
				annotationsMappingRegistry.isAnnotationRegisteredForType(NotEmpty.class, "java.lang.String"))).willReturn(
				Boolean.TRUE);
	...
	public void testValidatorPojoOk() throws InterceptorException
	{
		...
		replay(modelService);
		typeValidator.onValidate(constraint, null);
		given(Boolean.valueOf(annotationsMappingRegistry.isAnnotationRegisteredForType(Past.class, "java.util.Date"))).willReturn(
				Boolean.TRUE);
		attrValidator.onValidate(constraint, null);
		verify(modelService);
	}
