...
public class DuplicatedConstraintsValidationTest extends AbstractConstraintTest
{
	...
	public void prepareGroup()
	{
		...
		sampleGroup.setInterfaceName(
				"de.hybris.platform.validation.services.integration.DuplicatedConstraintsValidationTest.SampleGroup");
		sampleGroup.setId("sampleGroup");

		sampleOtherGroup = modelService.create(ConstraintGroupModel.class);
		sampleOtherGroup.setInterfaceName(
				"de.hybris.platform.validation.services.integration.DuplicatedConstraintsValidationTest.List");
	...
	public void testDuplicatedAssertFalseConstraintsForModel()
	{
		...
		{
			checkException(e, ModelSavingException.class, InterceptorException.class, UniqueAttributesInterceptor.class, false);
		}
