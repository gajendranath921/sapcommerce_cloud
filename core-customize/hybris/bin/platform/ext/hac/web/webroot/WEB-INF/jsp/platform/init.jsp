			...
			<c:choose>
				<c:when test="${type eq 'INIT'}">
					...
					<div class="box">
						<div class="quiet">
							<!-- Init page sidebar -->
							This page enables you to initialize the SAP Commerce.
							<hr />
							<hac:warning>
					...
					<div class="box">
						<div class="quiet">
						 <ul>
							 <li> <a href="${wikiInit}" target="_blank" rel="noopener noreferrer" class="quiet">Initialization</a> </li>
						</ul>
						</div>
					</div>
				</c:when>
				<c:otherwise>
					...
					<div class="box">
						<div class="quiet">
							<ul>
						 		<li> <a href="${wikiUpdate}" target="_blank" rel="noopener noreferrer" class="quiet">Update</a> </li>
							</ul>
						</div>
					</div>
				</c:otherwise>
