	...
	<body>
			<div class="prepend-top span-17 colborder" id="content">
				...
				<div class="marginLeft" id="inner">
					...
					<p>
						...
						<span class="filecol">local.properties</span> file. Afterwards, rebuild the SAP Commerce Suite and restart your application server to collect the data.
					</p>
				</div>			
			</div>
			<div class="span-6 last" id="sidebar">
				<div class="prepend-top" id="recent-reviews">
					...
					<div class="box">
						<ul>
							<li> <a href="${wikiClassLoaderMonitor}" target="_blank" rel="noopener noreferrer" class="quiet" >Classpath Analyzer</a> </li>
						</ul>
					</div>
				</div>
			</div>		
