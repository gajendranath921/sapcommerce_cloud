...
public class WorkflowAutomatedTest extends WorkflowTest
{
	...
	public void testAutomatedWorkflowActionException()
	{
		...
		final WorkflowActionTemplateModel templateAction4 = createWorkflowActionTemplateModel(testUser,
				ACTIONCODES.ACTION4.name(),
		...
		final WorkflowActionTemplateModel templateAction5 = createAutomatedWorkflowActionTemplateModel(testUser,
				ACTIONCODES.ACTION5.name(),
				WorkflowActionType.NORMAL,
				template,
				WorkflowAutomatedTestAction.class);
		final WorkflowActionTemplateModel templateAction6 = createWorkflowActionTemplateModel(testUser,
				ACTIONCODES.ACTION6.name(),
