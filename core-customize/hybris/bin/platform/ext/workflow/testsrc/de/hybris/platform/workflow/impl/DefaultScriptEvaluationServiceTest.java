...
public class DefaultScriptEvaluationServiceTest
{
	...
	public void setUp()
	{
		...
		scriptEvaluationService.setTypeService(typeService);
		scriptEvaluationService.setWorkflowTemplateService(workflowTemplateService);
		scriptEvaluationService.setWorkflowService(workflowService);
	}
