...
public class DefaultWarehousingStockLevelFacade extends OmsBaseFacade implements WarehousingStockLevelFacade
{
	...
	private WarehousingCommentService stockLevelCommentService;
			...
			final String releaseDate)
	{
		...
		{
			Assert.isTrue(false, Localization.getLocalizedString("warheousingfacade.stocklevel.error.dateformat"));
		}
