...
public class BaseWebservicesIntegrationTest extends ServicelayerTest
{
	...
	/**
	 * Retrieves a new authenticated {@link WsSecuredRequestBuilder} in order to build web requests
	 *
	 * @return the authenticated {@link WsSecuredRequestBuilder}
	 */
	protected WsSecuredRequestBuilder getWsSecuredRequestBuilder()
	{
		...
		return new WsSecuredRequestBuilder().extensionName(WarehousingwebservicesConstants.EXTENSIONNAME).clientConfig(config);
	}
