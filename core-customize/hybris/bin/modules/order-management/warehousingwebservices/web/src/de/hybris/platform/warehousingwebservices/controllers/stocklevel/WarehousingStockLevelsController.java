...
public class WarehousingStockLevelsController extends WarehousingBaseController
{
	...
	@ResponseBody
	@ApiOperation(nickname = "getStockLevelsForWarehouseCode", value = "Finds a paginated list of stock levels by a given warehouse code", notes = "Finds a paginated list of stock levels by a given warehouse code.", response = StockLevelSearchPageWsDto.class)
	...
	@ResponseBody
	@ApiOperation(nickname = "createStockLevel", value = "Creates a stocklevel", notes = "Creates a stocklevel.", response = StockLevelWsDto.class)
	...
	@ResponseBody
	@ApiOperation(nickname = "getStockLevelAdjustmentReasons", value = "Finds all adjustment reasons", notes = "Finds all adjustment reasons.", response = StockLevelAdjustmentReasonsWsDTO.class)
	...
	@ResponseStatus(HttpStatus.CREATED)
	@ResponseBody
	@ApiOperation(nickname = "createStockLevelAdjustment", value = "Creates an inventoryEvent to adjust a specific stocklevel", notes = "Creates an inventoryEvent to adjust a specific stocklevel.", response = StockLevelAdjustmentsWsDTO.class)
