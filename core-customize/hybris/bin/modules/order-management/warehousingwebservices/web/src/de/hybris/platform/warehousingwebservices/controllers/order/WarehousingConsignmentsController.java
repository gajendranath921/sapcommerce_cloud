...
public class WarehousingConsignmentsController extends WarehousingBaseController
{
	...
	@ResponseBody
	@ApiOperation(nickname = "getConsignments", value = "Finds a paginated list of consignments", notes = "Finds a paginated list of consignments.", response = ConsignmentSearchPageWsDto.class)
	...
	@ResponseBody
	@ApiOperation(nickname = "getConsignmentForCode", value = "Finds a consignment by a given consignment code", notes = "Finds a consignment by a given consignment code.", response = ConsignmentWsDTO.class)
	...
	@ResponseBody
	@ApiOperation(nickname = "getSourcingLocationsForConsignmentCode", value = "Finds a paginated list of sourcing locations for a given consignment code", notes = "Finds a paginated list of sourcing locations for a given consignment code.", response = WarehouseSearchPageWsDto.class)
	...
	@ResponseBody
	@ApiOperation(nickname = "getConsignmentsByStatus", value = "Finds a paginated list of consignments for a given consignment status", notes = "Finds a paginated list of consignments for a given consignment status", response = ConsignmentSearchPageWsDto.class)
	...
	@ResponseBody
	@ApiOperation(nickname = "getConsignmentStatuses", value = "Finds a list of all consignment's statuses", notes = "Finds a list of all consignment's statuses.", response = ConsignmentStatusListWsDTO.class)
	...
	@ResponseBody
	@ApiOperation(nickname = "getDeclineReasons", value = "Finds a list of all decline reasons", notes = "Finds a list of all decline reasons.", response = DeclineReasonListWsDTO.class)
	...
	@ResponseBody
	@ApiOperation(nickname = "getConsignmentEntriesForConsignmentCode", value = "Finds a paginated list of consignment entries for a given consignment code", notes = "Finds a paginated list of consignment entries for a given consignment code.", response = ConsignmentEntrySearchPageWsDto.class)
	...
	@ApiOperation(nickname = "confirmShipConsignment", value = "Confirms a consignment's shipping for a given consignment code", notes = "Confirms a consignment's shipping for a given consignment code.")
	...
	@RequestMapping(value = "{code}/confirm-pickup", method = RequestMethod.POST, consumes = { MediaType.APPLICATION_XML_VALUE,
			MediaType.APPLICATION_JSON_VALUE }, produces = { MediaType.APPLICATION_JSON_VALUE, MediaType.APPLICATION_XML_VALUE })
	@ResponseStatus(HttpStatus.OK)
	@ApiOperation(nickname = "confirmPickupConsignment", value = "Confirms a consignment's pickup for a given consignment code", notes = "Confirms a consignment's pickup for a given consignment code.")
	...
	@ResponseBody
	@ApiOperation(nickname = "isConsignmentConfirmable", value = "Checks if a consignment can be confirmed", notes = "Checks if a consignment can be confirmed.")
	...
	@ResponseBody
	@ApiOperation(nickname = "getPackagingInfo", value = "Finds the packaging information for the given consignment code", notes = "Finds the packaging information for the given consignment code.", response = PackagingInfoWsDTO.class)
	...
	@ResponseStatus(HttpStatus.OK)
	@ResponseBody
	@ApiOperation(nickname = "updatePackagingInfo", value = "Updates a consignment's packaging information", notes = "Updates a consignment's packaging information.", response = ConsignmentWsDTO.class)
	...
	@ResponseStatus(HttpStatus.OK)
	@ResponseBody
	@ApiOperation(nickname = "reallocateConsignment", value = "Reallocates a given consignment", notes = "Reallocates a given consignment.")
	...
	@ResponseStatus(HttpStatus.OK)
	@ResponseBody
	@ApiOperation(nickname = "pickConsignment", value = "Request to pick a given Consignment and optionally generate its Pick Slip", notes = "Request to pick a given Consignment and optionally generate its Pick Slip.", response = String.class)
	...
	@ResponseStatus(HttpStatus.OK)
	@ResponseBody
	@ApiOperation(nickname = "consolidatedPickConsignments", value = "Request to pick multiple Consignments and generate a consolidated Pick Slip", notes = "Request to pick multiple Consignments and generate a consolidated Pick Slip.", response = String.class)
	...
	@ResponseStatus(HttpStatus.OK)
	@ResponseBody
	@ApiOperation(nickname = "packConsignment", value = "Request to pack a given Consignment and optionally generate its Pack Label", notes = "Request to pack a given Consignment and optionally generate its Pack Label.", response = String.class)
	...
	@ResponseBody
	@ApiOperation(nickname = "getExportForm", value = "Request to ge the Export Form for a given Consignment", notes = "Request to ge the Export Form for a given Consignment.", response = String.class)
	...
	@ResponseBody
	@ApiOperation(nickname = "getShippingLabel", value = "Request to get the Shipping Label for a given Consignment", notes = "Request to get the Shipping Label for a given Consignment.", response = String.class)
	...
	@ResponseBody
	@ApiOperation(nickname = "getReturnShippingLabel", value = "Request to get the Return Shipping Label for a given Consignment", notes = "Request to get the Return Shipping Label for a given Consignment.", response = String.class)
	...
	@ResponseBody
	@ApiOperation(nickname = "getReturnForm", value = "Request to get the Return form for a given Consignment", notes = "Request to get the Return form for a given Consignment.", response = String.class)
	...
	@ResponseStatus(HttpStatus.OK)
	@ResponseBody
	@ApiOperation(nickname = "takePayment", value = "Request to take a payment for a given Consignment", notes = "Request to take a payment for a given Consignment.", response = PaymentTransactionEntryWsDTO.class)
	...
	@ResponseStatus(HttpStatus.OK)
	@ApiOperation(nickname = "manuallyReleasePaymentCapture", value = "Moves a consignment out of the waiting step after the payment capture has failed.", notes = "Moves a consignment out of the waiting step after the payment capture has failed.", response = String.class)
	...
	@RequestMapping(value = "/{code}/manual/commit-tax", method = RequestMethod.POST, produces = {
			...
			MediaType.APPLICATION_XML_VALUE })
	@ResponseStatus(HttpStatus.OK)
	@ApiOperation(nickname = "manuallyReleaseTaxCommit", value = "Moves a consignment out of the waiting step after a tax commit has failed", notes = "Moves a consignment out of the waiting step after a tax commit has failed.", response = String.class)
