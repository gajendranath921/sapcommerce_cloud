...
public class WarehousingWarehousesController extends WarehousingBaseController
{
	...
	@ResponseBody
	@ApiOperation(nickname = "getWarehouseForCode", value = "Finds a warehouse by the given code", notes = "It returns a warehouse for the given code, the given warehouse code should be valid", response = WarehouseWsDto.class)
