...
public class WarehousingAsnsController extends WarehousingBaseController
{
	...
	@ResponseBody
	@ApiOperation(nickname = "createAsn", value = "Creates an advanced shipping notice", notes = "Creates a new advanced shipping notice as given in the request.", response = AsnWsDTO.class)
	...
	@ResponseBody
	@ApiOperation(nickname = "confirmAsnReceipt", value = "Confirms the receipt of an advanced shipping notice", notes = "Confirms the receipt of an advanced shipping notice.", response = AsnWsDTO.class)
	...
	@ResponseBody
	@ApiOperation(nickname = "cancelAsn", value = "Cancels an advanced shipping notice", notes = "Cancels an advanced shipping notice.", response = AsnWsDTO.class)
