...
public class WarehousingPointOfServicesController extends WarehousingBaseController
{
	...
	@ResponseBody
	@ApiOperation(nickname = "getPointOfServiceByName", value = "Finds one point of service by name", notes = "Finds one point of service by name.", response = PointOfServiceWsDTO.class)
	...
	@ResponseBody
	@ApiOperation(nickname = "getWarehousesForPointOfService", value = "Finds a paginated list of warehouses per given point of service", notes = "Finds a paginated list of warehouses per given point of service.", response = WarehouseSearchPageWsDto.class)
	...
	@ResponseBody
	@ApiOperation(nickname = "updatePointOfServiceWithWarehouses", value = "Updates a point of service with a list of warehouse codes", notes = "Updates a point of service with a list of warehouse codes", response = PointOfServiceWsDTO.class)
	...
	@ResponseBody
	@ApiOperation(nickname = "deleteWarehousesFromPointOfService", value = "Request to delete a warehouse from point of service", notes = "Request to delete a warehouse from point of service.", response = PointOfServiceWsDTO.class)
	...
	@ResponseStatus(HttpStatus.OK)
	@ResponseBody
	@ApiOperation(nickname = "updatePointOfServiceWithAddress", value = "Updates point of service with an address", notes = "Updates point of service with an address.", response = PointOfServiceWsDTO.class)
