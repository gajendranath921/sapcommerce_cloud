...
public class WarehousingBaseStoresController extends WarehousingBaseController
{
	...
	@ResponseBody
	@ApiOperation(nickname = "getWarehousesForBaseStoreId", value = "Finds a paginated list of warehouses per a given base store", notes = "Finds a paginated list of warehouses per a given base store.", response = WarehouseSearchPageWsDto.class)
	...
	@ResponseBody
	@ApiOperation(nickname = "getPointsOfServiceForBaseStoreId", value = "Finds a paginated list of point of services per a given base store", notes = "Finds a paginated list of point of services per a given base store.", response = PointOfServiceSearchPageWsDTO.class)
