...
{
	@InjectMocks
	private final WarehousingCommentService service = new DefaultConsignmentEntryCommentService();
	@Mock
	...
	public void shouldCreate_SingleComment()
	{
		...
		verify(modelService).save(comment);
	...
	public void shouldCreate_MultipleComments()
	{
		...
		verify(modelService, times(2)).save(comment);
	...
	{
		Mockito.lenient().when(modelService.create(ComponentModel.class)).thenReturn(commentType);
