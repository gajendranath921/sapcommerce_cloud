...
public class DefaultOmsOrderCancelServiceTest
{
	...
	public void setup()
	{
		...
		Mockito.lenient().when(order.getConsignments()).thenReturn(consignments);
		Mockito.lenient().when(orderEntry1.getEntryNumber()).thenReturn(1);
		Mockito.lenient().when(orderEntry2.getEntryNumber()).thenReturn(2);
	...
	{
		Mockito.lenient().when(orderEntry1.getQuantity()).thenReturn(orderedQuantity);
			...
			final long orderedQuantity2, int cancelQuantity2)
	{
		...
		Mockito.lenient().when(orderEntry2.getQuantity()).thenReturn(orderedQuantity2);
			...
			final ConsignmentStatus status)
	{
		...
		Mockito.lenient().when(consignmentEntry1.getOrderEntry()).thenReturn(orderEntry);
		Mockito.lenient().when(consignmentEntry1.getQuantity()).thenReturn(entryQuantity);

		consignmentEntries1.add(consignmentEntry1);

		when(consignment1.getConsignmentEntries()).thenReturn(consignmentEntries1);
		Mockito.lenient().when(consignment1.getStatus()).thenReturn(status);
			...
			final ConsignmentStatus consignment2Status)
	{
		...
		consignmentEntries2 = new HashSet<>();
		Mockito.lenient().when(consignmentEntry2.getOrderEntry()).thenReturn(entry2);
		Mockito.lenient().when(consignmentEntry2.getQuantity()).thenReturn(entry2Quantity);

		consignmentEntries2.add(consignmentEntry2);
		consignments.add(consignment2);

		Mockito.lenient().when(consignment2.getConsignmentEntries()).thenReturn(consignmentEntries2);
		Mockito.lenient().when(consignment2.getStatus()).thenReturn(consignment2Status);
	}
	...
	{
		Mockito.lenient().when(consignmentEntry.getOrderEntry()).thenReturn(orderEntry);
		Mockito.lenient().when(consignmentEntry.getQuantity()).thenReturn(entryQuantity);
