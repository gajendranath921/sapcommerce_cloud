...
public class DefaultSourcingResultFactoryTest
{
	...
	{
		Mockito.lenient().when(orderEntry1.getQuantityUnallocated()).thenReturn(Long.valueOf(0L));
		...
		assertSame(orderEntry1, result.getAllocation().keySet().iterator().next());
		assertSame(warehouse, result.getWarehouse());
		assertSame(quantity, result.getAllocation().values().iterator().next());
	}
	...
	public void shouldCreateSourcingResult_MultiOrderEntries()
	{
		...
		Mockito.lenient().when(orderEntry1.getQuantity()).thenReturn(Long.valueOf(2L));
		when(orderEntry1.getQuantityUnallocated()).thenReturn(Long.valueOf(2L));

		Mockito.lenient().when(orderEntry2.getQuantity()).thenReturn(Long.valueOf(3L));
		...
		assertEquals(2L, result.getAllocation().get(orderEntry1).longValue());
		assertTrue(result.getAllocation().containsKey(orderEntry2));
		assertEquals(3L, result.getAllocation().get(orderEntry2).longValue());
		assertSame(warehouse, result.getWarehouse());
	}
