...
public class DefaultPickupWarehouseSelectionStrategyTest
{
	...
	public void setUp()
	{
		...
		Mockito.lenient().when(warehousesFilterProcessor.filterLocations(Sets.newHashSet(warehouseNoPickup))).thenReturn(Collections.emptySet());
		Mockito.lenient().when(warehousesFilterProcessor.filterLocations(Sets.newHashSet(warehouseNoPickup, warehouseForPickup)))
