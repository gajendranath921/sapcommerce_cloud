...
public class DefaultOrderCancellationServiceTest
{
	...
	public void setUp()
	{
		...
		Mockito.lenient().when(modelService.create(CancellationEventModel.class)).thenReturn(consignmentCancellationEvent);
		Mockito.lenient().when(guidKeyGenerator.generate()).thenReturn(UUID.randomUUID());
		...
		Mockito.lenient().when(consignmentEntry1.getOrderEntry()).thenReturn(orderEntry1);
		Mockito.lenient().when(consignmentEntry1.getQuantity()).thenReturn(Long.valueOf(10L));
		Mockito.lenient().when(consignmentEntry2.getOrderEntry()).thenReturn(orderEntry2);
		Mockito.lenient().when(consignmentEntry2.getQuantity()).thenReturn(Long.valueOf(5L));
		Mockito.lenient().when(consignment1.getCode()).thenReturn("consignment1234_1");
		Mockito.lenient().when(consignment1.getConsignmentEntries()).thenReturn(Sets.newHashSet(consignmentEntry1, consignmentEntry2));

		Mockito.lenient().when(consignmentEntry3.getOrderEntry()).thenReturn(orderEntry1);
		Mockito.lenient().when(consignmentEntry3.getQuantity()).thenReturn(Long.valueOf(10L));
		Mockito.lenient().when(consignmentEntry4.getOrderEntry()).thenReturn(orderEntry2);
		Mockito.lenient().when(consignmentEntry4.getQuantity()).thenReturn(Long.valueOf(5L));
		Mockito.lenient().when(consignment2.getCode()).thenReturn("consignment1234_2");
		Mockito.lenient().when(consignment2.getConsignmentEntries()).thenReturn(Sets.newHashSet(consignmentEntry3, consignmentEntry4));
		...
		Mockito.lenient().when(orderCancelRecordEntryModel.getOrderEntriesModificationEntries())
				.thenReturn(Lists.newArrayList(orderEntryCancelRecordEntryModel1, orderEntryCancelRecordEntryModel2));
		Mockito.lenient().when(orderEntryCancelRecordEntryModel1.getOrderEntry()).thenReturn(orderEntry1);
		Mockito.lenient().when(orderEntryCancelRecordEntryModel2.getOrderEntry()).thenReturn(orderEntry2);
	...
	public void shouldCancelNonAllocatedQuantities_WithNote() throws OrderCancelException
	{
		...
		Mockito.lenient().when(orderEntry1.getQuantityAllocated()).thenReturn(Long.valueOf(10L));
	...
	public void shouldCancelAllocatedQuantities_1Consignment() throws OrderCancelException
	{
		...
		final OrderCancelEntry cancellationEntry = new OrderCancelEntry(orderEntry1, 10L, "notes");
		final OrderCancelRequest cancelRequest = new OrderCancelRequest(order, Lists.newArrayList(cancellationEntry));
		Mockito.lenient().when(orderEntry1.getQuantityAllocated()).thenReturn(Long.valueOf(20L));
		Mockito.lenient().when(consignmentEntry1.getQuantityPending()).thenReturn(Long.valueOf(10L));
	...
	public void shouldCancelAllocatedQuantities_2Consignment() throws OrderCancelException
	{
		...
		Mockito.lenient().when(orderEntry1.getQuantityAllocated()).thenReturn(Long.valueOf(20L));
		Mockito.lenient().when(consignmentEntry1.getQuantityPending()).thenReturn(Long.valueOf(10L));
		Mockito.lenient().when(consignmentEntry3.getQuantityPending()).thenReturn(Long.valueOf(10L));
			...
			throws OrderCancelException
	{
		...
		Mockito.lenient().when(orderEntry1.getQuantityAllocated()).thenReturn(Long.valueOf(20L));
		Mockito.lenient().when(orderEntry2.getQuantityAllocated()).thenReturn(Long.valueOf(10L));
		Mockito.lenient().when(consignmentEntry1.getQuantityPending()).thenReturn(Long.valueOf(10L));
		Mockito.lenient().when(consignmentEntry2.getQuantityPending()).thenReturn(Long.valueOf(5L));
		Mockito.lenient().when(consignmentEntry3.getQuantityPending()).thenReturn(Long.valueOf(10L));
		Mockito.lenient().when(consignmentEntry4.getQuantityPending()).thenReturn(Long.valueOf(5L));
	...
	public void shouldCancelHalfAllocatedHalfNotAllocatedQuantities_1Consignment() throws OrderCancelException
	{
		...
		final OrderCancelEntry cancellationEntry = new OrderCancelEntry(orderEntry1, 10L);
		final OrderCancelRequest cancelRequest = new OrderCancelRequest(order, Lists.newArrayList(cancellationEntry));
		Mockito.lenient().when(orderEntry1.getQuantityAllocated()).thenReturn(Long.valueOf(15L));
		Mockito.lenient().when(consignmentEntry1.getQuantityPending()).thenReturn(Long.valueOf(5L));
	...
	public void shouldCancelHalfAllocatedHalfNotAllocatedQuantities_2Consignment() throws OrderCancelException
	{
		...
		Mockito.lenient().when(orderEntry1.getQuantityAllocated()).thenReturn(Long.valueOf(10L));
		Mockito.lenient().when(consignmentEntry1.getQuantityPending()).thenReturn(Long.valueOf(5L));
		Mockito.lenient().when(consignmentEntry3.getQuantityPending()).thenReturn(Long.valueOf(5L));
