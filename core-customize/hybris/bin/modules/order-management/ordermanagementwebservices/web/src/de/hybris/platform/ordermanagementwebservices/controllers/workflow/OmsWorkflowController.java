...
public class OmsWorkflowController extends OmsBaseController
{
	...
	@ResponseBody
	@Secured(ADMIN_GROUP)
	@ApiOperation(nickname = "getWorkflowActions", value = "Finds all active workflow actions for the current user", notes = "Finds all active workflow actions for the current user.", response = WorkflowActionListWsDto.class)
	...
	@Secured(ADMIN_GROUP)
	@ApiOperation(nickname = "decideWorkflowAction", value = "Performs the workflow actions with the provided decision.", notes = "Performs the workflow actions with the provided decision.")
	...
	@ResponseStatus(HttpStatus.OK)
	@Secured(ADMIN_GROUP)
	@ApiOperation(nickname = "decideWorkflowActions", value = "Performs the workflow actions belonging to a list of workflows with the provided decision.", notes = "Performs the workflow actions belonging to a list of workflows with the provided decision.")
