...
public class OmsReturnsController extends OmsBaseController
{
	...
	@ResponseBody
	@ApiOperation(nickname = "getReturns",value = "Finds a paginated list of all the returns in the system", notes = "Returns a paginated list of all the returns in the system", response = ReturnSearchPageWsDTO.class)
	...
	@ResponseBody
	@ApiOperation(nickname = "getReturnsByStatus", value = "Finds a paginated list of returns with one of a set of desired statuses", notes = "Returns a paginated list of returns with one of a set of desired statuses", response = ReturnSearchPageWsDTO.class)
	...
	@ResponseBody
	@ApiOperation(nickname = "getReturnForReturnCode", value = "Finds a specific return request by its code", notes = "Returns a specific return request by its code", response = ReturnRequestWsDTO.class)
	...
	@ResponseBody
	@ApiOperation(nickname = "updateReturnByReturnCode", value = "Updates a return request corresponding to the given code with the modifications provided", notes = "Updates a return request corresponding to the given code with the modifications provided.", response = ReturnRequestWsDTO.class)
	...
	@ResponseBody
	@ApiOperation(nickname = "getReturnStatuses", value = "Finds a list of all return possible return statuses", notes = "Returns a list of all return possible return statuses", response = ReturnStatusListWsDTO.class)
	...
	@ResponseBody
	@ApiOperation(nickname = "getReturnEntriesForOrderCode", value = "Finds a paginated list of return entries for a return request corresponding to the given code", notes = "Returns a paginated list of return entries for a return request corresponding to the given code", response = ReturnEntrySearchPageWsDTO.class)
	...
	@ResponseBody
	@ApiOperation(nickname = "createReturnRequest", value = "Creates a return request", notes = "Creates a return request", response = ReturnRequestWsDTO.class)
	...
	@ResponseBody
	@ApiOperation(nickname = "getReturnsCancellationReasons", value = "Finds a list of all possible return cancellation reasons", notes = "Finds a list of all possible return cancellation reasons", response = CancelReasonListWsDTO.class)
	...
	@ResponseBody
	@ApiOperation(nickname = "getRefundReasons", value = "Finds a list of all possible refund reasons", notes = "Finds a list of all possible return refund reasons", response = RefundReasonListWsDTO.class)
	...
	@ResponseBody
	@ApiOperation(nickname = "getReturnActions", value = "Finds a list of all possible return actions", notes = "Finds a list of all possible return actions", response = ReturnActionListWsDTO.class)
	...
	@ResponseStatus(HttpStatus.OK)
	@ApiOperation(nickname = "approveReturnRequest", value = "Approves a return request corresponding to the given code", notes = "Approves a return request corresponding to the given code")
	...
	@RequestMapping(value = "/cancel", method = RequestMethod.POST, produces = { MediaType.APPLICATION_JSON_VALUE,
			MediaType.APPLICATION_XML_VALUE }, consumes = { MediaType.APPLICATION_JSON_VALUE, MediaType.APPLICATION_XML_VALUE })
	@ResponseStatus(HttpStatus.OK)
	@ApiOperation(nickname = "cancelReturnRequest", value = "Cancels a return request", notes = "Cancels a return request")
	...
	@ResponseStatus(HttpStatus.OK)
	@ApiOperation(nickname = "manuallyReversePayment", value = "Requests manual reversal of the payment for a return", notes = "Requests manual reversal of the payment for a return")
	...
	@ResponseStatus(HttpStatus.OK)
	@ApiOperation(nickname = "manuallyReverseTax", value = "Requests manual reversal of the taxes for a return", notes = "Requests manual reversal of the taxes for a return")
