...
public class OmsOrdersController extends OmsBaseController
{
	...
	@ResponseBody
	@ApiOperation(nickname = "getOrders", value = "Finds all orders in the system", notes = "Returns all orders in the system.", response = OrderSearchPageWsDto.class)
	...
	@ResponseBody
	@ApiOperation(nickname = "getOrderForCode", value = "Finds a single order by a given order code", notes = "Returns a single order in the system.", response = OrderWsDTO.class)
	...
	@ResponseBody
	@ApiOperation(nickname = "getOrdersByStatus",value = "Finds a paginated list of orders for a given set of order statuses", notes = "Returns a paginated list of orders for a given set of order statuses.", response = OrderSearchPageWsDto.class)
	...
	@ResponseBody
	@ApiOperation(nickname = "getOrdersByStatuses",value = "Finds a list of all possible order statuses in the system", notes = "Returns a list of all possible order statuses in the system.", response = OrderStatusListWsDTO.class)
	...
	@ResponseBody
	@ApiOperation(nickname = "getOrderEntriesForOrderCode",value = "Finds a paginated list of order entries for the order with the given code", notes = "Returns a paginated list of order entries for the order with the given code.", response = OrderEntrySearchPageWsDTO.class)
	...
	@ResponseBody
	@ApiOperation(nickname = "getOrderEntryForOrderCodeAndEntryNumber",value = "Finds the order entry corresponding to the given entry number for the order with the given code", notes = "Returns the order entry corresponding to the given entry number for the order with the given code.", response = OrderEntryWsDTO.class)
	...
	@ResponseBody
	@ApiOperation(nickname = "getCancelReason",value = "Finds a list of all cancellation reasons", notes = "Returns a list of all cancellation reasons.", response = CancelReasonListWsDTO.class)
	...
	@ResponseBody
	@ApiOperation(nickname = "getOrderFraudReports",value = "Finds a list of all fraud reports for an order with the given code", notes = "Returns a list of all fraud reports for an order with the given code.", response = FraudReportListWsDTO.class)
	...
	@ResponseBody
	@ApiOperation(nickname = "submitOrder", value = "Submits an order to the system", notes = "Posts an order to the system.", response = OrderWsDTO.class)
	...
	@ApiOperation(nickname = "approvePotentiallyFraudulentOrder",value = "Approves an order that could potentially be fraudulent", notes = "Approves an order that could potentially be fraudulent.")
	...
	@ResponseStatus(HttpStatus.OK)
	@ApiOperation(nickname = "rejectPotentiallyFraudulentOrder",value = "Rejects an order that could be potentially fraudulent", notes = "Rejects an order that could potentially be fraudulent.")
	...
	@ResponseStatus(HttpStatus.CREATED)
	@ResponseBody
	@ApiOperation(nickname = "createCancelRequest",value = "Creates an order cancellation in the system", notes = "Creates an order cancellation request.", response = OrderCancelRequestData.class)
	...
	@ResponseStatus(HttpStatus.OK)
	@ApiOperation(nickname = "manuallyReleasePaymentVoid",value = "Moves an order out of the waiting step after payment authorization cancellation has failed, indicating payment was voided.", notes = "Moves an order out of the waiting step after payment authorization cancellation has failed, indicating payment was voided.")
	...
	@RequestMapping(value = "/{code}/manual/void-tax", method = RequestMethod.POST, produces = { MediaType.APPLICATION_JSON_VALUE,
			MediaType.APPLICATION_XML_VALUE }, consumes = { MediaType.APPLICATION_JSON_VALUE, MediaType.APPLICATION_XML_VALUE })
	@ResponseStatus(HttpStatus.OK)
	@ApiOperation(nickname = "manuallyReleaseTaxVoid",value = "Moves an order out of the waiting step after tax post void has failed.", notes = "Moves an order out of the waiting step after tax post void has failed.")
	...
	@RequestMapping(value = "/{code}/manual/commit-tax", method = RequestMethod.POST, produces = {
			...
			MediaType.APPLICATION_XML_VALUE })
	@ResponseStatus(HttpStatus.OK)
	@ApiOperation(nickname = "manuallyReleaseTaxCommit",value = "Moves an order out of the waiting step after tax commit has failed.", notes = "Moves an order out of the waiting step after tax commit has failed.")
	...
	@RequestMapping(value = "/{code}/manual/requote-tax", method = RequestMethod.POST, produces = {
			...
			MediaType.APPLICATION_XML_VALUE })
	@ResponseStatus(HttpStatus.OK)
	@ApiOperation(nickname = "manuallyReleaseTaxRequote",value = "Moves an order out of the waiting step after tax requote has failed.", notes = "Moves an order out of the waiting step after tax requote has failed.")
	...
	@RequestMapping(value = "/{code}/manual/reauth-payment", method = RequestMethod.POST, produces = {
			...
			MediaType.APPLICATION_XML_VALUE })
	@ResponseStatus(HttpStatus.OK)
	@ApiOperation(nickname = "manuallyReleasePaymentReauth",value = "Moves an order out of the waiting step after payment reauthorization has failed, indicating payment was reauthorized.", notes = "Moves an order out of the waiting step after payment reauthorization has failed, indicating payment was reauthorized.")
	...
	@RequestMapping(value = "/{code}/manual/delivery-cost-commit", method = RequestMethod.POST, produces = {
			...
			MediaType.APPLICATION_XML_VALUE })
	@ResponseStatus(HttpStatus.OK)
	@ApiOperation(nickname = "manuallyReleaseDeliveryCostCommit",value = "Moves an order out of the waiting step after delivery cost tax commit has failed, indicating tax was committed.", notes = "Moves an order out of the waiting step after delivery cost tax commit has failed, indicating tax was committed.")
