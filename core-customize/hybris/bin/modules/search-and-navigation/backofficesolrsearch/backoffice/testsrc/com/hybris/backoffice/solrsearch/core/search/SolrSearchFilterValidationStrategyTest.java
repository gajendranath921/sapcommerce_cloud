...
public class SolrSearchFilterValidationStrategyTest
{
	...
	{
		// given
		when(solrSearchStrategy.getFieldType(TYPE_CODE, FILTER_NAME)).thenReturn(null);
	...
	{
		// given
		when(solrSearchStrategy.getFieldType(TYPE_CODE, FILTER_NAME)).thenReturn("SomeOtherType");
	...
	{
		// given
		when(solrSearchStrategy.getFieldType(TYPE_CODE, FILTER_NAME)).thenReturn(Object.class.getName());
	...
	{
		// given
		when(solrSearchStrategy.isLocalized(TYPE_CODE, FILTER_NAME)).thenReturn(true);
	...
	{
		// given
		when(solrSearchStrategy.isLocalized(TYPE_CODE, FILTER_NAME)).thenReturn(false);
