...
public class BackofficeIndexerStrategyFactoryTest
{
	...
	public void shouldCreateBackofficeIndexerStrategy() throws Exception
	{
		...
		when(Boolean.valueOf(facetSearchConfigService.isValidSearchConfiguredForName(BACKOFFICE_CONFIG_NAME)))
	...
	public void shouldCreateDefaultIndexerStrategy() throws Exception
	{
		...
		when(Boolean.valueOf(facetSearchConfigService.isValidSearchConfiguredForName(OTHER_CONFIG_NAME)))
