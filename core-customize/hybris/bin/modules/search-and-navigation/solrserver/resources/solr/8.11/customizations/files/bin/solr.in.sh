...
#override previously defined SOLR_SSL_* SSL values for HTTP client
...
#SOLR_SSL_CLIENT_TRUST_STORE=solr/solr_client.p12
#SOLR_SSL_CLIENT_TRUST_STORE_PASSWORD=123456
