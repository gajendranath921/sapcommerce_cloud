...
public class YCommerceWebServicesTestSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		...
		getSetupImpexService().importImpexFile("/ycommercewebservicestest/import/sampledata/productCatalogs/wsTestProductCatalog/products-future-stocks.impex",true, false);
	...
	protected void loadMultiDimensionalData()
	{
		...
		getSetupImpexService().importImpexFile(
				...
				false);
		getSetupImpexService().importImpexFile(
				 "/ycommercewebservicestest/import/sampledata/productCatalogs/wsTestProductCatalog/dimension-products-media.impex", true,
				 false);
		getSetupImpexService().importImpexFile(
