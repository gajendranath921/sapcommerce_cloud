...
import de.hybris.platform.ycommercewebservices.user.data.LoginChangeResponse;
import de.hybris.platform.ycommercewebservices.user.data.PasswordRestoreResponse;
