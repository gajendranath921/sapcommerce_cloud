...
public class DefaultOrgUnitService implements OrgUnitService
{
	...
	{
		createUnitInternal(parameter);
	}

	@Override
	public Optional<OrgUnitModel> createAndGetUnit(final OrgUnitParameter parameter)
	{
		return createUnitInternal(parameter);
	}

	protected Optional<OrgUnitModel> createUnitInternal(final OrgUnitParameter parameter)
	{
