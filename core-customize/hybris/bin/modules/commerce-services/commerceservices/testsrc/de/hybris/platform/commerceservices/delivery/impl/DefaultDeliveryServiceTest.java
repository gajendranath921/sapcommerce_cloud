...
public class DefaultDeliveryServiceTest
{
	...
	public void testGetSupportedDeliveryModes()
	{
		...
		final AddressModel address = mock(AddressModel.class, withSettings().lenient());
		...
		given(deliveryModeLookupStrategy.getSelectableDeliveryModesForOrder(cartModel))
				.willReturn(new ArrayList<DeliveryModeModel>(Collections.singletonList(deliveryModeModel)));
