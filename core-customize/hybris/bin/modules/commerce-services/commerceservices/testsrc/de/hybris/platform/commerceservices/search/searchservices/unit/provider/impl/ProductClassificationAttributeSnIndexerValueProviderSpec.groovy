...
@UnitTest
public class ProductClassificationAttributeSnIndexerValueProviderSpec extends AbstractSpockTest {
	...
	@Test
	def "Fail to provide value with invalid classification attribute param"() {
		given:
		SnField field = new SnField(id: FIELD_1_ID)
		Map<String, String> valueProviderParameters = Map.of(ProductClassificationAttributeSnIndexerValueProvider.CLASSIFICATION_ATTRIBUTE_PARAM, "abc")
	...
	def "Provide value"() {
		...
		then:
		document.getFields().get(FIELD_1_ID) == value
	}

	@Test
	def "Provide multi-valued value"() {
		given:
		SnField field = new SnField(id: FIELD_1_ID, multiValued: true)
		Map<String, String> valueProviderParameters = Map.of(ProductClassificationAttributeSnIndexerValueProvider.CLASSIFICATION_ATTRIBUTE_PARAM, CLASSIFICATON_ATTRIBUTE_1)
		...
		classificationService.getFeatures(product, List.of(classAttributeAssignment)) >> featureList
		featureList.getFeatureByAssignment(classAttributeAssignment) >> feature
		feature.getValues() >> List.of(featureValue1, featureValue2)
		...
		then:
		document.getFields().get(FIELD_1_ID) == List.of(value1, value2)
	}
	...
	def "Provide localized value"() {
		...
		document.getFields().get(FIELD_1_ID) == [
			(Locale.ENGLISH): valueEn,
			(Locale.GERMAN) : valueDe
		]
	}

	@Test
	def "Provide multi-valued localized value"() {
		given:
		SnField field = new SnField(id: FIELD_1_ID, localized: true, multiValued: true)
		Map<String, String> valueProviderParameters = Map.of(ProductClassificationAttributeSnIndexerValueProvider.CLASSIFICATION_ATTRIBUTE_PARAM, CLASSIFICATON_ATTRIBUTE_1)
		SnQualifier qualifier1 = Mock()
		SnQualifier qualifier2 = Mock()
		List<SnQualifier> qualifiers = List.of(qualifier1, qualifier2)
		...
		FeatureList featureList = Mock()
		LocalizedFeature feature = Mock()
		FeatureValue featureValueEn1 = Mock()
		FeatureValue featureValueEn2 = Mock()
		Object valueEn1 = Mock()
		Object valueEn2 = Mock()
		FeatureValue featureValueDe1 = Mock()
		FeatureValue featureValueDe2 = Mock()
		Object valueDe1 = Mock()
		Object valueDe2 = Mock()
		...
		classificationService.getFeatures(product, List.of(classAttributeAssignment)) >> featureList
		featureList.getFeatureByAssignment(classAttributeAssignment) >> feature
		feature.getValues(Locale.ENGLISH) >> List.of(featureValueEn1, featureValueEn2)
		featureValueEn1.getValue() >> valueEn1
		featureValueEn2.getValue() >> valueEn2
		feature.getValues(Locale.GERMAN) >> List.of(featureValueDe1, featureValueDe2)
		featureValueDe1.getValue() >> valueDe1
		featureValueDe2.getValue() >> valueDe2
		...
		then:
		document.getFields().get(FIELD_1_ID) == [
			(Locale.ENGLISH): List.of(valueEn1, valueEn2),
			(Locale.GERMAN) : List.of(valueDe1, valueDe2)
		]
	}
	...
	def "Provide values for multiple fields"() {
		...
		SnField field2 = new SnField(id: FIELD_2_ID, multiValued: true)
		...
		then:
		document.getFields().get(FIELD_1_ID) == value1
