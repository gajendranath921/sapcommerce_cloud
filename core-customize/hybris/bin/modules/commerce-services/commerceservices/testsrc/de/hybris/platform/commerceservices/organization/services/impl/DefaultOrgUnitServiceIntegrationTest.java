...
public class DefaultOrgUnitServiceIntegrationTest extends BaseCommerceBaseTest
{
	...
	protected void validateCreateUnit()
	{
		...
		defaultOrgUnitService.createUnit(
				OrgUnitServiceTestUtil.createOrgUnitParam(null, rootUnit, EU_UNIT_UID, EU_UNIT_NAME, Boolean.TRUE,
						EU_UNIT_DESCRIPTION));

		final OrgUnitModel europe = OrgUnitServiceTestUtil.getUnit(EU_UNIT_UID, defaultOrgUnitService);
		validateCreateUnitResult(rootUnit, europe);
	}
	...
	protected void validateCreateAndGetUnit()
	{
		...
		final Optional<OrgUnitModel> europe = defaultOrgUnitService.createAndGetUnit(
				OrgUnitServiceTestUtil.createOrgUnitParam(null, rootUnit, EU_UNIT_UID, EU_UNIT_NAME, Boolean.TRUE,
						EU_UNIT_DESCRIPTION));

		Assert.assertTrue(europe.isPresent());
		validateCreateUnitResult(rootUnit, europe.get());
	}

	protected void validateCreateUnitResult(final OrgUnitModel rootUnit, final OrgUnitModel europe)
	{
	...
	public void shouldNotCreateAndGetUnitForOrgEmployee()
	{
		...
		defaultOrgUnitService.createAndGetUnit(
				OrgUnitServiceTestUtil.createOrgUnitParam(null, OrgUnitServiceTestUtil.getUnit(ROOT_UNIT_UID, defaultOrgUnitService),
						EU_UNIT_UID, EU_UNIT_NAME, Boolean.TRUE, EU_UNIT_DESCRIPTION));
	}
	...
	public void shouldUpdateUnit() throws ImpExException
	{
		...
		defaultOrgUnitService.updateUnit(
				OrgUnitServiceTestUtil.createOrgUnitParam(montreal, northAmerica, UPDATED_UNIT_UID, UPDATED_UNIT_NAME, Boolean.FALSE,
	...
	public void shouldUpdateUnitWithoutUpdatingParentForOrgManager()
	{
		...
		defaultOrgUnitService.updateUnit(
				OrgUnitServiceTestUtil.createOrgUnitParam(montreal, actualParent, UPDATED_UNIT_UID, UPDATED_UNIT_NAME, Boolean.FALSE,
						UPDATED_UNIT_DESCRIPTION));
	...
	public void shouldNotUpdateUnitWithUpdatingParentForOrgManager()
	{
		...
		defaultOrgUnitService.updateUnit(
				OrgUnitServiceTestUtil.createOrgUnitParam(montreal, newParent, UPDATED_UNIT_UID, UPDATED_UNIT_NAME, Boolean.FALSE,
						UPDATED_UNIT_DESCRIPTION));
	}
	...
	public void shouldNotUpdateUnitForOrgEmployee()
	{
		...
		defaultOrgUnitService.updateUnit(
				OrgUnitServiceTestUtil.createOrgUnitParam(montreal, null, UPDATED_UNIT_UID, UPDATED_UNIT_NAME, Boolean.FALSE,
						UPDATED_UNIT_DESCRIPTION));
	}
	...
	public void shouldNotAddMembersForOrgEmployee()
	{
		...
		defaultOrgUnitService.addMembers(
				OrgUtils.createOrgUnitMemberParameter(CA_UNIT_UID, Collections.emptySet(), EmployeeModel.class,
						createPageableData(0, 5)));
	}
	...
	public void shouldNotRemoveMembersForOrgEmployee()
	{
		...
		defaultOrgUnitService.removeMembers(
				OrgUtils.createOrgUnitMemberParameter(US_UNIT_UID, Collections.emptySet(), EmployeeModel.class,
						createPageableData(0, 5)));
	}
	...
	protected void validateGetMembers()
	{
		final SearchPageData<EmployeeModel> searchPageData = defaultOrgUnitService.getMembers(
				OrgUtils.createOrgUnitMemberParameter(NA_UNIT_UID, Collections.emptySet(), EmployeeModel.class,
						createPageableData(0, 5)));
	...
	{
		defaultOrgUnitService.getMembers(
				OrgUtils.createOrgUnitMemberParameter(NA_UNIT_UID, Collections.emptySet(), EmployeeModel.class, null));
	}
	...
	/**
	 * @param searchRoleUid A role Uid to search for
	 * @param roleSet       Set of roles to be searched against
