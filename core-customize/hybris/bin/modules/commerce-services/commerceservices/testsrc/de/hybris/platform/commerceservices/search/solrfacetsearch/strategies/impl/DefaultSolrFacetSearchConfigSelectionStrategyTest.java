...
public class DefaultSolrFacetSearchConfigSelectionStrategyTest
{
	...
	public void setUp()
	{
		...
		strategy.setSolrFacetSearchConfigDao(solrFacetSearchConfigDao);
		when(solrFacetSearchConfigDao.findAllFacetSearchConfigs()).thenReturn(Collections.<SolrFacetSearchConfigModel> emptyList());
	...
	public void testIndexConfigForBaseSiteConfigured() throws NoValidSolrConfigException
	{
		...
		lenient().when(baseStore.getSolrFacetSearchConfiguration()).thenReturn(null);
	...
	public void testIndexConfigForBaseStoreAndBaseSiteConfigured() throws NoValidSolrConfigException
	{
		...
		lenient().when(baseStore.getSolrFacetSearchConfiguration()).thenReturn(solrFacetSearchConfigModel2);
	...
	public void testFallbackFromCatalogVersions() throws NoValidSolrConfigException
	{
		...
		when(solrFacetSearchConfigDao.findAllFacetSearchConfigs())
				.thenReturn(
