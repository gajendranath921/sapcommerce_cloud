 ...
 */
package de.hybris.platform.commercewebservices.core.constants;

public class YcommercewebservicesConstants extends GeneratedYcommercewebservicesConstants
{
	public static final String MODULE_NAME = "commercewebservices";
	public static final String MODULE_WEBROOT = "occ";
