...
public class PickupOrderEntryGroupPopulatorTest
{
	...
	public void testPopulate()
	{
		...
		final AbstractOrderEntryModel entryModel4 = mock(AbstractOrderEntryModel.class, withSettings().lenient());
		...
		final PointOfServiceModel pointOfServiceModel1 = mock(PointOfServiceModel.class, withSettings().lenient());
		final PointOfServiceModel pointOfServiceModel2 = mock(PointOfServiceModel.class, withSettings().lenient());
