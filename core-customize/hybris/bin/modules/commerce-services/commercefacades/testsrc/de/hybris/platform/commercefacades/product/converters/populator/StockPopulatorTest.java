...
@UnitTest
public class StockPopulatorTest
{
	private StockPopulator<ProductModel, StockData> populator;
	...
	private DefaultBaseSiteService baseSiteService;
	...
	public void setUp()
	{
		...
		populator = new StockPopulator<ProductModel, StockData>();
		...
		baseSiteService = Mockito.mock(DefaultBaseSiteService.class);
	...
	public void onlyOneCategorySetForTheProductWithoutValue()
	{
		...
		Mockito.when(baseSiteModel.getDefaultStockLevelThreshold()).thenReturn(null);
	...
	public void onlyDefaultStockThresholdAtSiteLevelHavingValue()
	{
		...
		mockSuperCategories(size7, yellow, fit_W, size, fit, color, men, shoes, safety, apparel);
		Mockito.when(baseSiteService.getCurrentBaseSite()).thenReturn(baseSiteModel);
		Mockito.when(baseSiteModel.getDefaultStockLevelThreshold()).thenReturn(10);
		mockSomeStuff();
