...
public class OrderPopulatorTest
{
	...
	private static final String TEST_QUOTE_CODE = "testQuoteCode";
	@Mock
	...
	public void testConvert()
	{
		...
		given(orderEntryConverter.convertAll(Collections.singletonList(abstractOrderEntryModel)))
				.willReturn(Collections.singletonList(entryData));
		...
		given(quoteModel.getCode()).willReturn(TEST_QUOTE_CODE);
		...
		Assert.assertEquals(TEST_QUOTE_CODE, orderData.getQuoteCode());
	}
}
