...
public class BaseSitePopulatorTest
{
	...
	public void setUp() throws Exception
	{
		...
		when(baseSiteModel.isRequiresAuthentication()).thenReturn(true);
	...
	public void populate()
	{
		...
		assertTrue(baseSiteData.isRequiresAuthentication());
	}
	...
	public void populateWithOptionalFieldsEqualToNull()
	{
		...
		when(baseSiteModel.isRequiresAuthentication()).thenReturn(false);
