...
public class DeliveryOrderEntryGroupPopulatorTest
{
	...
	public void testPopulate()
	{
		...
		final AbstractOrderEntryModel entryModel2 = mock(AbstractOrderEntryModel.class, withSettings().lenient());
		final AbstractOrderEntryModel entryModel3 = mock(AbstractOrderEntryModel.class, withSettings().lenient());
