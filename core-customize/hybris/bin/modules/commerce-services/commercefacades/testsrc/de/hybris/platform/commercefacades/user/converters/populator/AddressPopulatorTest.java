...
public class AddressPopulatorTest
{
	...
	public void testConvert()
	{
		...
		given(addressModel.getDistrict()).willReturn("district");
		given(addressModel.getPostalcode()).willReturn("postalCode");
		given(addressModel.getPhone1()).willReturn("phone");
		given(addressModel.getCellphone()).willReturn("cellphone");
		...
		Assert.assertEquals("district", addressData.getDistrict());
