...
public class DefaultFutureStockFacade implements FutureStockFacade
{
	...
	public List<FutureStockData> getFutureAvailability(final String productCode)
	{
		...
		return mapFutureStock.getOrDefault(productCode, Collections.emptyList());
	}
	 ...
	 *
	 * @param productCode The product that is related to the variants.
	 * @param skus        Product codes of the desired variants.
	...
	public List<String> filterSelectedVariantProducts(final String productCode, final List<String> skus)
	{
		...
		if (CollectionUtils.isNotEmpty(skus))
		{
			...
			final Set<String> skusSet = new HashSet<>(skus);
	...
	{
		final List<String> selectedProductModels = new ArrayList<>();
	...
	public static class FutureStockDataComparator implements Comparator<FutureStockData>, Serializable
	{
