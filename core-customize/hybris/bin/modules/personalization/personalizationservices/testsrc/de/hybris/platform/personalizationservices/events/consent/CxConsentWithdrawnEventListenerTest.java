...
public class CxConsentWithdrawnEventListenerTest
{
	...
	public void testNull()
	{
		...
		//then
		verify(recalculationService, times(0)).recalculate(any(), anyListOf(RecalculateAction.class));
		verify(cxUserSegmentService, times(0)).setUserSegments(any(), anyCollectionOf(CxUserToSegmentModel.class));
	...
	public void testNoData()
	{
		...
		//then
		verify(recalculationService, times(0)).recalculate(any(), anyListOf(RecalculateAction.class));
		verify(cxUserSegmentService, times(0)).setUserSegments(any(), anyListOf(CxUserToSegmentModel.class));
		verify(cxCatalogService, times(0)).getConfiguredCatalogVersions();
		verify(cxActionResultService, times(0)).getCxResults(any(), any());
		verify(modelService, times(0)).remove(any());
	}
