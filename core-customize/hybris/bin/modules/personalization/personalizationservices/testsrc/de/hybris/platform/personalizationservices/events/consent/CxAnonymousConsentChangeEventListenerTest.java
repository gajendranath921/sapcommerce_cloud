...
public class CxAnonymousConsentChangeEventListenerTest
{
	...
	public void testNull()
	{
		...
		//then
		verify(recalculationService, times(0)).recalculate(anyListOf(RecalculateAction.class));
	}
	...
	public void testGivenConsent()
	{
		...
		final List<RecalculateAction> actionList = Collections.singletonList(RECALCULATE);
