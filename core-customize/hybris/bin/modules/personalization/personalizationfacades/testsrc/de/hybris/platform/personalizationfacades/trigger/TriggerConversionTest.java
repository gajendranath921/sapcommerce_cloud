...
public class TriggerConversionTest extends AbstractFacadeIntegrationTest
{
	...
	public void reverseTest() throws Exception
	{
		...
		Assert.assertEquals(CxSegmentTriggerModel.class, aResult.getClass());
	...
	public void reverseExTest() throws Exception
	{
		...
		//then
		Assert.assertNotNull(aResult);
		Assert.assertEquals(CxExpressionTriggerModel.class, aResult.getClass());
	...
	public void reverseDefaultTriggerTest() throws Exception
	{
		...
		//then
		Assert.assertNotNull(aResult);
		Assert.assertEquals(CxDefaultTriggerModel.class, aResult.getClass());
