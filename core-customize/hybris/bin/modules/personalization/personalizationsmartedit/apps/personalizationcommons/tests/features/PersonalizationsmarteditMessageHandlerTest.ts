import { PersonalizationsmarteditMessageHandler } from 'personalizationcommons/services';
...
describe('PersonalizationsmarteditMessageHandler', () => {
    ...
    beforeEach(() => {
        ...
        personalizationsmarteditMessageHandler = new PersonalizationsmarteditMessageHandler(
            alertService
        );
    });
