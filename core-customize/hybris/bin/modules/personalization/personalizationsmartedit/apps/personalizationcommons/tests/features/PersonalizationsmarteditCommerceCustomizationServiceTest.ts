import { PersonalizationsmarteditCommerceCustomizationService } from 'personalizationcommons/services';
...
describe('personalizationsmarteditCommerceCustomizationService', function () {
    ...
    describe('getAvailableTypes', () => {
        it('should be defined', () => {
            expect(
                personalizationsmarteditCommerceCustomizationService.getAvailableTypes
            ).toBeDefined();
        });

        it('should be empty when configuration is null', () => {
            expect(
                personalizationsmarteditCommerceCustomizationService.getAvailableTypes(null)
            ).toEqual([]);
        });

        it('should be empty when configuration is undefined', () => {
            expect(
                personalizationsmarteditCommerceCustomizationService.getAvailableTypes(undefined)
            ).toEqual([]);
        });
        ...
        it('should return type when it is enabled in configuration', () => {
            ...
            // when
            const availabelTypes = personalizationsmarteditCommerceCustomizationService.getAvailableTypes(
                confWithType1Enabled
            );
    ...
    describe('isCommerceCustomizationEnabled', () => {
        it('should be defined', () => {
            expect(
                personalizationsmarteditCommerceCustomizationService.isCommerceCustomizationEnabled
            ).toBeDefined();
        });
        ...
        it('should return true when at least one type is enabled', () => {
            ...
            // when
            const enabled = personalizationsmarteditCommerceCustomizationService.isCommerceCustomizationEnabled(
                confWithType1Enabled
            );
