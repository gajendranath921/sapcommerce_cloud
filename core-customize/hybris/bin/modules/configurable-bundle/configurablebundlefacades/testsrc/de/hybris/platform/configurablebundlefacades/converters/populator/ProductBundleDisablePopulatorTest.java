...
public class ProductBundleDisablePopulatorTest
{
	...
	public void shouldThrowExceptionWhenSourceIsNull()
	{
		...
		assertThat(productData.getAddToCartDisabled()).isEqualTo(null);
	}
	...
	public void testPopulateOneTargetDisableRule()
	{
		...
		assertThat(productData.getAddToCartDisabled()).isEqualTo(null);
		assertThat(disabledProductData.getAddToCartDisabled()).isEqualTo(true);
	...
	public void testPopulateMixedDisableRules()
	{
		...
		assertThat(productData.getAddToCartDisabled()).isEqualTo(null);
		assertThat(disabledProductData.getAddToCartDisabled()).isEqualTo(true);
		assertThat(disabledProductData2.getAddToCartDisabled()).isEqualTo(true);
	}
	...
	{		
		...
		assertThat(resultProducts).containsExactly(productData, disabledProductData);
		assertThat(productData.getAddToCartDisabled()).isEqualTo(null);
		assertThat(disabledProductData.getAddToCartDisabled()).isEqualTo(null);
	}
