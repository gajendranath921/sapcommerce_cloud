...
public class ProductBundleStarterPopulatorTest
{
	...
	public void setUp()
	{
		...
		Mockito.lenient().when(bundleTemplateConverter.convertAll(eq(Arrays.asList(starterBundleTemplate,notStarterBundleTemplate))))
				.thenReturn(Arrays.asList(starterData, notStarterData));
		Mockito.lenient().when(bundleTemplateConverter.convertAll(eq(Collections.singletonList(starterBundleTemplate)))).thenReturn(
				Collections.singletonList(starterData));
		Mockito.lenient().when(bundleTemplateConverter.convertAll(eq(Collections.singletonList(notStarterBundleTemplate)))).thenReturn(
