...
@UnitTest
public class BundleTemplateCatalogVersionConditionAdapterTest extends BundleTemplateConditionAdapterTestBase
{
	private final BundleTemplateConditionAdapter adapter = new BundleTemplateCatalogVersionConditionAdapter();
	...
	@Test
	public void shouldAcceptCatalogVersionNode()
	{
		//given
		final NavigationNode node = getNodeFactory().createCatalogVersionNode(staged);
		//when
