 ...
 */
@IntegrationTest
public class ConfigurableBundleTemplatePrepareInterceptorIntegrationTest extends ServicelayerTest
{

	private static final Logger LOG = Logger.getLogger(ConfigurableBundleTemplatePrepareInterceptorIntegrationTest.class);
