...
public class BundleTemplateStatusIDPrepareInterceptorIntegrationTest extends ServicelayerTest
{
	...
	public void testGenerateAbstractBundleRuleID()
	{
		...
		Assert.assertNotEquals(bundleStatus1.getId(), bundleStatus2.getId());
		...
		Assert.assertNotEquals(bundleStatus1.getId(), bundleStatus3.getId());
		Assert.assertNotEquals(bundleStatus2.getId(), bundleStatus3.getId());
		...
		Assert.assertNotEquals(bundleStatus1.getId(), bundleStatus5.getId());
		Assert.assertNotEquals(bundleStatus2.getId(), bundleStatus5.getId());
		Assert.assertNotEquals(bundleStatus3.getId(), bundleStatus5.getId());
