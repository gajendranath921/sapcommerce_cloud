...
public class AbstractBundleRuleIDPrepareInterceptorIntegrationTest extends ServicelayerTest
{
	...
	public void testGenerateAbstractBundleRuleID()
	{
		...
		Assert.assertNotEquals(bundleRule1.getId(), bundleRule2.getId());
		...
		Assert.assertNotEquals(bundleRule1.getId(), bundleRule3.getId());
		Assert.assertNotEquals(bundleRule2.getId(), bundleRule3.getId());
		...
		Assert.assertNotEquals(bundleRule1.getId(), bundleRule5.getId());
		Assert.assertNotEquals(bundleRule2.getId(), bundleRule5.getId());
		Assert.assertNotEquals(bundleRule3.getId(), bundleRule5.getId());
