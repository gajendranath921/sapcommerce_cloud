...
public class ConfPipeMockImpl extends BaseRunTimeConfigMockImpl
{
	...
	private Collection<PriceRowModel> europe1Prices;
	...
	protected void setBasePrices(final ConfigModel model, Double price)
	{
	...
	@Override
	public void addProductAttributes(ConfigModel model, ProductModel productModel)
	{
		if (productModel != null)
		{
			europe1Prices = productModel.getEurope1Prices();
