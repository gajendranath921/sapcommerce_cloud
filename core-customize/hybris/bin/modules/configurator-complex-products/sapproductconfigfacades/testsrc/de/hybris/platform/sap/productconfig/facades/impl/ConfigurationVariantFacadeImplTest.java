...
public class ConfigurationVariantFacadeImplTest
{
	...
	public void setUp()
	{
		...
		given(productConfigurationServiceMock.retrieveConfigurationModel(CONFIG_ID)).willReturn(configModel);
	...
	{
		given(productConfigurationServiceMock.retrieveConfigurationModel(CONFIG_ID)).willReturn(null);
	...
	{
		given(productConfigurationServiceMock.retrieveConfigurationModel(CONFIG_ID)).willReturn(new ConfigModelImpl());
		classUnderTest.searchForSimilarVariants(CONFIG_ID);
 	}	
