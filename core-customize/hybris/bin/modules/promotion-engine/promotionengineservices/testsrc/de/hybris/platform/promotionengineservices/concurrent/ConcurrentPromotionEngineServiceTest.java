 ...
 */
@IntegrationTest
public class ConcurrentPromotionEngineServiceTest extends PromotionEngineServiceBaseTestBase
{
	...
	{
		final String FIND_ORDERS_BY_CODE_QUERY = "GET {" + CartModel._TYPECODE + "} ";
