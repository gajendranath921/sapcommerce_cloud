...
public class PromotionEngineResultsPopulatorTest
{
	...
	public void setUp() throws Exception
	{
		...
		Mockito.lenient().when(orderDiscountPromotionsConverter.convert(order)).thenReturn(orderLevelPromotionEngineResults);
		Mockito.lenient().when(orderEntryDiscountPromotionConverter.convertAll(order.getEntries())).thenReturn(newArrayList(orderEntryLevelPromotionsResult));
	}
