...
class PromotionRulesSpec extends AbstractPromotionEngineServicesSpockTest
{
	...
	def "#testId : Adding #productsToAddToCart to Cart(#forCurrency) with #promotionRules promotions should give free gifts #gifts and amount to #promotedAmount with the promotions and #baseAmount without it"()
	{
		...
		'Test_Order_Threshold_Percentage_Discount_Cart' | ['1934793': 3] | ['order_threshold_percentage_discount_cart']| []| 269.6 | 299.55 | 'USD'
		...
		'Test_No_Halt' | ['493683': 3] | ['order_threshold_fixed_discount_cart', 'order_threshold_percentage_discount_cart']| []| 299.82 | 355.35 | 'USD'
		...
		'Test_Halt' | ['493683': 3] | ['order_threshold_fixed_discount_cart', 'order_threshold_percentage_discount_cart_then_halt']| []| 319.82 | 355.35 | 'USD'
		...
		// threshold of order_threshold_percentage_discount_cart_then_halt ($250) is reached and the rule triggers first as it has the highest priority of the 2 rules
		// following evaluations stopped as the rule calls drools.halt(). That's why the 2nd promotion doesn't trigger
		'Test_Halt_First' | ['493683': 3] | ['order_threshold_fixed_discount_cart', 'order_threshold_percentage_discount_cart_then_halt_first']| []| 319.82 | 355.35 | 'USD'
	...
	def "#testId : Adding #productsToAddToCart to Cart(#forCurrency) with #promotionRules promotions should amount to #promotedAmount with the promotions and #baseAmount without it when consumption mode is #consumption"()
	{
		...
		where:
			...
			//test for discount to a subset of cart,when qualifying container has reached the threshold of 199$, then give target container discount
			//qualifying containerX has products 779848 and 1291399, target containerA has products 834955 and 779864
			'Test_Subset_Cart_Percentage_Discount_Consumption_Disabled' | ['779848': 20, '1291399': 4, '834955': 10, '779864': 10, '779866': 1] | ['consumption_disabled_subset_cart_percentage_discount'] 												| 351.10   			| 382    		| 'USD'       | false
			'Test_Subset_Cart_Fixed_Discount_Consumption_Disabled' 		| ['779848': 20, '1291399': 4, '834955': 10, '779864': 10, '779866': 1] | ['consumption_disabled_subset_cart_fixed_discount'] 													| 352   			| 382    		| 'USD'       | false
