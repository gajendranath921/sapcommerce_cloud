...
public class DefaultRuleBasedPromotionsContextValidatorTest
{
	...
	{
		Mockito.lenient().when(promotion.getRule()).thenReturn(new DroolsRuleModel());
	}
	...
	{
		//given
		Mockito.lenient().when(promotion.getRule()).thenReturn(new AbstractRuleEngineRuleModel());
		//when
