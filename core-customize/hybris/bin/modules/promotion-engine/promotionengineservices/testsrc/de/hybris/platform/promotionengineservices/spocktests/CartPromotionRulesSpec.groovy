...
class CartPromotionRulesSpec extends AbstractPromotionEngineServicesSpockTest
{
	...
	def "#testId : Adding #productsToAddToCart to Cart(#forCurrency) should amount to #promotedAmount with #promotionRules promotion and #baseAmount without it"()
	{
		...
		'Test_Apply_Promotion_To_Cart_Total_Bigger_250_Three_Same_Products' | ['1934793': 3] |['order_threshold_percentage_discount_cart']| 269.6 | 299.55 | 'USD'
		...
		'Test_Apply_Not_Exclusive_Promotions_To_Cart_' | ['1934793': 3] |['order_threshold_percentage_discount_cart', 'order_threshold_fixed_discount_cart']| 249.6 | 299.55 | 'USD'
		...
		'Test_Apply_Exclusive_Promotions_To_Cart_' | ['1934793': 3] |['order_threshold_percentage_discount_cart_exclusive', 'order_threshold_fixed_discount_cart_exclusive']| 269.6 | 299.55 | 'USD'
		...
		// 10% discount
		'Test_Percentage_Discount_When_Product_NOT_In_Cart' | ['1382080': 1] |['product_not_in_cart_percentage_discount']| 517.4 | 574.88 | 'USD'
