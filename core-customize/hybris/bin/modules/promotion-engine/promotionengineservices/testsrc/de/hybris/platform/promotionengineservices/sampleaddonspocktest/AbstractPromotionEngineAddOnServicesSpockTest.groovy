...
@Ignore
class AbstractPromotionEngineAddOnServicesSpockTest extends ServicelayerSpockSpecification
{
	private static final Logger LOG = LoggerFactory.getLogger(AbstractPromotionEngineAddOnServicesSpockTest.class)
	...
	def setup()
	{
		...
		importCsv("/promotionengineservices/test/electronics/promotionengineTestData.impex", "utf-8")
		importCsv("/promotionengineservices/test/electronics/promotionengineTestData-sourceRule.impex", "utf-8")
		importCsv("/promotionengineservices/test/electronics/electronicspromotions.impex", "utf-8")
		importCsv("/promotionengineservices/test/powertools/categories.impex", "utf-8")
		importCsv("/promotionengineservices/test/powertools/products.impex", "utf-8")
		importCsv("/promotionengineservices/test/powertools/products-prices.impex", "utf-8")
		importCsv("/promotionengineservices/test/powertools/powertoolspromotions.impex", "utf-8")
	}
	...
	{
		return ruleSampleSwitchService.set(Switch.CONSUMPTION, status)
	}
	...
	protected List<PromotionGroupModel> getTestPromoGroups()
	{
		...
		final PromotionGroupModel powertoolsPromoGrp = promotionDao.findPromotionGroupByCode("powertoolsPromoGrp")
		list.add(testPromo)
		list.add(electronicsPromoGrp)
		list.add(powertoolsPromoGrp)
		return list
	}
	...
	protected void setGlobals(final DroolsRuleModel rule)
	{
		...
		try(final BufferedReader br = new BufferedReader(new StringReader(drl))){
	...
	protected BigDecimal evaluatePowerToolPromotionForCart(final String cartId)
	{
		final CartModel cart = getCartByCode(cartId)
	...
	protected void addCoponsToCart(final CartModel cart, final String couponCode)
	{
