...
public class PromotionResultVersioningIT extends PromotionEngineServiceBaseTestBase
{
	...
	{
		final String ruleName = "percentageDiscountCameraAccessories";

		final AbstractRuleEngineRuleModel rule = getRuleFromResource(
				"promotionengineservices/test/rules/" + ruleName + ".drl", ruleName + ".drl", ruleName);
	...
	{
		final String ruleName1 = "percentageDiscountCameraAccessories";
		final AbstractRuleEngineRuleModel rule1 = getRuleFromResource(
				"promotionengineservices/test/rules/" + ruleName1 + ".drl", ruleName1 + ".drl", ruleName1);
		...
		final String ruleName2 = "percentageDiscountCameraAccessories2";
		final AbstractRuleEngineRuleModel rule2 = getRuleFromResource(
				"promotionengineservices/test/rules/" + ruleName2 + ".drl",
				"percentageDiscountCameraAccessories.drl", ruleName2);
