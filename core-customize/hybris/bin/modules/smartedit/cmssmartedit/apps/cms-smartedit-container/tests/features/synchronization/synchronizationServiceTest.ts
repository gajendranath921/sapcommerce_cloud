...
import { DiscardableTimer, ISyncJob, JOB_STATUS, SynchronizationService } from 'cmscommons';
import {
...
describe('sync service  - unit test', () => {
    ...
    const theCatalogUpdateStatus: ISyncJob = {
        ...
        syncStatus: JOB_STATUS.FINISHED
    } as ISyncJob;
    ...
    beforeEach(() => {
        ...
        restServiceFactory.get.and.callFake((): any => {
    ...
    it('should call "get synchronization status" after interval.', async () => {
