...
describe('displayConditionsFacade', () => {
    ...
    const MOCK_VARIATION_PAGES: any = [
        {
    ...
    let pageRestrictionsService: jasmine.SpyObj<PageRestrictionsService>;
    ...
    beforeEach(() => {
        ...
        service = new DisplayConditionsFacade(pageService, pageRestrictionsService, logService);
    });
    ...
    describe('updatePage', () => {
        it('should delegate to the pageService to update the page', () => {
            ...
            expect(pageService.updatePageById).toHaveBeenCalledWith('somePageUid', {} as any);
        });
    });
