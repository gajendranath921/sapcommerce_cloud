...
module.exports = (function () {
    ...
    obj.constants = {
        BUTTON_SELECTOR: 'se-page-sync-menu-toolbar-item .toolbar-action--button'
    };
    ...
    obj.elements = {
        ...
        getPanelHeader: function () {
            return element(by.css('.se-sync-panel-header__sub-header'));
        },
        getPanelMessage: function () {
            return element(by.css('.se-sync-panel-new-page__message'));
        },
        getSyncCautionIcon: function () {
            return element(by.css('.se-toolbar-menu-ddlb--button__caution'));
        },
        getSyncToolbarMenuPanel: function () {
            return element(by.css('se-page-sync-menu-toolbar-item'));
        },
