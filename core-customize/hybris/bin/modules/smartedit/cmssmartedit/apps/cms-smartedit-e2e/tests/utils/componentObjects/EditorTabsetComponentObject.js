...
module.exports = {
    ...
    LINK_SELECTOR: 'a',
    TAB1_TAB_SELECTOR: 'li[tab-id="tab1"]',
    TAB2_TAB_SELECTOR: 'li[tab-id="tab2"]',
    TAB3_TAB_SELECTOR: 'li[tab-id="tab3"]',
    TAB4_TAB_SELECTOR: 'li[tab-id="tab4"]',
    TAB5_TAB_SELECTOR: 'li[tab-id="tab5"]',
    TAB6_TAB_SELECTOR: 'li[tab-id="tab6"]',
    TAB7_TAB_SELECTOR: 'li[tab-id="tab7"]',
    TAB1_TAB_CONTENT_SELECTOR: 'se-tab[tab-id="tab1"]',
    TAB2_TAB_CONTENT_SELECTOR: 'se-tab[tab-id="tab2"]',
    TAB3_TAB_CONTENT_SELECTOR: 'se-tab[tab-id="tab3"]',
    TAB4_TAB_CONTENT_SELECTOR: 'se-tab[tab-id="tab4"]',
    TAB5_TAB_CONTENT_SELECTOR: 'se-tab[tab-id="tab5"]',
    TAB6_TAB_CONTENT_SELECTOR: 'se-tab[tab-id="tab6"]',
    TAB7_TAB_CONTENT_SELECTOR: 'se-tab[tab-id="tab7"]',
