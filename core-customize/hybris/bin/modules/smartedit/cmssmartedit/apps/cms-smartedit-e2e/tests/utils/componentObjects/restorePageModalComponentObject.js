...
module.exports = (function () {
    ...
    componentObject.actions = {
        ...
        openPrimaryPageSelector: function (primaryPageToSelect) {
            return browser
                .click(componentObject.elements.getPrimaryContentPageSelectorOpenButton())
                .then(function () {
                    return componentObject.elements
                        .getPrimaryContentPageSelectorOption(primaryPageToSelect)
                        .isPresent()
        ...
        selectNewPrimaryContentPage: function (primaryPageToSelect) {
            return this.openPrimaryPageSelector(primaryPageToSelect).then(function () {
                return browser.click(
