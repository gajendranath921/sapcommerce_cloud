 ...
 */
const XPATH_PREFIX = "//div[contains(@class, 'se-tree-node__name')]/span[contains(., '";
module.exports = {
    ...
    _getNodeHandle: function (nodeLabel) {
        return by.xpath(
            `${XPATH_PREFIX}${nodeLabel}')]/ancestor::li[contains(@class, 'cdk-drag')][1]`
        );
    },
    _getNodeTitle: function (nodeLabel) {
        var deferred = protractor.promise.defer();
        var selector = `${XPATH_PREFIX}${nodeLabel}')]/ancestor::div[contains(@class, 'se-tree-node')]//div[contains(@class, 'se-tree-node__title')]/span`;
    ...
    clickOnLinkHavingClass: function (nodeLabel, cssClass) {
        return browser.click(
            by.xpath(
                `${XPATH_PREFIX}${nodeLabel}')]/ancestor::div[contains(@class, 'se-tree-node')]/div[1]/a/span[contains(@class, '${cssClass}')]`
            )
        );
    },
    clickOnLinkHavingContent: function (nodeLabel, anchorLabel) {
        return browser.click(
            by.xpath(
                `${XPATH_PREFIX}${nodeLabel}']/ancestor::div[contains(@class, 'se-tree-node')]/div[1]/a/[contains(., '${anchorLabel}')]`
            )
        );
    },
    clickOnLinkHavingClassInRenderer: function (nodeLabel, cssClass) {
        return browser.click(
            by.xpath(
                `${XPATH_PREFIX}${nodeLabel}')]/ancestor::div[contains(@class, 'se-tree-node')]//se-dropdown-menu//div[contains(@class, '${cssClass}')]`
            )
        );
    },
    ...
    getChildrenNames: function (nodeLabel) {
        ...
        if (nodeLabel) {
            selector = by.xpath(
                `${XPATH_PREFIX}${nodeLabel}')]/ancestor::se-tree-node-renderer/se-tree-node//div[contains(@class, 'se-tree-node__name')]`
            );
        } else {
            selector = by.css('.se-tree-node__name span');
        }
    ...
    getMoreMenuOptions: function (nodeLabel) {
        ...
        if (nodeLabel) {
            selector = by.xpath(
                `${XPATH_PREFIX}${nodeLabel}')]/ancestor::div[contains(@class, 'se-tree-node')]//se-dropdown-menu//ul/se-dropdown-menu-item/li`
            );
        } else {
    ...
    getMoreMenuItem: function (nodeLabel, option) {
        return by.xpath(
            `${XPATH_PREFIX}${nodeLabel}')]/ancestor::div[contains(@class, 'se-tree-node')]//se-dropdown-menu//a[contains(., '${option}')]`
        );
    },
