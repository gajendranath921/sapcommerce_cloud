...
describe('CmsItemDropdown -', function () {
    ...
    describe('Single Select - ', function () {
        ...
        it('WHEN the user selects an item in the list THEN the remove button is present', function () {
            // GIVEN
            page.actions.openGenericEditor();
            cmsItemDropdown.assertions.isEmpty(BANNER_FIELD_ID);
            ...
            // THEN
            cmsItemDropdown.assertions.hasRemoveButton(BANNER_FIELD_ID);
        });

        it('WHEN the user selects an item in the list and click remove button THEN the dropdown is again empty', function () {
            // GIVEN
            page.actions.openGenericEditor();
            cmsItemDropdown.assertions.isEmpty(BANNER_FIELD_ID);
            ...
            cmsItemDropdown.actions.selectItemInDropdown(BANNER_FIELD_ID, SINGLE_SELECT, BANNER_1);
            cmsItemDropdown.assertions.isNotEmpty(BANNER_FIELD_ID);
            cmsItemDropdown.actions.removeSelectedItem(BANNER_FIELD_ID);
        ...
        it('GIVEN an item is selected WHEN the user clicks on it THEN it opens a nested editor', function () {
            ...
            // WHEN
            cmsItemDropdown.actions.clickSelectedItem(BANNER_FIELD_ID, BANNER_1);

            // THEN
            genericEditor.assertions.topEditorIsNested(expectedNestingLevel);
            genericEditorBreadcrumb.assertions.componentIsDisplayedInCorrectNestingLevel(
                BANNER_1_NAME,
                BANNER_1_TYPE,
        ...
        it('GIVEN an item is selected and opened in a nested editor WHEN the user saves it THEN the editor must close saving any changes', async function () {
            const fixtureID0 = await backendClient.modifyFixture(
                [
        ...
        it('GIVEN a new item is created from the dropdown WHEN the user cancels it THEN the editor must close without saving any changes', function () {
            ...
            // WHEN
            cmsItemDropdown.actions.openNewNestedComponentOfTypeFromDropdown(
                BANNER_FIELD_ID,
                BANNER_2,
                BANNER_COMPONENT_TYPE
            );
        ...
        it('GIVEN a new item is created from the dropdown WHEN the user saves it THEN the editor must close saving any changes', function () {
            ...
            cmsItemDropdown.actions.clickSelectedItem(BANNER_FIELD_ID, BANNER_2_UID);
    ...
    describe('Multi Select - ', function () {
        ...
        it('GIVEN an item is selected WHEN the user clicks on it THEN it opens a nested editor', function () {
            ...
            // WHEN
            cmsItemDropdown.actions.clickSelectedItem(TABS_FIELD_ID, TAB_1);
        ...
        it('GIVEN a new item is created from the dropdown WHEN the user saves it THEN the editor must close saving any changes', function () {
            ...
            cmsItemDropdown.actions.clickSelectedItem(TABS_FIELD_ID, TAB_2_UID);
    ...
    describe('Nested Elements - ', function () {
        ...
        it('GIVEN several nested component editors are open WHEN the top one has a validation error THEN it should not affect lower level component editors', function () {
            ...
            genericEditor.actions.save();
            genericEditor.assertions.fieldHasValidationErrorsInTab(
                FIELD_WITH_ERROR_QUALIFIER,
                null,
                1
            );
        ...
        it('GIVEN several nested component editors are open WHEN they are saved THEN the changes are persisted', function () {
            ...
            cmsItemDropdown.actions.clickSelectedItem(TABS_FIELD_ID, TAB_3_UID);
