...
module.exports = (function () {
    ...
    componentObject.consts = {
        TEMPLATE_SELECTOR_ID: 'templateCode',
    ...
    componentObject.elements = {
        ...
        getTemplateFieldSelector: function () {
            return this.getGenericEditorFieldSelector(componentObject.consts.TEMPLATE_SELECTOR_ID);
        },
        ...
        getCreateVersionFieldLabel: function () {
            return element(by.css('se-workflow-create-version-field'));
        },
        ...
        getPageWorkflowMenu: function () {
            return element(by.css('.se-page-workflow-menu'));
        },
        getPageTasksButton: function () {
            return element(by.css('.page-tasks-btn'));
        },
        ...
        getItemMenuMoreButton: function () {
            return element(by.css('.workflow-item-menu__toggle-btn'));
        },
        ...
        getItemMenuEditItem: function () {
            return element(by.css('.workflow-description__edit-btn'));
        },
        ...
        getActionsForTabId: function (tabId) {
            return element.all(
                by.css('se-tab[tab-id="' + tabId + '"]' + ' se-workflow-action-item')
            );
        },
        ...
        getCommentsForAction: function (tabId, actionCode) {
            return componentObject.elements
                .getWorkflowActionByCode(tabId, actionCode)
                .all(by.css('se-workflow-action-comment'));
        },
        getDecisionButtonsGroup: function (tabId, actionCode) {
            return componentObject.elements
                .getWorkflowActionByCode(tabId, actionCode)
                .element(by.css('.se-workflow-action-item__decision-buttons'));
        },
