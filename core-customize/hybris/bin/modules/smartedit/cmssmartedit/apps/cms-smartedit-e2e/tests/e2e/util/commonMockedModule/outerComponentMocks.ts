...
angular
    ...
    .run(function (httpBackendService, backendMocksUtils, navigationNodePOST, navigationNodeNodes) {
        var items = {
        ...
        (window as any).itemPUTDefaultResponse = function (_method, url, data, headers) {
            var uuid = /cmsitems\/(.*)/.exec(url)[1];
        ...
        (window as any).itemPUT = componentPUTMock;
        componentPUTMock.respond((window as any).itemPUTDefaultResponse);
        ...
        var componentsListGETMock = httpBackendService
            ...
            .respond(function (method, url, data, headers) {
                var params = urlUtils.parseQuery(data) as any;
