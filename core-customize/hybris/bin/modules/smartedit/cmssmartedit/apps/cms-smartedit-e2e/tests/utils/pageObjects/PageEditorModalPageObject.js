...
module.exports = (function () {
    ...
    pageObject.elements = {
        ...
        getPageVariationsFirstRow: function () {
            return element(by.css('se-display-conditions-page-variations tbody tr:nth-child(1)'));
        },
        getPageVariationsSecondRow: function () {
            return element(by.css('se-display-conditions-page-variations tbody tr:nth-child(2)'));
        },
