...
const TIMESTAMP = '2016-07-07T14:33:37+0000';
const APPREL_UK = 'apparel-uk';
const CATALOG_ID = 'apparel-ukContentCatalog';
...
angular
    ...
    .constant('PATH_TO_CUSTOM_VIEW', '../e2e/pageEditorModal/customView.html')
        ...
        this.openModal = function (uid) {
            var page = {
                ...
                uriContext: {
                    ...
                    CURRENT_CONTEXT_SITE_ID: APPREL_UK
                }
            };
