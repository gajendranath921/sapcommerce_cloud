...
const testsConfig = {
    ...
    storefrontPath:
        'cms-smartedit-e2e/node_modules/@smartedit/storefront-generator/dummystorefront/fakeAngularEmptyPage.html',
    htmlPath: 'cms-smartedit-e2e/generated/pages/smartedit.html',
...
if (shards > 0 && shard >= 0) {
    console.log(
        `cmssmartedit-e2e - Sharding... total of shards: ${shards} - current shard #: ${shard}`
    );
