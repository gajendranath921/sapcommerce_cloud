    ...
    var dateTimeSelectorObject = {
        ...
        elements: {
            ...
            getOpenWidgetButtonById: function (fieldId) {
                return dateTimeSelectorObject.elements
                    .getDateTimeFieldById(fieldId)
                    .element(by.css('.se-date-field--button'));
            },
            timePicker: function () {
        ...
        actions: {
            toggleWidget: function (fieldId) {
                return browser.click(
                    dateTimeSelectorObject.elements.getOpenWidgetButtonById(fieldId)
                );
            },
            ...
            selectDate: function (dateStr) {
                ...
                return dateTimeSelectorObject.utils
        ...
        utils: {
            ...
            getDateFromString: function (dateStr) {
                ...
                var month = dateTimeSelectorObject.constants.MONTHS[parseInt(matches[1], 10) - 1];
                    ...
                    .then(function () {
                        return browser
                            .click(
                                element(
                                    by.css(
                                        "div[class*='datepicker-months'] th[class*='picker-switch']"
                                    )
                                )
                            )
                            .then(function () {
                                browser.click(
                                    element(
                                        by.cssContainingText("span[class*='year']", yearToSelect)
                                    )
                                );
                            });
                    });
            ...
            selectMonth: function (monthToSelect) {
                return browser.click(
                    element(by.cssContainingText("span[class*='month']", monthToSelect))
                );
            },
            selectDay: function (dayToSelect) {
                return browser.click(
                    element(by.cssContainingText('.datepicker-days td:not(.old)', dayToSelect))
                );
            },
            selectHour: function (hourToSelect) {
                return browser
                    .click(element(by.css('div.timepicker-picker .timepicker-hour')))
                    .then(function () {
                        return browser.click(
                            element(by.cssContainingText("td[class*='hour']", hourToSelect))
                        );
                    });
            },
            selectMinutes: function (minutesToSelect) {
                return browser
                    .click(element(by.css("div[class='timepicker-picker'] .timepicker-minute")))
                    .then(function () {
                        browser.click(
                            element(by.cssContainingText("td[class*='minute']", minutesToSelect))
                        );
                    });
            },
            selectPeriod: function (periodToSelect) {
                return browser
                    .isElementPresent(by.cssContainingText('button', 'AM'))
                    .then(function (isAMSelected) {
