...
module.exports = (function () {
    ...
    var selectors = {
        ...
        backButton: function () {
            return by.css('.fd-modal__footer button#ACTION_PREVIOUS');
        }
    };
    ...
    componentObject.elements = {
        ...
        submitButton: function () {
            return browser.findElement(by.css('.fd-modal__footer button#ACTION_SAVE'));
        },
    ...
    componentObject.actions = {
        ...
        moveBack: function () {
            return browser.click(selectors.backButton());
        },
