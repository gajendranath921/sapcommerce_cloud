    ...
    var componentObjects = {
        ...
        assertions: {
            deletePageItemIsActive: function () {
                browser.waitForAbsence(by.css('.se-dropdown-item__delete-link-wrapper--disabled'));
            },
            deletePageItemIsInactive: function () {
                expect(
                    componentObjects.elements
                        .getDeletePageItemAnchor()
                        .element(by.css('.se-dropdown-item__delete-link-wrapper--disabled'))
                        .isPresent()
                ).toBe(true);
            },
        ...
        elements: {
            getDeletePageItemAnchor: function () {
                ...
                return browser.findElement(
                    by.css('.se-dropdown-more-menu .se-dropdown-item__delete-wrapper')
                );
            },
            getDeletePageItemPopoverAnchor: function () {
                return componentObjects.elements
                    .getDeletePageItemAnchor()
                    .element(by.css('.se-dropdown-item__delete-page-popover span'));
            },
