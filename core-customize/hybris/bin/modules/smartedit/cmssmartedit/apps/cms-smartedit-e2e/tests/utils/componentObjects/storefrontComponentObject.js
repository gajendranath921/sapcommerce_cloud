...
module.exports = (function () {
    ...
    componentObject.elements = {
        getComponentById: function (componentId) {
            return browser.switchToIFrame().then(function () {
                return element(
                    by.css('.smartEditComponent[data-smartedit-component-id=' + componentId + ']')
                );
            });
        },
                ...
                return browser
                    .waitUntil(function () {
                        ...
                        element
                            .all(
                                by.css(
                                    ".smartEditComponent[data-smartedit-component-id='" +
                                        slotId +
                                        "'] .smartEditComponent"
                                )
                            )
                    ...
                    }, 'Expected ' + expectedElementsInSlotCount + ' components in slot')
                    .then(function () {
                        return element.all(
                            by.css(
                                "#smarteditoverlay .smartEditComponentX[data-smartedit-component-id='" +
    ...
    componentObject.actions = {
        ...
        moveToComponentByAttributeAndValue: function (attribute, value) {
            return browser.switchToIFrame().then(function () {
                return componentObject.elements
                    .getComponentByAttributeAndValue(attribute, value)
                    .then(function (element) {
                        return browser.actions().mouseMove(element).perform();
                    });
            });
