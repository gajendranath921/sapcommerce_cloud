...
module.exports = (function () {
    ...
    catalogAwareSelector.elements = {
        getCatalogAwareSelectorRoot: function (selectorId) {
            return element(by.css('se-catalog-aware-selector[id="' + selectorId + '"]'));
        },
    ...
    catalogAwareSelector.actions = {
        ...
        selectItemInSearchBox: async (itemName) => {
            const itemElement = catalogAwareSelector.elements.getItemSearchBoxOption(itemName);
            await browser.waitUntil(EC.elementToBeClickable(itemElement));
            await browser.click(itemElement);
        },
