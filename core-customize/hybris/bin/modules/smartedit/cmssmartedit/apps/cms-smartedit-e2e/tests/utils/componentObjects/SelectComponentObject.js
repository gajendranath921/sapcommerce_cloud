...
module.exports = (function () {
    ...
    componentObject.selectors = selectors;
    ...
    componentObject.elements = {
        ...
        getAllSelectedOptions: function (hostId) {
            return element.all(componentObject.locators.getSelectedItem(hostId));
        },
    ...
    componentObject.actions = {
        ...
        selectOptionByComponentId: function (hostId, optionId) {
            return browser.click(
                componentObject.elements
                    .getAllOptions(hostId)
                    .all(by.css(`[data-component-id="${optionId}"]`))
                    .first(),
                'Could not click on dropdown option with componentId=' + optionId
            );
        },
