...
describe('Page List', function () {
    ...
    it('GIVEN I am on the page list of the first catalog WHEN I click on a linkable page name THEN I expect to be redirected to this page', function () {
        var EXPECTED_IFRAME_SRC = '/generated/pages/storefront.html?cmsTicketId=dasdfasdfasdfa';
...
describe('Options in dropdown', function () {
    ...
    describe('Page is not in a workflow', function () {
        ...
        describe('Staged catalog', () => {
            ...
            it('GIVEN I am on the page list of the first staged catalog WHEN I open the drop down menu THEN I expect to see clone option on dropdown', function () {
                pageList.actions.openPageDropdownByPageName('homepage');
                expect(pageList.elements.getDropdownCloneButton().isPresent()).toBe(
                    true,
                    'Expected the presence of clone option in the dropdown menu'
                );
            });
        ...
        describe('Online catalog', () => {
            ...
            it('GIVEN I am on the page list of the first staged catalog WHEN I open the drop down menu THEN I expect to see sync option on dropdown', function () {
                pageList.actions.openPageDropdownByPageName('homepage_uk_online');
                expect(pageList.elements.getDropdownSyncButton().isPresent()).toBe(
                    false,
            ...
            it('GIVEN I am on the page list of the first staged catalog WHEN I open the drop down menu THEN I expect to see clone option on dropdown', function () {
                ...
                expect(pageList.elements.getDropdownCloneButton().isPresent()).toBe(
                    false,
                    'Expected the absence of clone option in the dropdown menu'
                );
            });
...
describe('Soft deletion of a page\n', function () {
    ...
    const GIVEN_DESCR = 'GIVEN I am on a page list view\n';
    ...
    it(
        `${GIVEN_DESCR}WHEN I open the drop down menu of a non-deletable page\n` +
    ...
    it(
        `${GIVEN_DESCR}WHEN I open the drop down menu of a deletable page\n` +
    ...
    it(
        `${GIVEN_DESCR}WHEN I click on the "move to trash" option of a deletable page\n` +
    ...
    it(
        `${GIVEN_DESCR}WHEN I open the drop down menu of a page that has some validation error and delete it\n` +
