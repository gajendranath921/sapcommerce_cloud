...
module.exports = (function () {
    ...
    linkToggle.assertions = {
        externalRadioIsSelected: function () {
            expect(linkToggle.elements.getExternalRadio().isSelected()).toBe(
                true,
        ...
        internalRadioIsSelected: function () {
            expect(linkToggle.elements.getInternalRadio().isSelected()).toBe(
                true,
                'Expect external radio to be selected'
            );
        },
        ...
        urlLinkEqualTo: function (possibleValue) {
            expect(linkToggle.elements.getUrlLinkField().getAttribute('value')).toEqual(
                possibleValue,
