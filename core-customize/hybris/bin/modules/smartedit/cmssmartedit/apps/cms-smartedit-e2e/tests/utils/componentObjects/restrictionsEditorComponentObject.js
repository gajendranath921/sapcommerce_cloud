...
var MSG_EXPECTED_NAME_FIELD_TO_BE_DISABLED = 'Expected name field to be disabled';
var MSG_EXPECTED_TYPE_DROPDOWN_NOT_TO_BE_PRESENT_IN_EDIT_MODE =
    'Expected type dropdown not to be present in edit mode';
var MSG_EXPECTED_RESTRICTION_SEARCH_BOX_NOT_TO_BE_PRESENT_IN_EDIT_MODE =
    'Expected restriction search box not to be present in edit mode';
var MSG_NAMEFIELD_TO_BE_PRESENT_IN_EDIT_MODE = 'Expected nameField to be present in edit mode';
...
module.exports = (function () {
    ...
    restrictionsEditor.elements = {
        ...
        getRestrictionInListByName: function (restrictionName) {
            ...
            return restrictionElements
                .filter(function (elem) {
                    return elem
                        .element(by.css(restrictionsEditor.constants.RESTRICTION_TABLE_ITEM.HEADER))
                        .getText()
                        .then(function (text) {
        ...
        getRestrictionDescriptionByName: function (restrictionName) {
            return restrictionsEditor.elements
                .getRestrictionInListByName(restrictionName)
                .element(by.css(restrictionsEditor.constants.RESTRICTION_TABLE_ITEM.DESCRIPTION));
        },
        getRestrictionMenuByName: function (restrictionName) {
            return restrictionsEditor.elements
                .getRestrictionInListByName(restrictionName)
                .all(by.css('.se-dropdown-more-menu__toggle'))
                .first();
        },
        getRestrictionEditButtonByName: function (restrictionName) {
            return restrictionsEditor.elements
                .getRestrictionInListByName(restrictionName)
                .all(by.cssContainingText('a', 'Edit'))
                .first();
        },
        getRestrictionDeleteButtonByName: function (restrictionName) {
            return restrictionsEditor.elements
                .getRestrictionInListByName(restrictionName)
                .all(by.cssContainingText('a', 'Remove'))
                .first();
        },
        getApplyRuleDropdown: function () {
            return element(by.css('.se-select#criteria-type .toggle-button'));
        },
        getAnyRestrictionOption: function () {
            return element(
                by.cssContainingText('.se-select#criteria-type li', 'Apply any restriction')
            );
        },
        ...
        getRestrictionsWithErrorsCount: function () {
            return element
                .all(
                    by.css(
                        restrictionsEditor.constants.RESTRICTION_TABLE_ITEM.HEADER + '.error-input'
                    )
                )
                .count();
        },
        ...
        getRestrictionTypeDropdown: function () {
            return element(
                by.css(
                    restrictionsEditor.constants.RESTRICTION_TYPE_SELECTOR_ID +
        ...
        getRestrictionTypeOption: function (optionValue) {
            return element(
                by.cssContainingText(
                    restrictionsEditor.constants.RESTRICTION_TYPE_SELECTOR_ID +
                        ' se-restriction-management-select-item',
                    optionValue
                )
            );
        },
        getRestrictionsSearchBox: function () {
            return element(
                by.css(
                    restrictionsEditor.constants.RESTRICTION_NAME_SELECTOR_ID +
                        ' .fd-select-button-custom'
                )
            );
        },
        getRestrictionsSearchBoxInput: function () {
            return element(
                by.css(
                    restrictionsEditor.constants.RESTRICTION_NAME_SELECTOR_ID + ' .search__input'
                )
            );
        },
        getRestrictionSearchBoxOption: function (optionValue) {
            return element(
                by.cssContainingText(
                    restrictionsEditor.constants.RESTRICTION_NAME_SELECTOR_ID + ' ol li span',
                    optionValue
                )
            );
        },
        getRestrictionSearchBoxNewButton: function () {
            return element(by.cssContainingText('button', 'se.yationablesearchitem.action.create'));
        },
        getAddRestrictionButton: function () {
            return element(
                by.cssContainingText('button', 'se.cms.restriction.management.panel.button.add')
            );
        },
        getUpdateRestrictionButton: function () {
            return element(
                by.cssContainingText('button', 'se.cms.restriction.management.panel.button.save')
            );
        },
        ...
        getCategoryRestrictionCategoriesSelector: function () {
            return element(by.css('se-editable-list[id="categories_list"]'));
        },
        getMenuForCategory: function (categoryName) {
            return restrictionsEditor.elements
                .getCategoryRestrictionCategoriesSelector()
                .element(by.cssContainingText('ol li .se-product-row__product', categoryName))
                .element(by.xpath('..'))
                .element(by.css('.se-dropdown-more-menu'));
        },
        getDeleteCategoryButton: function (categoryName) {
            return restrictionsEditor.elements
                .getMenuForCategory(categoryName)
                .element(by.cssContainingText('.se-dropdown-more-menu a', 'Delete'));
        },
        ...
        getUserGroupInDropdown: function (userGroup) {
            return restrictionsEditor.elements
                ...
                .all(by.cssContainingText('ul li span', userGroup))
                .first();
        },
        ...
        getUserGroupDeleteButton: function (userGroupName) {
            return restrictionsEditor.elements
                ...
                .element(
                    by.xpath(
                        "//li[descendant::item-printer/descendant::span[contains(text(),'" +
                            userGroupName +
                            "')]]/a"
                    )
                );
        ...
        getNotEditableWarning: function () {
            return element(
                by.cssContainingText(
                    'div',
                    'se.cms.restriction.management.select.type.not.supported.warning'
                )
            );
        },
        ...
        getRestrictionsYMessage: function () {
            return element(by.css('restrictions-editor se-message'));
        },

        getRestrictionPartOfWorkflowMessage: function (restrictionName) {
            return restrictionsEditor.elements
                .getRestrictionInListByName(restrictionName)
                .element(by.id('restrictionPartOfWorkflow'));
        }
    };
    ...
    restrictionsEditor.actions = {
        ...
        openRestrictionDropdownMenu: function (restrictionName) {
            return browser.click(
                restrictionsEditor.elements.getRestrictionMenuByName(restrictionName)
            );
        },
        ...
        openRestrictionForEditing: function (restrictionName) {
            return restrictionsEditor.actions
                .openRestrictionDropdownMenu(restrictionName)
                .then(function () {
                    browser
                        .waitForVisibility(
                            restrictionsEditor.elements.getRestrictionEditButtonByName(
                                restrictionName
                            )
                        )
                        .then(function () {
        ...
        removeRestriction: function (restrictionName) {
            return restrictionsEditor.actions
                ...
                .then(function () {
                    return browser.click(
                        restrictionsEditor.elements.getRestrictionDeleteButtonByName(
                            restrictionName
                        )
                    );
                });
        ...
        selectRestrictionType: function (restrictionType) {
            return restrictionsEditor.actions.openRestrictionTypeDropdown().then(function () {
                browser
                    .waitForVisibility(
                        restrictionsEditor.elements.getRestrictionTypeOption(restrictionType)
                    )
                    .then(function (type) {
                        return browser.click(
                            restrictionsEditor.elements.getRestrictionTypeOption(restrictionType)
        ...
        selectRestrictionInSearchBoxByExactName: function (restrictionName) {
            return restrictionsEditor.actions.openRestrictionsSearchBox().then(function () {
                return browser.click(
                    restrictionsEditor.elements.getRestrictionSearchBoxOption(restrictionName)
                );
            });
        },
        searchRestriction: function (searchTerm) {
            return restrictionsEditor.actions.openRestrictionsSearchBox().then(function () {
                browser.sendKeys(
                    restrictionsEditor.elements.getRestrictionsSearchBoxInput(),
                    searchTerm
                );
            });
        },
        ...
        addExistingTimeRestriction: function (restrictionName) {
            ...
            return restrictionsEditor.actions.openSliderPanel().then(function () {
                return restrictionsEditor.actions
                    .selectRestrictionType(restrictionType)
                    .then(function () {
                        return restrictionsEditor.actions.selectRestrictionInSearchBoxByExactName(
                            restrictionName
                        );
                    });
            });
        ...
        createNewTimeRestriction: function (newRestrictionName, timeRestrictionData) {
            ...
            return restrictionsEditor.actions.openSliderPanel().then(function () {
                return restrictionsEditor.actions
                    ...
                    .then(function () {
                        return restrictionsEditor.actions
                            .createEmptyRestriction(newRestrictionName)
                            .then(function () {
                                return restrictionsEditor.actions.setTimeRestrictionData(
                                    timeRestrictionData
                                );
                            });
                    });
        ...
        updateTimeRestrictionData: function (restrictionName, timeRestrictionData) {
            return restrictionsEditor.actions
                .openRestrictionForEditing(restrictionName)
                .then(function () {
        ...
        setCategoryRestrictionData: function (restrictionData) {
            restrictionsEditor.utils
                .toggleBooleanField(
                    restrictionsEditor.elements.getCategoryRestrictionRecursiveToggle(),
                    restrictionData.recursive
                )
                .then(function () {
                    return catalogAwareSelector.actions
                        .selectItems(
                            restrictionsEditor.constants.CATEGORIES_SELECTOR_ID,
                            restrictionData.categories
                        )
                        .then(function () {
                ...
                return restrictionsEditor.actions
                    ...
                    .then(function () {
                        return restrictionsEditor.actions
                            .createEmptyRestriction(newRestrictionName)
                            .then(function () {
                                return restrictionsEditor.actions.setCategoryRestrictionData(
        ...
        removeCategory: function (categoryName) {
            return restrictionsEditor.actions.openMenuForCategory(categoryName).then(function () {
                return browser.click(
                    restrictionsEditor.elements.getDeleteCategoryButton(categoryName)
                );
            });
        },
        ...
        selectUserGroups: function (userGroups) {
            ...
            userGroups.forEach(function (userGroup) {
                promisesToResolve.push(
                    restrictionsEditor.actions.openUserGroupsDropdown().then(function () {
        ...
        setUserGroupRestrictionData: function (restrictionData) {
            restrictionsEditor.utils
                .toggleBooleanField(
                    restrictionsEditor.elements.getUserGroupRestrictionApplySubGroupsToggle(),
                    restrictionData.applyRestriction
                )
                .then(function () {
                ...
                return restrictionsEditor.actions
                    ...
                    .then(function () {
                        return restrictionsEditor.actions
                            .createEmptyRestriction(newRestrictionName)
                            .then(function () {
                                return restrictionsEditor.actions.setUserGroupRestrictionData(
        ...
        removeUserGroup: function (userGroupToDelete) {
            return browser.click(
                restrictionsEditor.elements.getUserGroupDeleteButton(userGroupToDelete)
            );
        },
    ...
    restrictionsEditor.assertions = {
        listHasExpectedNumberOfRestrictions: function (expectedNumberOfRestrictions) {
            expect(restrictionsEditor.elements.getRestrictionListSize()).toBe(
                expectedNumberOfRestrictions,
        ...
        restrictionIsNotInList: function (restrictionName) {
            browser.waitForAbsence(
                restrictionsEditor.elements.getRestrictionInListByName(restrictionName),
                'Expected restriction ' +
                    restrictionName +
                    ' not to be in the list of selected restrictions'
            );
        },
        restrictionIsInList: function (restrictionName) {
            expect(
                restrictionsEditor.elements.getRestrictionInListByName(restrictionName).isPresent()
            ).toBe(
                true,
                'Expected restriction ' +
                    restrictionName +
                    ' to be in the list of selected restrictions'
            );
        },
        ...
        timeRestrictionPanelIsNotEditable: function () {
            expect(
                restrictionsEditor.utils.isTextFieldEditable(
                    restrictionsEditor.elements.getRestrictionNameField()
                )
            ).toBe(false, MSG_EXPECTED_NAME_FIELD_TO_BE_DISABLED);
            expect(
                restrictionsEditor.utils.isDateFieldEditable(
                    restrictionsEditor.elements.getTimeRestrictionActiveFromField()
                )
            ).toBe(false, 'Expected active from field to be disabled');
            expect(
                restrictionsEditor.utils.isDateFieldEditable(
                    restrictionsEditor.elements.getTimeRestrictionActiveUntilField()
                )
            ).toBe(false, 'Expected active until field to be disabled');
        },
        timeRestrictionHasRightData: function (restrictionName, restrictionData) {
            var expectedLabel =
                'Page only applies from ' +
                restrictionData.activeFrom +
                ' to ' +
                restrictionData.activeUntil;

            expect(
                restrictionsEditor.elements
                    .getRestrictionDescriptionByName(restrictionName)
                    .getText()
            ).toBe(expectedLabel);
        },
        timeRestrictionIsInEditMode: function () {
            browser.waitForAbsence(
                restrictionsEditor.elements.getRestrictionTypeDropdown(),
                MSG_EXPECTED_TYPE_DROPDOWN_NOT_TO_BE_PRESENT_IN_EDIT_MODE
            );
            browser.waitForAbsence(
                restrictionsEditor.elements.getRestrictionsSearchBox(),
                MSG_EXPECTED_RESTRICTION_SEARCH_BOX_NOT_TO_BE_PRESENT_IN_EDIT_MODE
            );

            expect(restrictionsEditor.elements.getRestrictionNameField().isPresent()).toBe(
                true,
                MSG_NAMEFIELD_TO_BE_PRESENT_IN_EDIT_MODE
            );
            expect(
                restrictionsEditor.elements.getTimeRestrictionActiveFromField().isPresent()
            ).toBe(true, 'Expected activeFromField to be present in edit mode');
            expect(
                restrictionsEditor.elements.getTimeRestrictionActiveUntilField().isPresent()
            ).toBe(true, 'Expected activeUnitlField to be present in edit mode');
        },
        ...
        categoryRestrictionPanelIsNotEditable: function () {
            ...
            expect(
                restrictionsEditor.utils.isToggleFieldEditable(
                    restrictionsEditor.elements.getCategoryRestrictionRecursiveToggle()
                )
            ).toBe(false, 'Expected toggle to be disabled');
            expect(
                restrictionsEditor.utils.isCategoriesSelectorEditable(
                    restrictionsEditor.elements.getCategoryRestrictionCategoriesSelector()
                )
        ...
        categoryRestrictionHasRightData: function (restrictionName, restrictionData) {
            var expectedLabel =
                'Page only applies on categories: ' + restrictionData.categories.Staged + ';';
        ...
        categoryRestrictionIsInEditMode: function () {
            ...
            expect(
                restrictionsEditor.elements.getCategoryRestrictionRecursiveToggle().isPresent()
            ).toBe(true, 'Expected recursiveToggle to be present in edit mode');
            expect(
                restrictionsEditor.elements.getCategoryRestrictionCategoriesSelector().isPresent()
            ).toBe(true, 'Expected categoriesSelector to be present in edit mode');
        },
        ...
        userGroupRestrictionPanelIsNotEditable: function () {
            ...
            expect(restrictionsEditor.utils.isDropdownEditable()).toBe(
                false,
                'Expected dropdown to be disabled'
            );
        },
        ...
        userGroupRestrictionIsInEditMode: function () {
            ...
            expect(
                restrictionsEditor.elements
                    .getUserGroupRestrictionApplySubGroupsToggle()
                    .isPresent()
            ).toBe(true, 'Expected applySubgroupsToggle to be present in edit mode');
            expect(restrictionsEditor.elements.getUserGroupsSelector().isPresent()).toBe(
                true,
                'Expected groupsSelector to be present in edit mode'
            );
        },
        userGroupSelectorContainsGroups: function (userGroups) {
            userGroups.forEach(function (userGroup) {
                expect(
                    restrictionsEditor.elements.getUserGroupLabelInSelector(userGroup).isPresent()
                ).toBe(true, 'Expected user ' + userGroup + ' group to be selected');
            });
        },
        ...
        restrictionPanelIsEmptyAndNotEditable: function () {
            browser.waitForAbsence(
                restrictionsEditor.elements.getRestrictionNameField(),
                'Expected nameField not to be present'
            );
        },
        restrictionCannotBeEdited: function () {
            ...
            expect(restrictionsEditor.elements.getNotEditableWarning().isPresent()).toBe(
                true,
                'Expected warning to be displayed.'
            );
        },
        ...
        assertEditButtonIsHidden: function (restrictionName) {
            browser.waitForAbsence(
                restrictionsEditor.elements.getRestrictionEditButtonByName(restrictionName)
            );
        },
        assertEditButtonIsVisible: function (restrictionName) {
            expect(
                restrictionsEditor.elements
                    .getRestrictionEditButtonByName(restrictionName)
                    .isPresent()
            ).toBe(true);
        },
        assertRestrictionPartOfWorkflowMessageDisplayed: function (restrictionName) {
            expect(
                restrictionsEditor.elements
                    .getRestrictionPartOfWorkflowMessage(restrictionName)
                    .isPresent()
            ).toBe(true);
        }
    };
    ...
    restrictionsEditor.utils = {
        ...
        isCategoriesSelectorEditable: function (field) {
            var DISABLED_CLASS_NAME = 'se-editable-list-disabled';
            return field
                .all(by.css('div'))
                .first()
                .getAttribute('class')
