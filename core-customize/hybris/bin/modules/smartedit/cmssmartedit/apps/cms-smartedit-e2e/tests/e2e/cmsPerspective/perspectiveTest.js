    ...
    describe('CMS Perspectives', function () {
        ...
        describe('WHEN other perspective than Basic CMS perspective is selected', function () {
            ...
            it('no contextual menu button shows', function () {
                ...
                expect(
                    componentContextualMenu.elements.getNumContextualMenuItemsForComponentId(
                        COMPONENT_NAME
                    )
                ).toBe(0);
            });
        ...
        describe('WHEN Basic CMS perspective is selected', function () {
            ...
            it('SimpleResponsiveBannerComponent receives 3 contextual menu buttons : move, delete and edit', function () {
                // WHEN
                storefront.actions.moveToComponentByAttributeAndValue(
                    'data-smartedit-component-type',
                    'SimpleResponsiveBannerComponent'
                );

                // THEN
                componentContextualMenu.assertions.removeMenuItemForComponentIdLoadedRightImg(
                    COMPONENT_NAME
                );
                componentContextualMenu.assertions.editMenuItemForComponentIdLoadedRightImg(
                    COMPONENT_NAME
                );
                componentContextualMenu.assertions.moveMenuItemForComponentIdLoadedRightImg(
                    COMPONENT_NAME
                );
            });
            ...
            it('GIVEN the user does not have EDIT permissions on a type WHEN the user hovers on the component of that type THEN the edit button should not be available', function () {
                ...
                // THEN
                contextualMenu.assertions.assertEditButtonIsNotPresent(
            ...
            it('components coming from parent catalog will have an external component decorator on them', function () {
                ...
                componentContextualMenu.assertions.externalComponentMenuItemForComponentIdLoadedRightImg(
                    COMPONENT4_NAME
                );

                componentContextualMenu.actions.clickExternalComponentButton(COMPONENT4_NAME);

                componentContextualMenu.assertions.externalComponentToShowParentCatalogDetails(
                    COMPONENT4_NAME,
