...
describe('slotSyncContextualMenu - ', function () {
    ...
    describe('slotSyncContextualMenu with sync permissions AND page approved', function () {
        ...
        it('GIVEN content slot that has not been synced with target catalog version WHEN I hover over it THEN the sync button is disabled and the message is shown (sync possible only from page level)', function () {
            // GIVEN
