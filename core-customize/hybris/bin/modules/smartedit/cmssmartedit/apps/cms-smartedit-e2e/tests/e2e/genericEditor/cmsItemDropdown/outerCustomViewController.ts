...
angular
    .module('customViewModule', ['backendMocksUtilsModule'])
    .constant('PATH_TO_CUSTOM_VIEW', '../e2e/genericEditor/cmsItemDropdown/customView.html')
    .controller('customViewController', function (editorModalService, backendMocksUtils) {
                ...
                filteredItems = filteredItems.filter(function (item) {
                    ...
                    itemSearchParams.forEach(function (param) {
                        ...
                        if (
                            ...
                            item[paramParsed[0]] &&
                            item[paramParsed[0]].toUpperCase() === paramParsed[1].toUpperCase()
                        ) {
                            filtered = true;
                        }
                    });
        ...
        componentGETMock.respond(function (method, url, data, headers) {
            ...
            return [
                200,
                items.componentItems.find(function (item) {
