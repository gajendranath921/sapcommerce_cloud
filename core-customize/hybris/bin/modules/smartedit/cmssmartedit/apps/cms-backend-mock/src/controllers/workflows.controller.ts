...
export class WorkflowsController {
    ...
    getWorklowActionComments(
        ...
        if (actionCode === 'Action2') {
            const description = 'please review translations';
            comments.push(
                this.workflowsService.createRegularComment(
                    'Comment2',
                ...
                this.workflowsService.createRegularComment('Comment4', description),
                this.workflowsService.createRegularComment('Comment5', description),
                this.workflowsService.createRegularComment('Comment6', description),
                this.workflowsService.createDecisionComment(
                    'Action2',
                    'DecisionComment2',
                    'some description'
                ),
                this.workflowsService.createRegularComment('Comment7', description),
                this.workflowsService.createRegularComment('Comment8', description)
            );
        }
