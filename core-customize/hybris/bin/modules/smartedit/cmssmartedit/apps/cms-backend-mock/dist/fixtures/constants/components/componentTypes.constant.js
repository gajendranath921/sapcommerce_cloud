...
const TYPE_TABSET_NAME = 'type.tabset.name';
const TYPE_CMSLINKCOMPONENT_NAME = 'type.cmslinkcomponent.name';
const SE_PSTFIX_TEXT_KEY = 'se.cms.visible.postfix.text';
const VISIBLE_NAME_KEY = 'type.component.abstractcmscomponent.visible.name';
exports.componentTypes = [
    {
        attributes: [
            {
                cmsStructureType: 'Boolean',
                i18nKey: VISIBLE_NAME_KEY,
                localized: false,
                qualifier: 'visible',
                postfix: SE_PSTFIX_TEXT_KEY
            },
            {
    ...
    },
    {
        ...
        i18nKey: TYPE_CMSLINKCOMPONENT_NAME,
        name: 'Link',
    ...
    },
    {
        attributes: [
            ...
            },
            {
                ...
                subTypes: {
                    CMSLinkComponent: TYPE_CMSLINKCOMPONENT_NAME
                }
            }
        ],
        category: 'NotToBeFound',
    ...
    },
    {
        ...
        category: 'COMPONENT',
        code: 'TabsetComponent',
        i18nKey: TYPE_TABSET_NAME,
...
//# sourceMappingURL=componentTypes.constant.js.map