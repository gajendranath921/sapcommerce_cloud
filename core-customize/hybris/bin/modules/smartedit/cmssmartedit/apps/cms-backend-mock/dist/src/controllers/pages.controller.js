...
let PagesController = class PagesController {
    ...
    getPageTemplateDataByUuid(pageUuid) {
        if (pageUuid && pageUuid === 'pageuuid') {
            return {
                frontEndName: 'pageTemplate2',
                name: 'Page Template 2',
                previewIcon: 'previewIcon 2',
    ...
    getDefaultPages(typeCode) {
        if (typeCode) {
            const timestamp = '2016-04-08T21:16:41+0000';
            switch (typeCode) {
                case 'ContentPage':
                    return {
                        pages: [
...
tslib_1.__decorate([
    common_1.Get('cmswebservices/v1/pagetemplate*'),
    tslib_1.__param(0, common_1.Query('pageUuid')),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [String]),
    tslib_1.__metadata("design:returntype", void 0)
], PagesController.prototype, "getPageTemplateDataByUuid", null);
tslib_1.__decorate([
