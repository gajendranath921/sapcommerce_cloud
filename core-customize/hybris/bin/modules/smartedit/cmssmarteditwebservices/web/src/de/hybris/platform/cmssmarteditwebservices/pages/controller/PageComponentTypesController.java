...
public class PageComponentTypesController
{
    ...
    @ResponseBody
    @ApiOperation(nickname = "getComponentTypesAvailableToPage", value = "Retrieves component types.", notes = "Retrieves the component types that can be added to a page.")
    @ApiResponses({
    ...
    @ApiImplicitParams({
            ...
            @ApiImplicitParam(name = "langIsoCode", value = "language ISO Code", dataType = "string", paramType = "query"),
