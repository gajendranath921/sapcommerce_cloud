...
public class CategorySearchController
{
	...
	@GetMapping
	@ResponseBody
	@ApiOperation(nickname = "getProductCategoriesByTextOrMask", value = "Find product categories by text or mask", notes = "Endpoint to find product categories using a free text search field.")
	@ApiResponses(
	{
