...
public class PageOperationsController
{
	...
	@ResponseBody
	@ApiOperation(nickname = "performPageItemOperations", value = "Perform different operations on the page item.", notes = "Endpoint to perform different operations on the page item such as delete a page etc.")
	@ApiImplicitParams(
	{
