...
public class InboxController
{
	...
	@ResponseBody
	@ApiOperation(nickname = "getWorkFlowTasks", value = "Retrieves all workflow tasks for the current user that are yet to be acted upon", notes = "Endpoint that retrieves all workflow tasks for the current user")
	@ApiResponses(
	{ //
