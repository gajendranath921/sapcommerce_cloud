...
public class SynchronizationController
{
	...
	@ResponseBody
	@ApiOperation(nickname = "getSynchronizationStatus", value = "Get synchronization status", notes = "Will build the synchronization status of a page including detailed status of its content slots and their cms components.")
	@ApiResponses(
	{ //
	...
	public SyncItemStatusWsDTO getSyncStatus( //
			@ApiParam(value = "The catalog uid", required = true)
			@PathVariable
	...
	@ResponseBody
	@ApiOperation(nickname = "performSynchronization", value = "Perform synchronization", notes = "Will perform synchronization status on a list of item identifier by their ItemSynchronizationWsDTO.")
	@ApiBaseSiteIdParam
