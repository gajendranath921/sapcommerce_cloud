...
public class CatalogController
{
	...
	@ApiOperation(nickname = "getContentCatalogs", value = "Get content catalogs", notes = "Endpoint to retrieve content catalog information including the related catalog versions for all catalogs for a given site and its parents.")
	...
	@ApiOperation(nickname = "getProductCatalogs", value = "Get product catalogs", notes = "Endpoint to retrieve product catalog information including the related catalog versions for all catalogs for a given site")
