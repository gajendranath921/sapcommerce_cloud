...
module.exports = function(grunt) {
    ...
    grunt.registerTask(
        taskName,
        'fails the build if the code contains fdescribe or fit in one of the e2e',
        function() {
            ...
            if (focusedFiles.length) {
                grunt.log.writeln(
                    'At least one e2e test file contains a focus (fdescribe and/or fit):'.yellow
                );
