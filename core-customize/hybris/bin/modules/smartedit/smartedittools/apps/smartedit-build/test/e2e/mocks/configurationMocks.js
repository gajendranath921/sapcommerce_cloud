...
angular
    ...
    //     });
    // })
    .run(function (httpBackendService, $injector) {
        ...
        var map = [
            ...
            {
                value:
                    '{"smartEditContainerLocation":"/smartedit-build/test/e2e/smarteditContainer/clickThroughOverlay.js"}',
                key: 'applications.clickThroughOverlayTriggerModule'
            },
            {
                value:
                    '{"smartEditContainerLocation":"/smartedit-build/test/e2e/smarteditContainer/httpSpy.js"}',
