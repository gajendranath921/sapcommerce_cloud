        ...
        test: {
            ...
            unit: {
                ...
                commonUtilModules: [
                    ...
                    path.join(BUNDLE_ROOT, 'node_modules/angular/angular.js'),
                    path.join(BUNDLE_ROOT, 'node_modules/angular-animate/angular-animate.js'),
                    path.join(BUNDLE_ROOT, 'node_modules/angular-route/angular-route.js'),
                    path.join(
                        BUNDLE_ROOT,
                    ...
                    path.join(BUNDLE_ROOT, 'node_modules/angular-sanitize/angular-sanitize.js'),
                    path.join(BUNDLE_ROOT, 'node_modules/ui-select/dist/select.js'),
                    ...
                    path.join(BUNDLE_ROOT, 'node_modules/angular-ui-tree/dist/angular-ui-tree.js'),
                    path.join(
                        BUNDLE_ROOT,
                        'node_modules/ng-infinite-scroll/build/ng-infinite-scroll.js'
                    ),
                    path.join(BUNDLE_ROOT, 'node_modules/crypto-js/crypto-js.js'),
                    path.join(BUNDLE_ROOT, 'node_modules/angular-mocks/angular-mocks.js'),
