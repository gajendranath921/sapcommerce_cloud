...
public class DefaultSmarteditI18nFacadeTest
{
	...
	public void setUp()
	{
		...
		lenient().when(commonI18NService.getLocaleForIsoCode(ENGLISH.toString())).thenReturn(new Locale("en"));
		lenient().when(commonI18NService.getLocaleForIsoCode(GERMAN.toString())).thenReturn(new Locale("de"));
		lenient().when(commonI18NService.getLocaleForIsoCode(FRENCH.toString())).thenReturn(new Locale("fr"));
		lenient().when(commonI18NService.getLocaleForIsoCode(COLUMBIA_SPANISH.toString())).thenReturn(COLUMBIA_SPANISH);
	}
	...
	public void shouldNotGetLocalizationsWhen_SystemInitialized_And_TenantOnStartupDoesNotMatchCurrentTenant()
	{
		...
		doReturn(currentTenant).when(smarteditI18nFacade).getCurrentTenant();
		doReturn(true).when(smarteditI18nFacade).isSystemInitialized();
		lenient().doNothing().when(smarteditI18nFacade).initializeLocalizations();
	...
	{
		lenient().when(l10nService.getResourceBundle(i18nService.getAllLocales(FRENCH))).thenReturn(createResourceBundle(null, null));
