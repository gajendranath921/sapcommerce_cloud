...
public class DefaultSmarteditConfigurationDao implements SmarteditConfigurationDao
{
	...
	public static final String SELECT_ALL_CONFIGURATIONS = String.format("SELECT {%s} FROM {%s} ORDER BY {%s}", SmarteditConfigurationModel.PK,
			SmarteditConfigurationModel._TYPECODE, SmarteditConfigurationModel.KEY);
