...
public class I18nController
{
	...
	@ApiOperation(nickname = "getTranslationMap", value = "Get a Translation Map", notes = "Endpoint to retrieve translated data using the specified locale value")
	...
	@ResponseBody
	@ResponseStatus(value = HttpStatus.OK)
	@ApiOperation(nickname = "getLanguages", value = "Get Languages", notes = "Endpoint to retrieve list of supported languages")
