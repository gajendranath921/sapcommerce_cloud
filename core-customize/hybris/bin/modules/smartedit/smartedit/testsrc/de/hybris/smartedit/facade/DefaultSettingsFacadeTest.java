...
public class DefaultSettingsFacadeTest
{
	...
	public void testDefaultSettingsFacade()
	{
		...
		Mockito.doReturn(" a , b,,, ,c, d, e,f,g ").when(defaultSettingsFacade).getSetting("smartedit.validFileMimeTypeCodes");
		...
		assertThat(settings.get("smartedit.validFileMimeTypeCodes"), is(Arrays.asList("a", "b", "c", "d", "e", "f", "g")));
	}
}
