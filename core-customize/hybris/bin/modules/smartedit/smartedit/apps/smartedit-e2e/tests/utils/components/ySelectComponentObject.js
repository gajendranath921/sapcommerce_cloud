    ...
    var ySelect = function (id) {
        ...
        this.elements = {
            getSelectorContainer: function () {
                return this.elem.element(this.locators.selectorContainer());
            }.bind(this),
            getSimpleDropdownToggle: function () {
                return this.elem.element(by.css('.select2-choice'));
            }.bind(this),
            getMultiDropdownToggle: function () {
                return this.elem.element(by.css('.ui-select-search'));
            }.bind(this),
            getAllOptions: function () {
                return this.elem.all(by.css('.ui-select-choices-row'));
            }.bind(this),
            getOptionByText: function (text) {
                return this.elem.element(
                    by.xpath(
                        "//*[contains(@class, 'ui-select-choices-row')]//span[normalize-space(text())='" +
                            text +
                            "']"
                    )
                );
            ...
            getAllMultiSelections: function () {
                return this.elem.all(by.css('.select2-search-choice > span'));
            }.bind(this)
        };
                            ...
                            !classNames.match(
                                new RegExp(
                                    '(' +
                                        ...
                                        '|' +
                                        ySelect.constants.VALIDATION_MESSAGE_TYPE.WARNING +
                                        ')',
                                    'g'
                                )
                            ),
                            'Selector has a validation state'
                        ).toBeTruthy();
                    });
            }.bind(this),
