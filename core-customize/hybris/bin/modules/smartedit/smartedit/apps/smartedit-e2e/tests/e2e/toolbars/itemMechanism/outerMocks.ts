...
import '../../../utils/outerLegacyCustomAppBootstrap';
        ...
        moduleUtils.bootstrap(
            (httpBackendService: HttpBackendService, windowUtils: WindowUtils) => {
                ...
                const map = [
                    ...
                    {
                        value:
                            '{"smartEditContainerLocation":"/apps/smartedit-e2e/generated/e2e/toolbars/itemMechanism/outerapp.js"}',
                        key: 'applications.Outerapp'
                    },

                    {
                        value:
                            '{"smartEditLocation":"/apps/smartedit-e2e/generated/e2e/toolbars/itemMechanism/innerapp.js"}',
                ...
                httpBackendService
                    ...
                    .respond(function (method, url, data) {
                        const returnedPayload = {
                            ...
                            resourcePath:
                                'http://127.0.0.1:9000/generated/e2e/toolbars/itemMechanism/iframe.html'
                        };
