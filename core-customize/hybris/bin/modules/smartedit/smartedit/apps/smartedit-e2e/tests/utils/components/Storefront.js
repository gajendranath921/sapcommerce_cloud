...
module.exports = (function () {
    ...
    storefrontObject.actions = {
        deepLink: function () {
            return browser.switchToIFrame().then(function () {
                storefrontObject.actions.moveToComponent(
                    storefrontObject.constants.DEEP_LINKS_SLOT_ID,
                    'ContentSlot'
                );
        ...
        moveToComponent: function (componentId, componentType) {
            ...
            browser
                .actions()
                .mouseMove(
                    storefrontObject.elements.getOriginalComponentById(componentId, componentType)
                )
                .perform();
        },
    ...
    storefrontObject.assertions = {
        ...
        assertComponentContains: function (componentModel, content) {
            _assertElementContains(
                storefrontObject.elements.getComponentByModel(componentModel),
                content
            );
        },
        ...
        assertComponentInOverlayPresent: function (componentId, componentType, isPresent) {
            ...
            _assertElementPresent(
                storefrontObject.elements.getComponentInOverlayById(componentId, componentType),
                isPresent
            );
        },
