        ...
        async openAndBeReady(
            ...
            await browser.get(
                pageListType === 'clientPagedList'
                    ? `smartedit-e2e/generated/e2e/clientPagedList/index.html?perspectiveServiceResult=${PERSPECTIVE_SERVICE_RESULT}`
                    : `smartedit-e2e/generated/e2e/dynamicPagedList/index.html?perspectiveServiceResult=${PERSPECTIVE_SERVICE_RESULT}`
            );
        },
