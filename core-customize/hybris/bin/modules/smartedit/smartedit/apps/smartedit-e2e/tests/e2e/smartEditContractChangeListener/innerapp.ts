...
import { InnerClickThroughOverlay } from '../../utils/commonMockedModules/innerClickThroughOverlay';
...
export class SakExecutorDebugComponent {
    ...
    getSakExecutorElements() {
        return AbstractDecorator.getScopes()
            .concat(this.legacyDecoratorToCustomElementConverter.getScopes())
            .sort();
    }
...
@NgModule({
    imports: [CommonModule, InnerClickThroughOverlay],
    declarations: [
