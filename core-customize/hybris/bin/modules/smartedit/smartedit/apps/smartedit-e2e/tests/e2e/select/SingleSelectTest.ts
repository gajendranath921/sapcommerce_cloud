...
describe('Single Select - ', () => {
    ...
    describe('Single Selector - ', () => {
        ...
        describe('callbacks', () => {
            ...
            it(
                'GIVEN "keyup" WHEN providing search input AND releasing a key (keyup) THEN the "keyup" function should be' +
                    ' called',
                async () => {
                    ...
                    await PageObject.Assertions.keyupSearchIsEqualTo(singleSelect1App, '');
                    ...
                    await Select.Actions.setSearchInputValue(singleSelect1, 'c');

                    browser.sleep(401);

                    await PageObject.Assertions.keyupSearchIsEqualTo(singleSelect1App, 'abc');
                }
            );
        });
