    ...
    providers: [
        ...
        moduleUtils.bootstrap(
            (httpBackendService: HttpBackendService) => {
                ...
                httpBackendService.whenGET(/apps\/smartedit-e2e\/generated\/e2e/).passThrough();
                ...
                const map = [
                    ...
                    {
                        value:
                            '{"smartEditContainerLocation":"/apps/smartedit-e2e/generated/e2e/collapsible/outerapp.js"}',
                        key: 'applications.collapsibleApp'
                    },
                    {
