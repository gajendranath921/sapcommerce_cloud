        ...
        moduleUtils.bootstrap(
            (httpBackendService: HttpBackendService, windowUtils: WindowUtils) => {
                ...
                const map = [
                    ...
                    {
                        value:
                            '{"smartEditContainerLocation":"/apps/smartedit-e2e/generated/e2e/gateway/outerapp.js"}',
                        key: 'applications.Outerapp'
                    },
                    {
                        value:
                            '{"smartEditLocation":"/apps/smartedit-e2e/generated/e2e/gateway/innerapp.js"}',
                ...
                httpBackendService
                    ...
                    .respond(function (method, url, data) {
                        const returnedPayload = {
                            ...
                            resourcePath: 'http://127.0.0.1:9000/generated/e2e/gateway/iframe.html'
                        };
