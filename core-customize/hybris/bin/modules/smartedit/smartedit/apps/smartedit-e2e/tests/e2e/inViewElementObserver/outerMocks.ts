...
import '@smartedit/e2e-utils/shared/mocks/container/clickThroughOverlay';
        ...
        moduleUtils.bootstrap(
            (httpBackendService: HttpBackendService, windowUtils: WindowUtils) => {
                ...
                const map = [
                    ...
                    {
                        value:
                            '{"smartEditLocation":"/apps/smartedit-e2e/generated/e2e/inViewElementObserver/innerapp.js"}',
