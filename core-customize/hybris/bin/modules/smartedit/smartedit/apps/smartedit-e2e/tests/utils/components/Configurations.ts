...
export namespace Configurations {
    ...
    export const Actions = {
        ...
        async waitUntilConfigurationReady(): Promise<void> {
            await browser.waitUntil(() => {
                return Elements.getConfigurationsAsList()
                    .count()
                    .then((count) => {
                        return count > 0;
                    });
        ...
        async clickSave(): Promise<void> {
            await browser.click(Elements.getSaveButton(), 'Could not click on Save Button');
        ...
        getConfigurations(): Promise<{ key: string; value: string }[]> {
            return Actions.getEntry([], Elements.getConfigurationsAsList(), 0);
        },
