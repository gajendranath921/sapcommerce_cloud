    ...
    providers: [
        ...
        moduleUtils.bootstrap(
            (httpBackendService: HttpBackendService, languageService: LanguageService) => {
                ...
                const storfrontentUrl = '/apps/smartedit-e2e/generated/pages/storefront.html';
                ...
                httpBackendService.whenPOST(/thepreviewTicketURI/).respond({
                    ...
                    resourcePath: document.location.origin + storfrontentUrl
                });
