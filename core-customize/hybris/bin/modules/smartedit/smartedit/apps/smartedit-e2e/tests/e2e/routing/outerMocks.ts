...
import { STOREFRONT_URI_TOKEN } from '../../utils/outerConstants';
        ...
        E2eOnLoadingSetupModule.provide([
            {
                ...
                useValue: 'http://127.0.0.1:9000/generated/e2e/routing/smarteditiframe.html'
            }
        ]),
        ...
        moduleUtils.bootstrap(
            (httpBackendService: HttpBackendService) => {
                const map = [
                    ...
                    {
                        value:
                            '{"smartEditLocation":"/apps/smartedit-e2e/generated/e2e/routing/innerDecorators.js"}',
                        key: 'applications.CMSApp'
                    },
                    {
                        value:
                            '{"smartEditContainerLocation":"/apps/smartedit-e2e/generated/e2e/routing/outerapp.js"}',
                ...
                const allSites = [
                    {
                        previewUrl:
                            '/apps/smartedit-e2e/generated/e2e/routing/smarteditiframe.html',
                        name: {
                            en: 'Electronics'
                        },
