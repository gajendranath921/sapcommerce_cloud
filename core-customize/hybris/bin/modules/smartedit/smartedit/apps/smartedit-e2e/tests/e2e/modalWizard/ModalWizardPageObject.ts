...
export namespace ModalWizardPageObject {
    ...
    export const Actions = {
        async navigate(): Promise<void> {
            await browser.get('smartedit-e2e/generated/e2e/modalWizard/#!/ng/storefront');
        },
