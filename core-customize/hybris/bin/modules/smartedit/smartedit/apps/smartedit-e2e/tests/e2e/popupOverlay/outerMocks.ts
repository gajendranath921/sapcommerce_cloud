        ...
        moduleUtils.bootstrap(
            (
                ...
                const map = [
                    ...
                    {
                        value:
                            '{"smartEditContainerLocation":"/apps/smartedit-e2e/generated/e2e/popupOverlay/outerapp.js"}',
                        key: 'applications.popupOverlayApp'
                    },
                    {
                ...
                indicator.onSmarteditContainerReady().subscribe(() => {
                    lazy.$templateCache().put(
                        'popupOverlayTemplateUrl.html',
                        '<div id="popup">{{ $ctrl.message }}</div>'
                    );
                });
            },
            [
