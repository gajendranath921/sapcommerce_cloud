...
@Component({
    ...
    template: ` <span>Results Header Custom Component</span> `
})
...
@Component({
    ...
    template: ` <div><b>Label:</b> {{ data.item.label }} <b>Price:</b> {{ data.item.price }}</div> `
})
...
export class MockMultiSelect1Component
    extends BaseMockSelectComponent
...
export class MockMultiSelect2Component
    extends BaseMockSelectComponent
    implements Partial<SelectComponent<any>> {
