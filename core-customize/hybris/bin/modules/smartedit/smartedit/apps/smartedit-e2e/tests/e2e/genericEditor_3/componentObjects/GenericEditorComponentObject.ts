...
export namespace GenericEditorComponentObject {
    export const Elements = {
        ...
        getRichTextWarningCheckbox() {
            return by.css('[id="richTextWarningCheckBox"]');
        },
        getRichTextWarningMessage() {
            return by.css('[id="richTextWarningMessage"]');
        }
    };
    ...
    export const Actions = {
        ...
        async clickWarningCheckBox(): Promise<void> {
            await browser.click(Elements.getRichTextWarningCheckbox());
        },
        // Fields
    ...
    export const Assertions = {
        ...
        async richTextWarningMessageNotDisplayed(): Promise<void> {
            await browser.waitForAbsence(Elements.getRichTextWarningMessage());
        },

        async richTextWarningMessageDisplayed(): Promise<void> {
            await browser.waitForVisibility(Elements.getRichTextWarningMessage());
        },
        ...
        async fieldHasValidationErrorInLanguage(
            ...
            expect(await validationErrors.get(0).getText()).toBe(expectedErrorMsg);
        },
