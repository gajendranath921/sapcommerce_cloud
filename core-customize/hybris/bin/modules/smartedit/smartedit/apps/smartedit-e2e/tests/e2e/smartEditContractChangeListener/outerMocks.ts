        ...
        moduleUtils.bootstrap(
            (httpBackendService: HttpBackendService) => {
                ...
                const map = [
                    ...
                    {
                        value:
                            '{"smartEditContainerLocation":"/apps/smartedit-e2e/generated/e2e/smartEditContractChangeListener/outerapp.js"}',
                        key: 'applications.OuterClickThroughOverlay'
                    },
                    {
                        value:
                            '{"smartEditLocation":"/apps/smartedit-e2e/generated/e2e/smartEditContractChangeListener/innerapp.js"}',
                        key: 'applications.InnerSECCLDecoratorsModule'
                    },
                    {
                        value: '"somepath"',
                        key: 'i18nAPIRoot'
