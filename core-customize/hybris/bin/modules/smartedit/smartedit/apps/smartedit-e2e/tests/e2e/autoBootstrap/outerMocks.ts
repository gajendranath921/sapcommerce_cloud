        ...
        moduleUtils.bootstrap(
            (httpBackendService: HttpBackendService) => {
                ...
                const map = [
                    ...
                    {
                        value:
                            '{"smartEditLocation":"/apps/smartedit-e2e/generated/e2e/autoBootstrap/innerDummyDecorators.js"}',
                        key: 'applications.InnerDecoratorsModule'
                    },
                    {
                        value: '"somepath"',
                        key: 'i18nAPIRoot'
...
// window.__smartedit__.smartEditInnerAngularApps = ['InnerDecoratorsModule'];
