...
export class SmarteditElementComponent {
    ...
    ngAfterViewInit(): void {
        this.mousenterListener = (event: Event): void => {
            if (!this.active) {
        ...
        this.mouseleaveListener = (event: Event): void => {
            if (this.active) {
                this.active = false;
                this.propagateActiveStateToChildren();
            }
    ...
    private onComponentUpdated(
        eventId: string,
        componentUpdatedData: ComponentUpdatedEventInfo
    ): void {
    ...
    private propagateActiveStateToChildren = (): void => {
