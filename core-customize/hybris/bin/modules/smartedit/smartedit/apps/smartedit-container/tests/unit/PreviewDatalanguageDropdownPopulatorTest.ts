...
describe('PreviewDatalanguageDropdownPopulator', () => {
    ...
    it('GIVEN a correct siteId WHEN PreviewDatalanguageDropdownPopulator.populate is called THEN populate will return a list of associated languages', async () => {
        ...
        languageService.getLanguagesForSite.and.returnValue(
            Promise.resolve<any>(languageDescriptors)
        );

        // WHEN
        const languages = await previewDatalanguageDropdownPopulator.fetchAll({
            field: {
    ...
    it('GIVEN a correct siteId WHEN fetchAll is called with a search string THEN it will return a list of associated languages filtered based on the search string', async () => {
        // GIVEN
        languageService.getLanguagesForSite.and.returnValue(
            Promise.resolve<any>(languageDescriptors)
        );
    ...
    it('GIVEN a wrong siteId WHEN fetchAll is called THEN it will return a rejected promise', async () => {
        // GIVEN
