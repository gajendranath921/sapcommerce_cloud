...
describe('notificationService', () => {
    ...
    const DUMMY_COMPONENT_NAME = 'DummyComponent';

    const DUMMY_CONFIGURATION: INotificationConfiguration = {
        id: DUMMY_ID,
        componentName: DUMMY_COMPONENT_NAME
    };
    ...
    describe('pushNotification', () => {
        ...
        it('creates an notification with given ID and component name', () => {
            // Given
            const configuration = {
                id: DUMMY_ID,
    ...
    describe('removeNotification', () => {
        ...
        it('does not remove notification when no notification with the given ID exists', () => {
            ...
            notificationService.pushNotification({
                id: DUMMY_ID1,
                componentName: 'DummyComponent1'
            });

            notificationService.pushNotification({
                id: DUMMY_ID2,
                componentName: 'DummyComponent2'
            });
