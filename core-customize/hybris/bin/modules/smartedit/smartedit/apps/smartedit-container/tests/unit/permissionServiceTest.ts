...
describe('smarteditContainer permissionService', function () {
    ...
    const RULE_NAME_NOT_AN_ARRAY = 'not.an.array';
    ...
    describe('initialization', () => {
        it('checks GatewayProxied', () => {
            expect(
                annotationService.getClassAnnotation(PermissionService, GatewayProxied)
            ).toEqual([
                'isPermitted',
                'clearCache',
                'registerPermission',
        ...
        it('(permissionService as any)._registerEventHandlers', () => {
            ...
            perspectiveChangeCallback(null);
    ...
    describe('PermissionService.registerPermission', function () {
        ...
        it('throws exception if parameter names is not of type Array', function () {
            ...
            expect(function () {
                permissionService.registerPermission({
                    aliases: RULE_NAME_NOT_AN_ARRAY,
                    rules: []
                } as any);
            }).toThrow(new Error('Permission aliases must be an array'));
        });
    ...
    describe('PermissionService.isPermitted', function () {
        ...
        it('returns true when permission exists with verified rule', async function () {
            // Given
            permissionService.registerRule({
                names: [DUMMY_RULE_NAME],
                verify() {
        ...
        it('returns false when at least one rule is false', async function () {
            // Given
        ...
        it('returns true when two permissions are requested whose rules are true', async function () {
            // Given
            permissionService.registerRule({
                names: [DUMMY_RULE_NAME1],
                verify() {
        ...
        it('returns false when at least one permission requested has a false rule', async function () {
            // Given
            permissionService.registerRule({
                names: [DUMMY_RULE_NAME1],
                verify() {
        ...
        it('returns true when requested permission exists and called with permission name as a parameter', async function () {
            // Given
        ...
        it('is called with two permissions, referencing 1 rule, then rule.verify is called once with with 2 permission name', async function () {
            // Given
            const verify = jasmine.createSpy('verify').and.returnValue(Promise.resolve(true));
        ...
        it('is called with one permission, referencing 1 rule, then rule.verify is called once with with 1 permission name', async function () {
            // Given
            const verify = jasmine.createSpy('verify').and.returnValue(Promise.resolve(true));
        ...
        it('only calls the same rule.verify with a given permission name once for a given context', async function () {
            // Given
            const verify = jasmine.createSpy('verify').and.returnValue(Promise.resolve(true));
        ...
        it('calls the same rule.verify with a given permission name more than once if the contexts associated to the permission names are different', async function () {
            // Given
            const verify = jasmine.createSpy('verify').and.returnValue(Promise.resolve(true));
        ...
        it('calls two rules with different permission names but the same context if it is shared', async function () {
            // Given
        ...
        it('returns true when requested permission does not exist but default rule is registered and called with permission name as a parameter', async function () {
            // Given
            const verify = jasmine.createSpy('verify').and.returnValue(Promise.resolve(true));
        ...
        it('only calls a rule once when multiple permissions use the same rule', async function () {
            // Given
            const verify = jasmine.createSpy('verify').and.returnValue(Promise.resolve(true));
        ...
        it('only calls a rule once when multiple permissions reference the same rule with different names', async function () {
            // Given
            const verify = jasmine.createSpy('verify').and.returnValue(Promise.resolve(true));
        ...
        it('returns false when one asynchronous rule returns false before the other rules return', async function () {
            // Given
            permissionService.registerRule({
                names: [DUMMY_RULE_NAME1],
                verify() {
        ...
        it('returns error message when one asynchronous rule rejects before the other rules return', async function () {
            // Given
        ...
        it('caches the result of the first call for the same permission and returns the cached result on the second call', async function () {
            // Given
            const verify = jasmine.createSpy('verify').and.returnValue(Promise.resolve(true));
        ...
        it('console logs error message when a rule is rejected', async function () {
            // Given
            const ERROR_MESSAGE = 'error.message';
    ...
    describe('PermissionService.hasCachedResult', function () {
        ...
        it('returns true when a cache section exists for a given rule and a result exists with the given key', async function () {
            // Given
            permissionService.registerRule({
                names: [DUMMY_RULE_NAME],
                verify() {
    ...
    describe('PermissionService.clearCache', function () {
        it('removes all cached values', async function () {
            // Given
            const verify1 = jasmine.createSpy('verify').and.returnValue(Promise.resolve(true));
            const verify2 = jasmine.createSpy('verify').and.returnValue(Promise.resolve(true));
