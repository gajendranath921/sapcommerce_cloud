...
describe('previewService', () => {
    ...
    describe('initialization', () => {
        ...
        describe('prepares restServices', () => {
            it('WHEN prepareRestService is called AND configuration cannot be loaded THEN it will handle a rejected promise', async () => {
    ...
    describe('createPreview', () => {
        it('WHEN createPreview is called and save operation has failed THEN it will return a rejected promise', async () => {
            const rejectReason = REJECT_REASON;
        ...
        it('GIVEN required attributes for createPreview are missing WHEN createPreview is called THEN it will throw', async () => {
    ...
    describe('updatePreview', () => {
        it('GIVEN required attributes for updatePreview are missing WHEN createPreview is called THEN it will throw', async () => {
            const invalidPreviewData = lodash.cloneDeep(mockPreviewData);
        ...
        it('WHEN updatePreview is called AND update operation has failed THEN it will return a rejected promise', async () => {
            const rejectReason = REJECT_REASON;
