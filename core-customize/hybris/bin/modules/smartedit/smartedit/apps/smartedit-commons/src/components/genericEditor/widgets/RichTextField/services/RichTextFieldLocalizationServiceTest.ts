...
describe('richTextFieldLocalizationService', () => {
    ...
    describe('localizeCKEditor', () => {
        it("should set global variable CKEDITOR's language to the current locale's equivalent in CKEDITOR when the conversion exists", async () => {
        ...
        it("should set global variable CKEDITOR's language to the current locale when the conversion does not exist", async () => {
