...
describe('dateTimePickerLocalizationService', () => {
    ...
    describe('localizeDateTimePicker', () => {
        it('should not localize the tool nor tooltips when both are already localized', async () => {
        ...
        it('should localize only the tool not the tooltips when tooltips are already localized but the tool itself is not', async () => {
        ...
        it('should localize only the tooltips nor the tool when the tool is already localized but not the tooltips', async () => {
            datetimepicker.locale.and.callFake(localeReturnSame);
        ...
        it('should localize both the tool and tooltips when they are not already localized', async () => {
            datetimepicker.locale.and.callFake(localeReturnDifferent);
            datetimepicker.tooltips.and.callFake(tooltipsReturnDifferent);
