...
describe('GenericEditorDropdownServiceFactory', () => {
    ...
    const i18nKey_smarteditComponentTypeDropDownAName =
        'type.thesmarteditComponentType.dropdownA.name';

    // options
    const fieldWithOptions: GenericEditorField = {
        cmsStructureType: 'EditableDropdown',
        qualifier: 'dropdownA',
        i18nKey: i18nKey_smarteditComponentTypeDropDownAName,
        options: [],
    ...
    beforeEach(() => {
        ...
        $injector.get.and.callFake(getProvider as any);
    ...
    it(
        ...
        () => {
            ...
            // WHEN
            const changeObject = cloneDeep(mockOption1);
