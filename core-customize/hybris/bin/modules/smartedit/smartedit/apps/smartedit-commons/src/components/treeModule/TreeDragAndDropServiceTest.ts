...
describe('TreeDragAndDropService - ', () => {
    ...
    describe('Callbacks', () => {
        ...
        it('beforeDrop calls beforeDropCallback', () => {
            treeDragAndDropService.init(getDndOptions());
    ...
    describe('Drop handling - ', () => {
        it('stops executing handleDrop if pointer is not over container', () => {
            treeDragAndDropService.init(getDndOptions());
        ...
        it('stops executing handleDrop if config is not present', () => {
            const spy = spyOn(treeDragAndDropService as any, 'allowDrop');
        ...
        it('stops executing handleDrop if allowDrop conditions are not met', () => {
        ...
        it('executes handleDrop if all validation is passed', () => {
