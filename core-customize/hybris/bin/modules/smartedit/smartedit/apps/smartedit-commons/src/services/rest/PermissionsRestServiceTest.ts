...
describe('PermisionsRestService', () => {
    ...
    it('Successfully returns permissions', () => {
        ...
        mockResource.queryByPost.and.returnValue(
            promiseHelper.buildPromise('success', PromiseType.RESOLVES, results) as any
        );
    ...
    it('Failed resource to be rejected with reason', () => {
        ...
        mockResource.queryByPost.and.returnValue(
            promiseHelper.buildPromise('fail', PromiseType.REJECTS, failureReason) as any
        );
