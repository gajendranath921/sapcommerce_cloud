...
public class DefaultYFormFacade implements YFormFacade
{
			...
			final String documentId) throws YFormServiceException
	{
		...
		final Map<String, String> metadata = FormDefinitionUtils.getFormDefinitionMetadata(content);
	...
	/**
	 * Create empty YFormData for YFormDefinition. It assigns it to the corresponding YFormDefinition via orbeon background API.
	 *
	 * @param applicationId
	 * @param formId
	 * @return new Id for YFormData
	 */
	@Override
	public String createEmptyYFormData(final String applicationId, final String formId) throws YFormServiceException
	{
		return proxyFacade.createEmptyDataForForm(applicationId, formId);
	}
	...
	public String getFormDataContentTemplate(final String applicationId, final String formId) throws YFormServiceException
	{
		...
		String emptyYFormDataId = this.createEmptyYFormData(applicationId, formId);
		return this.getYFormDataModel(emptyYFormDataId).getContent();
	}
