...
public class MarketplaceProductsTranslatorTest
{
	...
	public void setUp()
	{
		...
		Mockito.lenient().when(applicationContext.getBean("productService")).thenReturn(productService);
		Mockito.lenient().when(applicationContext.getBean("catalogVersionService")).thenReturn(catalogVersionService);
