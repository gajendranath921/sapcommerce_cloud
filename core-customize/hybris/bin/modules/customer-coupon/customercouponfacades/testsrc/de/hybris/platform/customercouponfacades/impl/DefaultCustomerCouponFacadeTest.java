...
public class DefaultCustomerCouponFacadeTest
{
	...
	public void testGrantCouponAccessForCurrentUserSuccess()
	{
		...
		Mockito.lenient().when(customerCouponService.getValidCustomerCouponByCode(Mockito.anyString())).thenReturn(optional);
	...
	{
		Mockito.lenient().when(customerCouponRemovableStrategy.checkRemovable(Mockito.anyString())).thenReturn(true);
