...
public class DefaultValidationAndOutputEncodingITTest extends AbstractRuleEngineServicesTest
{
	...
	private final String droolRuleUuid = "a33dc303-11ef-4719-82f5-ea6d8ae6dec9";
	...
	{
		importCsv("/droolsruleengineservices/test/outputEncoding_source_rule.impex", "utf-8");
	}
	...
	public void testOutputEncoding() throws IOException
	{
		...
		final String expectedDroolsContentCode = getResourceAsString(
				"/droolsruleengineservices/test/compiler/sony_generatedDroolContents.bin");
	...
	protected DroolsRuleGeneratorContext prepareContext() throws IOException
	{
		...
		final RuleCompilationContext ruleCompilationContext = ruleCompilationContextProvider.getRuleCompilationContext();
