...
public abstract class AbstractRuleCompilePublishComposer extends ViewAnnotationAwareComposer
{
	 ...
	 * 			error messsage
	 */
	protected void onValidationError(final String message)
	{
		getNotificationService().notifyUser(NotificationSource.MESSAGE_SOURCE, EventType.EXCEPTION, Level.FAILURE, message);
	}
