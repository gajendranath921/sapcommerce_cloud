...
public class RuleEngineUndeployJobPerformableUnitTest
{
	private static final String MODULE_NAME = "test_module";

	@InjectMocks
	private RuleEngineUndeployJobPerformable jobPerformable;
	@Mock
	...
	public void testPerformOk()
	{
		...
		Mockito.lenient().when(ruleMaintenanceService.undeployRules(sourceRules, MODULE_NAME)).thenReturn(result);
