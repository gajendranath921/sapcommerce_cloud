...
public class ProductToProductCodesMapperTest
{
	...
	public void setUp()
	{
		Mockito.lenient().when(product.getCode()).thenReturn("productCode");
	}
	...
	{
		Mockito.lenient().when(product.getVariants()).thenReturn(Collections.emptyList());
	...
	public void shouldMapProductCodesCorrectly()
	{
		...
		Mockito.lenient().when(product.getVariants()).thenReturn(List.of(product1, product2));
		Mockito.lenient().when(product1.getVariants()).thenReturn(List.of(product3));
		Mockito.lenient().when(product2.getVariants()).thenReturn(List.of(product4));
