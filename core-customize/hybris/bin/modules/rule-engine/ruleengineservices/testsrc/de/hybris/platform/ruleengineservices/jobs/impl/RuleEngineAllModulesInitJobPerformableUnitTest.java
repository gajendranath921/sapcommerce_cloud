...
public class RuleEngineAllModulesInitJobPerformableUnitTest
{

	@InjectMocks
	private RuleEngineAllModulesInitJobPerformable jobPerformable;
	@Mock
	...
	public void testPerformOk()
	{
		...
		Mockito.lenient().when(ruleMaintenanceService.initializeAllModules(true)).thenReturn(result);
	...
	@Test
	public void testPerformGenericSuccess()
	{
