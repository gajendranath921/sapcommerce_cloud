...
public class DefaultRuleActionsConverterTest
{
	...
	protected List<RuleActionData> createRuleActionsSimple()
	{
		...
		Mockito.lenient().when(ruleActionsRegistry.getAllActionDefinitionsAsMap()).thenReturn(
	...
	protected List<RuleActionData> createRuleActionsComplex()
	{
		...
		Mockito.lenient().when(ruleActionsRegistry.getAllActionDefinitionsAsMap()).thenReturn(ruleActionDefinitions);
