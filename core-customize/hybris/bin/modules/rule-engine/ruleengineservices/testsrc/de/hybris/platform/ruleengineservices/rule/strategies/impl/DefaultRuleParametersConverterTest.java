...
public class DefaultRuleParametersConverterTest
{
	...
	public void setUp() throws Exception
	{
		...
		Mockito.lenient().when(ruleParameterValueConverter.fromString(STRING_VALUE_JSON, STRING_TYPE)).thenReturn(STRING_VALUE);
		Mockito.lenient().when(ruleParameterValueConverter.fromString(INTEGER_VALUE_JSON, INTEGER_TYPE)).thenReturn(INTEGER_VALUE);
