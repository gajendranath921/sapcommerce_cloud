...
public class ConditionToValuesMapperTest<T>
{
	...
	public void shouldReturnListOfMappedValues()
	{
		...
		Mockito.lenient().when(parameterValueMapper.fromString("value1")).thenReturn(object1);
		Mockito.lenient().when(parameterValueMapper.fromString("value4")).thenReturn(object2);
