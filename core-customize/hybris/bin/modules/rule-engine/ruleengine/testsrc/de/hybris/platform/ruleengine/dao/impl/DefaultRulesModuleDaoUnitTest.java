...
public class DefaultRulesModuleDaoUnitTest
{
	...
	public void testFindByNameAndVersion()
	{
		...
		Mockito.lenient().when(flexibleSearchService.<AbstractRulesModuleModel> searchUnique(any(FlexibleSearchQuery.class))).thenReturn(rulesModule);
	...
	{
		Mockito.lenient().when(flexibleSearchService.<AbstractRulesModuleModel> searchUnique(any(FlexibleSearchQuery.class)))
