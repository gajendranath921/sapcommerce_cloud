...
public class DefaultRuleEngineContainerRegistryUnitTest
{
	...
	public void setUp()
	{
		...
		Mockito.lenient().when(concurrentMapFactory.createNew()).thenReturn(containerMap);
	...
	{
		final ReleaseIdImpl releaseId1 = new ReleaseIdImpl("test_group1", "test_artifact1", RELEASEID_VERSION);
		final ReleaseIdImpl releaseId2 = new ReleaseIdImpl("test_group2", "test_artifact2", RELEASEID_VERSION);
	...
	{
		ruleEngineContainerRegistry.setReadLockEnabled(true);
