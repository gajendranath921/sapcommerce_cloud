...
public class DefaultIncrementalRuleEngineUpdateStrategyUnitTest
{
	...
	{
		Mockito.lenient().when(engineRulesRepository.countDeployedEngineRulesForModule(MODULE_NAME)).thenReturn(99L);
	...
	{
		Mockito.lenient().when(engineRulesRepository.countDeployedEngineRulesForModule(MODULE_NAME)).thenReturn(1000L);
