...
public class DefaultSolrChangesServiceTest extends HybrisJUnit4TransactionalTest
{
	...
	{
		//test
		assertEquals("check the name file", NAME, solrService.getNameFile());
		assertNotEquals("check name file is different from original","licensee.properties", solrService.getNameFile());
	}
