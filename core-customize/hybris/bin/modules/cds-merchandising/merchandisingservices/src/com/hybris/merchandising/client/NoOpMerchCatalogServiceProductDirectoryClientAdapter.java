...
public class NoOpMerchCatalogServiceProductDirectoryClientAdapter implements MerchCatalogServiceProductDirectoryClient {
	...
	{
		processPublish(productDirectoryId, version, context);
		return null;
	}
	 ...
	 * @param version            the version to publish.
	 */
	private void processPublish(final String productDirectoryId, final String version, final ProductPublishContext context)
	{
		LOG.debug("Publishing productDirectoryId: {}, version: {}, numberOfProduct: {}", productDirectoryId, version, context.getTotal());
	}
