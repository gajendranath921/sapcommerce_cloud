...
public class MerchCatalogServiceProductDirectoryClientAdapter implements MerchCatalogServiceProductDirectoryClient
{
	 ...
	 */
	@Override
	public Void publishProducts(final String productDirectoryId, final String version, final ProductPublishContext context)
	{
		return publishProductsAsync(productDirectoryId, version, context)
				.subscribeOn(scheduler)
				.toBlocking().firstOrDefault(null);
	}
	 ...
	 */
	@Override
	public Observable<Void> publishProductsAsync(final String productDirectoryId, final String version, final ProductPublishContext context)
	{
		return getAdaptee().publishProductsAsync(productDirectoryId, version, context);
	}
	...
	{		
		...
		{
			throw new MerchandisingConfigurationException(
					"Unable to retrieve client for MerchCatalogService (MerchCatalogServiceProductDirectoryClient). Please create a client if you wish to use Merchandising functionality.",
					e);
		}
	}
