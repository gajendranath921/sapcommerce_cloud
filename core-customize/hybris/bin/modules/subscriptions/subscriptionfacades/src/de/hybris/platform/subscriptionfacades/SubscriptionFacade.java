...
public interface SubscriptionFacade
{
	 ...
	 * @throws SubscriptionFacadeException if created payment method cannot be updated
	 */
	@Nonnull
	 ...
	 * @throws SubscriptionFacadeException if operation cannot be performed
	 */
	@Nonnull
	 ...
	 *
	 * @return {@link SubscriptionPaymentData} containing the results of the operation
	 * @throws SubscriptionFacadeException if subscription cannot be created
	 */
	 ...
	 * @throws SubscriptionFacadeException if payment method cannot be changed
	 */
	@Nonnull
	 ...
	 *
	 * @return {@link SubscriptionPaymentData} containing the results of the operation
	 * @throws SubscriptionFacadeException if payment method cannot be replaced
	 */
	@Nonnull
	...
	/**
	 *
	 * Replaces the payment method for the given subscription and effectiveFrom.
	 *
	 * @param subscriptionId
	 ...
	 * 			 ptoduct data with information about subscription terms
	 * @param startDate
	 ...
	 *
	 * @param productCode
	 * 				code of the subscription product
	 ...
	 *
	 * @param orderCode
	 * 				code of the given order
	 * @param entryNumber
	 * 				entry number in the order
