 ...
 * <code>
 * java -jar bootstrap/bin/ybootstrap.jar "new de.hybris.platform.groovynature.GroovynatureStandalone().run();"
 * </code> From eclipse, just run as Java Application. Note that you maybe need to add all other projects like
 * ext-commerce, ext-pim to the Launch configuration classpath.
 */
public class GroovynatureStandalone
{
	/**
	...
	{
		new GroovynatureStandalone().run();
	}
