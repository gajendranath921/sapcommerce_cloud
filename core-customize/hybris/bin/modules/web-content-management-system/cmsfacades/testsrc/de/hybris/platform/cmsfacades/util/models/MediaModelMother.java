...
public class MediaModelMother extends AbstractModelMother<MediaModel>
{
	...
	public enum MediaTemplate
	{
		...
		VIDEO("code-media-video", "filename-media-video", "mimetype-media-video", "alt-text-media-video", "description-media-video","url-media-video");
	...
	public MediaModel createThumbnailModel(final CatalogVersionModel catalogVersion)
	{
		return createMediaModel(catalogVersion, MediaTemplate.VIDEO);
	}
	public MediaModel createThumbnailModelWithCode(final CatalogVersionModel catalogVersion, final String code)
	{
		return createMediaModelWithCode(catalogVersion, MediaTemplate.VIDEO, code);
	}
