...
public class CreateMediaValidatorTest
{
	...
	private static final String MEDIA_CATALOG_ID = "apparel-deContentCatalog";
    private static final String MEDIA_CATALOG_VERSION = "Staged";
	...
	public void setUp()
	{
		...
		mediaData.setCatalogId(MEDIA_CATALOG_ID);
        mediaData.setCatalogVersion(MEDIA_CATALOG_VERSION);
		...
		when(mediaDataExistsPredicate.test(mediaData)).thenReturn(Boolean.FALSE);
	}
	...
	{
		when(mediaDataExistsPredicate.test(mediaData)).thenReturn(Boolean.TRUE);
