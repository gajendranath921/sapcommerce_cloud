...
public class GenericComponentTypeStructureServiceTest
{
	...
	private final List<Populator<ComposedTypeModel, ComponentTypeData>> subTypeStructure1PopulatorList = new ArrayList<>();
	private final Set<ComponentTypeAttributeStructure> subTypeStructure1AttributeList = new HashSet<>();
	...
	public void setup() throws Exception
	{
		...
		when(componentTypeStructureRegistry.getComponentTypeStructure(INVALID_TYPE_CODE_REGISTRY))
				.thenReturn(typeStructureRegistryInvalid);
