...
public class DefaultCMSWorkflowAttachmentServiceTest
{
	...
	{
		when(cmsWorkflowService.findAllWorkflowsByAttachedItems(any(), any())).thenReturn(Collections.singletonList(workflow));
		when(cmsWorkflowParticipantService.isActiveWorkflowActionParticipantForAttachmentItems(Collections.singletonList(cmsItem))).thenReturn(TRUE);
	...
	{
		when(cmsWorkflowService.findAllWorkflowsByAttachedItems(any(), any())).thenReturn(Collections.singletonList(workflow));
		when(cmsWorkflowParticipantService.isActiveWorkflowActionParticipantForAttachmentItems(Collections.singletonList(cmsItem))).thenReturn(FALSE);
