...
public class ContentPageModelMother extends AbstractModelMother<ContentPageModel>
{
	...
	public String createHomPageAndReturnUUID(final CatalogVersionModel catalogVersion) {
		ContentPageModel page = this.homePage(catalogVersion);
		Optional<ItemData> optional = getUniqueItemIdentifierService().getItemData(page);
	...
	public UniqueItemIdentifierService getUniqueItemIdentifierService()
	{
