...
public class DefaultItemSynchronizationServiceIntegrationTest extends BaseIntegrationTest
{
	...
	public void shouldCollectPageRelationsFromOnlineCatalogVersionButOnlyThoseThatWereRemovedFromSourceCatalogVersion()
	{
		...
		// only non existent relations in source catalog version will be retrieved from online catalog version
		modelService.remove(stagedContentSlotForPageModel);
		...
		assertThat("Collector should collect all relations that exist in target catalog version but does not exist in source catalog version", contentSlotForPageModelKeys,
