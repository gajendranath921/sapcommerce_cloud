...
import de.hybris.platform.cmsfacades.media.validator.predicate.MediaDataExistsPredicate;
...
public class CreateMediaValidator implements Validator
{
	...
	private Predicate<MediaData> mediaDataExistsPredicate;
	...
	public void validate(final Object obj, final Errors errors)
	{
		...
		else if (!Objects.isNull(target.getCode()) && getMediaDataExistsPredicate().test(target))
		{
	...
	protected Predicate<MediaData> getMediaDataExistsPredicate()
	{
		return mediaDataExistsPredicate;
	}

	@Required
	public void setMediaDataExistsPredicate(final Predicate<MediaData> mediaDataExistsPredicate)
	{
		this.mediaDataExistsPredicate = mediaDataExistsPredicate;
	}
