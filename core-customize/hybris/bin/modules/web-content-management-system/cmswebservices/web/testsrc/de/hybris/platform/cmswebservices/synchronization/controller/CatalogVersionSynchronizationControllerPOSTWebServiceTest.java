...
@IntegrationTest
public class CatalogVersionSynchronizationControllerPOSTWebServiceTest extends ApiBaseIntegrationTest
{
	...
	public void testCreateSynchronization() throws Exception
	{
		...
		final Response response = getCmsManagerWsSecuredRequestBuilder() //
				...
				.post(Entity.entity(new SyncJobData(), MediaType.APPLICATION_JSON));
