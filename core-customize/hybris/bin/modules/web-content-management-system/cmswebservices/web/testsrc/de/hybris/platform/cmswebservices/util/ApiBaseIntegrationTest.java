...
public class ApiBaseIntegrationTest extends ServicelayerTest
{
	...
	/**
	 * To retrieve a new authenticated <code>WsSecuredRequestBuilder</code> for the given username and password.
	 *
	 * @return authenticated <code>WsSecuredRequestBuilder</code>
	 */
	...
	protected String getCatalogVersionUuid(final CatalogVersionModel catalogVersion)
	{
