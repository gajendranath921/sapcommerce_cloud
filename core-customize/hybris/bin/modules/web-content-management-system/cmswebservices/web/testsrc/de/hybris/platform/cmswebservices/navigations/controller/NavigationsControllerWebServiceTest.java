...
public class NavigationsControllerWebServiceTest extends ApiBaseIntegrationTest
{
	...
	private static final String CHILD_UID_1_1 = "child-uid-1-1";
	...
	public void setup()
	{
		...
		final CMSNavigationNodeModel childnode1 = navigationNodeModelMother.createNavigationNode("child-1", CHILD_UID_1, node1, "child-title-en-1",
				catalogVersion);
		...
		navigationNodeModelMother.createNavigationNode("child-3", CHILD_UID_3, node1, "child-title-en-3",
				catalogVersion);
		navigationNodeModelMother.createNavigationNode("child-1-1", CHILD_UID_1_1, childnode1, "child-title-en-1-1",
				catalogVersion);
	...
	public void testGetAllNavigationNodes() throws CMSItemNotFoundException
	{
		...
		assertThat(navigationNodes.size(), is(7));
	}
	...
	public void testGetChildrenlNavigationNodes() throws CMSItemNotFoundException
	{
		...
		assertNode(navigationNodes.get(0), CHILD_UID_1, NODE_UID_1, 0, true);
	...
	public void testDeleteOnelNavigationNode() throws CMSItemNotFoundException
	{
		...
		final Response thirdGetResponse = getCmsManagerWsSecuredRequestBuilder() //
				.path(replaceUriVariablesWithDefaults(ENDPOINT, new HashMap<>()))
				.path(CHILD_UID_1_1)
				.build() //
				.accept(MediaType.APPLICATION_JSON) //
				.get();
		assertResponse(Response.Status.NOT_FOUND, thirdGetResponse);
	}
	...
	public void testUpdatePositionForOnelNavigationNode() throws CMSItemNotFoundException
	{
		...
		assertNode(data, CHILD_UID_1, NODE_UID_1, 3, true);
