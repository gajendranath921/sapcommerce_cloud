...
public class CMSVersionController
{
	...
	@ResponseBody
	@ApiOperation( //
			value = "Gets all versions for an item filtered by a mask.", notes = "Retrieves a list of available CMSVersions "
					+ "by a search mask for the item identified by its itemUUID.", nickname = "getVersionsForItem")
	@ApiImplicitParams(
	{ @ApiImplicitParam(name = "siteId", value = "The site identifier", required = true, dataType = "string", paramType = "path"),
			@ApiImplicitParam(name = "pageSize", value = "Page size for paging", required = false, dataType = "string", paramType = "query"),
	...
	@ResponseBody
	@ApiOperation( //
			value = "Gets a specific version for an item.", notes = "Retrieves a CMSVersion identified "
					+ "by its uid and for the item identified by its itemUUID.", nickname = "getVersion")
	@ApiImplicitParams(
	{ @ApiImplicitParam(name = "siteId", value = "The site identifier", required = true, dataType = "string", paramType = "path"),
			@ApiImplicitParam(name = "itemUUID", value = "The uuid of the item", required = true, dataType = "string", paramType = "path") })
	@ApiResponses(
	...
	@ResponseBody
	@ApiOperation( //
			value = "Creates a CMSVersion for an item.", //
			notes = "Generates a new instance of the CMSVersion for the item identified by its itemUUID.",
			nickname = "createVersion")
	@ApiImplicitParams(
	{ @ApiImplicitParam(name = "siteId", value = "The site identifier", required = true, dataType = "string", paramType = "path"),
			@ApiImplicitParam(name = "itemUUID", value = "The uuid of the item", required = true, dataType = "string", paramType = "path") })
	@ApiResponses(
	...
	@ResponseBody
	@ApiOperation( //
			value = "Updates a CMSVersion for an item.", notes = "Replaces an existing CMSVersion identified by its uid for the item identified\n" +
			"by its itemUUID.", nickname = "replaceVersion")
	@ApiImplicitParams(
	{ @ApiImplicitParam(name = "siteId", value = "The site identifier", required = true, dataType = "string", paramType = "path"),
			@ApiImplicitParam(name = "itemUUID", value = "The uuid of the item", required = true, dataType = "string", paramType = "path") })
	@ApiResponses(
	...
	@ApiOperation( //
			value = "Rolls back an item to a specific CMSVersion.", notes = "Sets a CMSversion of the item identified by its itemUUID to a previously\n" +
			"saved CMSVersion.", nickname = "doRollbackVersion")
	@ApiImplicitParams(
	{ @ApiImplicitParam(name = "siteId", value = "The site identifier", required = true, dataType = "string", paramType = "path"),
			@ApiImplicitParam(name = "itemUUID", value = "The uuid of the item", required = true, dataType = "string", paramType = "path") })
	@ApiResponses(
	...
	@ApiOperation( //
			...
			notes = "Removes a specific instance of the CMSVersion identified by its uid and for the item identified\n" +
					"by its itemUUID.",
			nickname = "removeVersion")
	@ApiImplicitParams(
	{ @ApiImplicitParam(name = "siteId", value = "The site identifier", required = true, dataType = "string", paramType = "path"),
			@ApiImplicitParam(name = "itemUUID", value = "The uuid of the item", required = true, dataType = "string", paramType = "path") })
	@ApiResponses(
