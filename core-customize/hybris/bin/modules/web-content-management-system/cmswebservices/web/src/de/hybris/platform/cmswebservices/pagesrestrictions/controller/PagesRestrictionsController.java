...
public class PagesRestrictionsController
{
	...
	@ResponseBody
	@ApiOperation(value = "Gets restrictions for all pages.", notes = "Finds restrictions for all pages.", nickname = "getRestrictionsForAllPage")
	@ApiImplicitParams(
	{ //
	...
	@ResponseStatus(value = HttpStatus.OK)
	@ResponseBody
	@ApiOperation(value = "Gets restrictions by page.", notes = "Retrieves all restrictions that belong to the page for the given page id.", nickname = "getRestrictionsByPage")
	@ApiImplicitParams(
	{ //
			@ApiImplicitParam(name = "siteId", value = "The site identifier", required = true, dataType = "string", paramType = "path"),
			@ApiImplicitParam(name = "catalogId", value = "The catalog name", required = true, dataType = "string", paramType = "path"),
