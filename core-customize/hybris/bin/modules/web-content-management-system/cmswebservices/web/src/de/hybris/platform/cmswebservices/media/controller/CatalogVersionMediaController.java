...
public class CatalogVersionMediaController
{
	...
	@ApiImplicitParams(
			{ //
					...
					@ApiImplicitParam(name = "folder", value = "The folder that media will be update to", required = false, dataType = "string", paramType = "query") })
	public MediaData uploadMultipartMedia(
			...
			@ApiParam(value = "The folder that media will be update to", required = true) //
