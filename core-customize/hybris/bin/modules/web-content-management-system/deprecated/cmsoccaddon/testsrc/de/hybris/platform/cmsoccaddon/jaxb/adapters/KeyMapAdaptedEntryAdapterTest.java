...
public class KeyMapAdaptedEntryAdapterTest
{
	...
	public void shouldMarshalMapValue()
	{
		...
		testkeyMapAdaptedEntry.setKey(TEST_KEY);
		testkeyMapAdaptedEntry.setMapValue(testMap);

		final Element result = keyMapAdaptedEntryAdapter.marshal(testkeyMapAdaptedEntry);
		assertThat(result.getTextContent(), equalTo(TEST_STRING));
	}
