...
public class DefaultCMSRestrictionServiceTest
{
	...
	public void restrictionRelatedSharedSlots()
	{
		...
		when(abstractRestrictionModel.getComponents()).thenReturn(components);
		when(cmsComponentService.inSharedSlots(component)).thenReturn(true);

		assertTrue(cmsRestrictionService.relatedSharedSlots(abstractRestrictionModel));
	}
	...
	public void restrictionRelatedNonSharedSlots()
	{
		...
		components.add(component);
		when(abstractRestrictionModel.getComponents()).thenReturn(components);
		when(cmsComponentService.inSharedSlots(component)).thenReturn(false);

		assertFalse(cmsRestrictionService.relatedSharedSlots(abstractRestrictionModel));
	}

	@Test
	public void restrictionRelatedNoComponents()
	{
		when(abstractRestrictionModel.getComponents()).thenReturn(new ArrayList<>());
