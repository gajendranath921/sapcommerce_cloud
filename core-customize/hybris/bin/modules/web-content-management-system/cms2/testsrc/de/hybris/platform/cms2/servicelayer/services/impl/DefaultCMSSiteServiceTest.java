...
public class DefaultCMSSiteServiceTest
{
	...
	@Test
	public void testShouldReturnNullWhenSiteDontHaveContentCatalog()
	{
		when(cmsSiteService.getCurrentSite()).thenReturn(cmsSiteMock);
		when(cmsSiteMock.getDefaultContentCatalog()).thenReturn(null);

		CatalogVersionModel versionModel = cmsSiteService.getCurrentSiteDefaultContentCatalogActiveVersion();

		assertThat(versionModel).isNull();
	}

	@Test
	public void testShouldReturnNullWhenSiteContentCatalogDontHaveActiveVersion()
	{
		when(cmsSiteService.getCurrentSite()).thenReturn(cmsSiteMock);
		when(cmsSiteMock.getDefaultContentCatalog()).thenReturn(contentCatalogMock5);
		when(contentCatalogMock5.getActiveCatalogVersion()).thenReturn(null);
