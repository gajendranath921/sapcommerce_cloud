...
public class ApprovePageAutomatedWorkflowActionTest
{
	...
	public void setUp()
	{
		...
		when(relatedItemsOnPageService.getRelatedItems(contentPage)).thenReturn(Collections.emptySet());
		when(relatedItemsOnPageService.getRelatedItems(abstractPage)).thenReturn(Collections.emptySet());
	}
