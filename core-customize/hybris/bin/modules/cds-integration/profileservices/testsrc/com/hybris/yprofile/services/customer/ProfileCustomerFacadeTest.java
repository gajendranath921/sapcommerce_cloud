...
public class ProfileCustomerFacadeTest {
    ...
    @Test
    public void testLoginSuccessWhenConsentModelConsentReferenceIsNotNull() {
        //given
        Cookie[] cookies = new Cookie[0];
        when(this.httpServletRequest.getCookies()).thenReturn(cookies);
        when(this.consentService.getConsentReferenceFromSession()).thenReturn(null);
        when(this.consentService.getConsentReferenceFromConsentModel()).thenReturn(CONSENT_REFERENCE_ID);
