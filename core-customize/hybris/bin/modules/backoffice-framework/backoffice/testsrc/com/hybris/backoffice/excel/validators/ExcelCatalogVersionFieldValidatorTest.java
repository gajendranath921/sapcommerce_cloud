...
public class ExcelCatalogVersionFieldValidatorTest
{
	...
	public void setup()
	{
		...
		Mockito.lenient().when(firstCatalog.getCatalogVersions()).thenReturn(Sets.newHashSet(firstAVersion, firstBVersion));
		Mockito.lenient().when(secondCatalog.getCatalogVersions()).thenReturn(Sets.newHashSet(secondAVersion));
	}
