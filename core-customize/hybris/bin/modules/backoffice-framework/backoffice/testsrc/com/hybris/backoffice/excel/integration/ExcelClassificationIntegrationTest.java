...
public class ExcelClassificationIntegrationTest extends ExcelIntegrationTest
{
	...
	public void setUp() throws Exception
	{
		...
		defaultSessionTimeZone = i18NService.getCurrentTimeZone();
	}
	...
	public void tearDown()
	{
		...
		i18NService.setCurrentTimeZone(defaultSessionTimeZone);
	}
	...
	public void testExportIncludingClassification() throws IOException
	{
		...
		i18NService.setCurrentTimeZone(TimeZone.getTimeZone("UTC"));
