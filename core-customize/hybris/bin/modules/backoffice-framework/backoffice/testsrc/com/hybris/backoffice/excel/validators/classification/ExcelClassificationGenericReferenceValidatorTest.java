...
public class ExcelClassificationGenericReferenceValidatorTest
{
	...
	public void shouldHandleWhenTypeIsNotOnBlacklist()
	{
		...
		Mockito.lenient().when(typeService.isAssignableFrom(MediaModel._TYPECODE,MediaModel._TYPECODE)).thenReturn(true);
	...
	public void shouldNotHandleBlankCellValues()
	{
		...
		Mockito.lenient().when(classAttributeAssignmentModel.getAttributeType()).thenReturn(REFERENCE);
