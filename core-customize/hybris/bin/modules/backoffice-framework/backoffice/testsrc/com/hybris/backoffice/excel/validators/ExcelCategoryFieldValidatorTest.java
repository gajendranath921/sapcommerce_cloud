...
public class ExcelCategoryFieldValidatorTest
{
	...
	public void setup()
	{
		...
		Mockito.lenient().when(categoryService.getCategoryForCode(firstCatalogVersion, SECOND_CATEGORY)).thenReturn(secondCategory);
	}
	...
	public void shouldNotHandleCategoryWhenCellIsEmpty()
	{
		...
		Mockito.lenient().when(relationMetaTypeModel.getCode()).thenReturn(ProductModel._CATEGORYPRODUCTRELATION);
