...
public class ExcelBooleanClassificationFieldValidatorTest
{
	...
	{
		// given
		final ImportParameters importParameters = new ImportParameters(null, null, "RANGE[TRUE;FALSE]", null,
				Lists.newArrayList(new HashMap<>()));
	...
	{
		// given
		final ImportParameters importParameters = new ImportParameters(null, null, "TRUE,FALSE", null,
				Lists.newArrayList(new HashMap<>()));
	...
	{
		// given
		final ImportParameters importParameters = new ImportParameters(null, null, "TRUE", null,
				Lists.newArrayList(new HashMap<>()));
