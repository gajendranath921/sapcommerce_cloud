...
public class DefaultClassificationAttributeHeaderValueCreatorTest
{
	...
	public void shouldCreateClassificationAttributeHeaderValue()
	{
		...
		assertThat(result).isEqualTo(
				"@column[class='classificationClass',system='ClassificationSystem',version='ClassificationVersion',translator=de.hybris.platform.catalog.jalo.classification.impex.ClassificationAttributeTranslator]");
	}
	...
	public void shouldCreateClassificationAttributeHeaderValueWithReferences()
	{
		...
		// then
		assertThat(result).isEqualTo(
				"@column(catalog(id,version))[class='classificationClass',system='ClassificationSystem',version='ClassificationVersion',translator=de.hybris.platform.catalog.jalo.classification.impex.ClassificationAttributeTranslator]");
	}
	...
	private ClassAttributeAssignmentModel prepareAssignment()
	{
		...
		given(classificationClassModel.getCode()).willReturn("classificationClass");
