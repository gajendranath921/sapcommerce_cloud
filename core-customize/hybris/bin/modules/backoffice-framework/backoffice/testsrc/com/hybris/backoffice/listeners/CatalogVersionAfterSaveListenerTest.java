...
public class CatalogVersionAfterSaveListenerTest
{
	...
	private Collection<AfterSaveEvent> getEventsWithCreateCatalogVersionEvents()
	{
		...
		Mockito.lenient().when(modelService.get(pk)).thenReturn(mock(CatalogVersionModel.class));
	...
	{
		final AfterSaveEvent removeEventMock = mock(AfterSaveEvent.class);
		Mockito.lenient().when(removeEventMock.getType()).thenReturn(AfterSaveEvent.REMOVE);
		...
		Mockito.lenient().when(modelService.get(createPk)).thenReturn(mock(CatalogVersionModel.class));
		Mockito.lenient().when(modelService.get(removePk)).thenReturn(mock(CatalogVersionModel.class));
