...
import static com.hybris.backoffice.excel.validators.ExcelEurope1PricesValidator.VALIDATION_INCORRECT_PRICE_CURRENCY;
...
public class ExcelEurope1PricesValidatorTest
{
	...
	public void shouldNotHandleWhenCellIsEmpty()
	{
		...
		Mockito.lenient().when(elementTypeModel.getCode()).thenReturn(PriceRowModel._TYPECODE);
	...
	public void testPricesIncorrectFormat(final String priceCurrencyValue)
	{
		...
		assertThat(validationCellResult.getValidationErrors().get(0).getMessageKey())
				.isEqualTo(VALIDATION_INCORRECT_PRICE_CURRENCY);
	}
