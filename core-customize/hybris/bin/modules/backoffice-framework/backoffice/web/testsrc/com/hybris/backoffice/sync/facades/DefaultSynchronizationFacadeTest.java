...
public class DefaultSynchronizationFacadeTest
{
	...
	public void testCopyCronJobData()
	{
		...
		cronJobForRerun.setNodeID(1);
		cronJobForRerun.setNodeGroup("differentNodeGroupThanHost");
		...
		assertThat(newCronJobModel.getNodeID()).isEqualTo(cronJobForRerun.getNodeID());
		assertThat(newCronJobModel.getNodeGroup()).isEqualTo(cronJobForRerun.getNodeGroup());
	}
