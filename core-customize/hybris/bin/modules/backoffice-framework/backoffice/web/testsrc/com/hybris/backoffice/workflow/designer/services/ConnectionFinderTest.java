...
public class ConnectionFinderTest
{
	...
	public void setUp() throws Exception
	{
		...
		Mockito.lenient().when(context.getWim()).thenReturn(wim);
	}
	...
	public void shouldFindActionToDecisionEdges()
	{
		...
		Mockito.lenient().when(nodeTypeService.isDecision(decisionToAction.getFromNode())).thenReturn(true);
		Mockito.lenient().when(nodeTypeService.isAction(decisionToAction.getToNode())).thenReturn(true);
	...
	public void shouldFindDecisionToActionEdges()
	{
		// given
		final Edge actionToDecision = mockEdgeWithNodes();
		Mockito.lenient().when(nodeTypeService.isAction(actionToDecision.getFromNode())).thenReturn(true);
		Mockito.lenient().when(nodeTypeService.isDecision(actionToDecision.getToNode())).thenReturn(true);
	...
	public void shouldFindActionToDecisionEdge()
	{
		...
		Mockito.lenient().when(nodeTypeService.isSameAction(action1, action1ToDecision2.getFromNode())).thenReturn(true);
	...
	public void shouldFindDecisionToActionEdge()
	{
		...
		Mockito.lenient().when(nodeTypeService.isSameDecision(decision1, decision1ToAction2.getFromNode())).thenReturn(true);
