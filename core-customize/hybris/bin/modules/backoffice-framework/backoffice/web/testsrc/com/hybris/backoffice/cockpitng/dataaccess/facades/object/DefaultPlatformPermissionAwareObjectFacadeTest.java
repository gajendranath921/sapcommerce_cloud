...
public class DefaultPlatformPermissionAwareObjectFacadeTest
{
	...
	public void shouldIgnorePropertiesWithDefaultValue()
	{
		...
		Mockito.lenient().when(dirtyAttributeWithDefaultValue.getQualifier()).thenReturn(dirtyAttributeWithDefaultValueQualifier);
		...
		Mockito.lenient().when(dirtyAttributeWithoutDefaultValue.getQualifier()).thenReturn(dirtyAttributeWithoutDefaultValueQualifier);
