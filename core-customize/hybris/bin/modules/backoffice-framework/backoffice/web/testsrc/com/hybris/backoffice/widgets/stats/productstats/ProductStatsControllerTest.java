...
import org.zkoss.chart.plotOptions.BarDataLabels;
...
public class ProductStatsControllerTest extends AbstractWidgetUnitTest<ProductStatsController>
{
	...
	@Mock
	private BarDataLabels dataLabels;
	...
	public void shouldInitializeChartConfiguration()
	{
		...
		// then
		verify(controller.getCharts()).setTitle(nullable(String.class));
		verify(controller.getCharts().getTooltip()).setEnabled(anyBoolean());
		verify(controller.getCharts().getTooltip()).setPointFormat(nullable(String.class));
	...
	public void shouldInitializeChartOptions()
	{
		...
		// then
		verify(controller.getCharts().getChart()).setType(nullable(String.class));
	...
	public void shouldInitializePiePlotOptions()
	{
		...
		verify(piePlotOptions).setCursor(nullable(String.class));
		verify(piePlotOptions).setInnerSize(nullable(String.class));
	...
	public void shouldInitializeColumnPlotOptions()
	{
		...
		verify(columnPlotOptions).setCursor(nullable(String.class));
	...
	public void initializeDataLabels()
	{
		...
		verify(dataLabels).setFormat(nullable(String.class));
	}
