...
public class ObjectCacheKeyGeneratorImplTest
{
	...
	@Test
	public void testComputeKey4ItemModelWithId()
	{
	...
	@Test
	public void testComputeKey4ItemModelWithNoId()
	{
		final ProductModel mdl = new ProductModel();
		final Object expectedObj = Lists.newArrayList(mdl, labelStringObjectHandler.getCurrentLocale(),
				RequestOperationContextHolder.instance().getContext());
		when(objectFacade.getObjectId(any())).thenReturn("");
		final Object obj = objectCacheKeyGeneratorImpl.computeKey(mdl);
