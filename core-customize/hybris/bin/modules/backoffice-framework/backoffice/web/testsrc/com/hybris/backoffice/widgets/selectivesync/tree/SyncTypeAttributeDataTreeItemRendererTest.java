...
public class SyncTypeAttributeDataTreeItemRendererTest
{
	...
	public void before()
	{
		...
		Mockito.lenient().when(labelService.getObjectLabel(any())).thenAnswer(answer -> {
	...
	public void shouldRenderNoReadAccessTypeNodeInTree() throws Exception
	{
		...
		Mockito.lenient().when(mockedTypeNode.isType()).thenReturn(true);
		Mockito.lenient().when(mockedTypeNode.getCheckbox()).thenReturn(mockedCheckbox);
		Mockito.lenient().when(mockedTypeNode.getText()).thenReturn(LABEL);
	...
	public void shouldRenderNoReadAccessAttributeNodeInTree() throws Exception
	{
		...
		Mockito.lenient().when(mockedAttributeData.getIncludedInSync()).thenReturn(true);

		Mockito.lenient().when(mockedAttributeNode.isAttribute()).thenReturn(true);
		Mockito.lenient().when(mockedAttributeNode.getCheckbox()).thenReturn(checkbox);
		Mockito.lenient().when(mockedAttributeNode.getText()).thenReturn(LABEL);
		given(mockedAttributeNode.getData()).willReturn(mockedAttributeData);
