	...
	public void testOnPerformSocketWithContextIsSent()
	{
		...
		verify(getActionInstance()).sendOutput(eq(BulkEditAction.SOCKET_OUT_BULK_EDIT_CTX), argThat(new ArgumentMatcher<Map>()
		{
			...
			public boolean matches(Map map) {
				return "superType".equals(map.get(BulkEditAction.CTX_TYPE_CODE))
						&& CollectionUtils.isEqualCollection(selectedItems, (Collection<?>) map.get(BulkEditAction.CTX_ITEMS_TO_EDIT));
			}
		}));
