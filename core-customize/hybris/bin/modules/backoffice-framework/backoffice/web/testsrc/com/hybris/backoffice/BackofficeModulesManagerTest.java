...
public class BackofficeModulesManagerTest
{
	...
	@Test
	public void shouldGetRightRootDir()
	{
		final String dir = CONSTANT_TEMP_DIR + File.separator + "4test";
		final File actual = manager.getRootDir(dir, manager.getDirProcessors());
		final File expect = new File(FileUtils.getTempDirectoryPath() + File.separator + "4test");

		Assertions.assertThat(actual.getAbsolutePath()).isEqualTo(expect.getAbsolutePath());
	}
