		...
		extends AbstractCockpitngUnitTest<DefaultBackofficeListViewConfigFallbackStrategy>
{
	...
	{
		// given
		Mockito.lenient().when(typeService.getTypeForCode(null)).thenThrow(IllegalArgumentException.class);
	...
	public void shouldAddColumnsForComposedTypeModel() throws TypeNotFoundException
	{
		...
		Mockito.lenient().when(viewAttributeDescriptorModel.getQualifier()).thenReturn(QUALIFIER);
