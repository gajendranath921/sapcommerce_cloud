...
public class DefaultWorkflowTemplateActivationServiceTest
{
	...
	public void testActivateWorkflowTemplates() throws EvalError
	{
		...
		verify(scriptEvaluationService).evaluateActivationScripts(nullable(ItemModel.class), same(currentValues), isNull(Map.class),
				nullable(String.class));
	...
	public void testPrepareWorkflowTemplateActivationContexts()
	{
		doReturn(new WorkflowTemplateActivationCtx(null, null, null, null)).when(service).prepareWorkflowTemplateActivationCtx(
				nullable(ItemModel.class), nullable(WorkflowTemplateActivationAction.class), nullable(Context.class));
		...
		verify(service, times(2)).prepareWorkflowTemplateActivationCtx(nullable(ItemModel.class),
				same(WorkflowTemplateActivationAction.CREATE), nullable(Context.class));
		verify(service, times(1)).prepareWorkflowTemplateActivationCtx(nullable(ItemModel.class),
				same(WorkflowTemplateActivationAction.SAVE), nullable(Context.class));
	}
