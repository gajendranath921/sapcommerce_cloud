...
public class DefaultPlatformTypeFacadeStrategyTest
{
	...
	@Test
	public void shouldNotWritableOnCreateWhenInitialIsFalse() throws Exception{
		AttributeDescriptorModel attributeDescriptorModel = new AttributeDescriptorModel();
		attributeDescriptorModel.setInitial(false);

		boolean isisWritableOnCreation= testSubject.isWritableOnCreation(attributeDescriptorModel);
		assertThat(isisWritableOnCreation).isFalse();
	}

	@Test
	public void shouldWritableOnCreateWhenInitialIsTrue() throws Exception{
		AttributeDescriptorModel attributeDescriptorModel = new AttributeDescriptorModel();
		attributeDescriptorModel.setInitial(true);

		boolean isisWritableOnCreation= testSubject.isWritableOnCreation(attributeDescriptorModel);
		assertThat(isisWritableOnCreation).isTrue();
	}
}
