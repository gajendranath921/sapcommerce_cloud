...
public class RangeLabelProviderTest
{
	...
	public void shouldProvideResultLabelWithEmptyStringValueWhenStartRangeIsNull()
	{
		...
		Mockito.lenient().when(labelService.getObjectLabel(range.getStart())).thenReturn(null);
		Mockito.lenient().when(labelService.getObjectLabel(range.getEnd())).thenReturn(RANGE_TO_VALUE);
	...
	public void shouldProvideResultLabelWithEmptyStringValueWhenEndRangeIsNull()
	{
		...
		Mockito.lenient().when(labelService.getObjectLabel(range.getStart())).thenReturn(RANGE_FROM_VALUE);
		Mockito.lenient().when(labelService.getObjectLabel(range.getEnd())).thenReturn(null);
