...
public class BackofficeSyncIntegrationTest extends ServicelayerBaseTest
{
	...
	public void testBeforeAndAfterSyncEventsTriggered()
	{
		...
		final ArgumentMatcher<DefaultCockpitEvent> startedMatcher = new ArgumentMatcher<DefaultCockpitEvent>()
		{
			...
			@Override
			public boolean matches(DefaultCockpitEvent defaultCockpitEvent) {
				return ProcessStartEvent.EVENT_NAME.equals(defaultCockpitEvent.getName()) && defaultCockpitEvent.getData() instanceof ProcessStartEvent
						&& ((ProcessStartEvent) defaultCockpitEvent.getData()).getProcessEvent() != null;
			}
		};
		final ArgumentMatcher<DefaultCockpitEvent> finishedMatcher = new ArgumentMatcher<DefaultCockpitEvent>()
		{
			...
			@Override
			public boolean matches(DefaultCockpitEvent defaultCockpitEvent) {
				return ProcessFinishedEvent.EVENT_NAME.equals(defaultCockpitEvent.getName()) && defaultCockpitEvent.getData() instanceof ProcessFinishedEvent
						&& ((ProcessFinishedEvent) defaultCockpitEvent.getData()).getProcessEvent() != null;
			}
		};
