 ...
 */
public class DynamicDataFeedClient extends DataFeedClient
{
	private static final Logger LOGGER = LoggerFactory.getLogger(DynamicDataFeedClient.class);
	...
	public DynamicDataFeedClient(final ClientConfiguration cfg)
	{
		super(cfg, null);
	}
