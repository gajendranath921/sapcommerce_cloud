 ...
 */
public class DynamicRawItemClassClient extends RawItemClassClient
{
	private static final Logger LOGGER = LoggerFactory.getLogger(DynamicRawItemClassClient.class);
	...
	public DynamicRawItemClassClient(final ClientConfiguration cfg)
	{
		super(cfg, null);
	}
