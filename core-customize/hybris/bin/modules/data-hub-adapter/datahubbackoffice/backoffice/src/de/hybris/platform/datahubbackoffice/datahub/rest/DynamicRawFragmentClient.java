...
import com.hybris.datahub.client.RawFragmentClient;
 ...
 */
public class DynamicRawFragmentClient extends RawFragmentClient
{
	private static final Logger LOGGER = LoggerFactory.getLogger(DynamicRawFragmentClient.class);
	...
	public DynamicRawFragmentClient(final ClientConfiguration cfg)
	{
		super(cfg, null);
	}
