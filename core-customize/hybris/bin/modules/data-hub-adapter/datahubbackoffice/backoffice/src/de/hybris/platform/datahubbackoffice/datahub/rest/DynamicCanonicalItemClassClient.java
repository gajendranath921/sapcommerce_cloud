 ...
 */
public class DynamicCanonicalItemClassClient extends CanonicalItemClassClient
{
	private static final Logger LOGGER = LoggerFactory.getLogger(DynamicCanonicalItemClassClient.class);
	...
	public DynamicCanonicalItemClassClient(final ClientConfiguration cfg)
	{
		super(cfg, null);
	}
