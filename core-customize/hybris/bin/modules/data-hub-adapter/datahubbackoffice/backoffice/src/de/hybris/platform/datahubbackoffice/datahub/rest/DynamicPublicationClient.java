 ...
 */
public class DynamicPublicationClient extends PublicationClient implements DynamicRestClient
{
	private static final Logger LOGGER = LoggerFactory.getLogger(DynamicPublicationClient.class);
	...
	public DynamicPublicationClient(final ClientConfiguration cfg)
	{
		super(cfg, null);
	}
