 ...
 */
public class DynamicDataHubStatusClient extends DataHubStatusClient
{
	private static final Logger LOGGER = LoggerFactory.getLogger(DynamicDataHubStatusClient.class);
	...
	public DynamicDataHubStatusClient(final ClientConfiguration cfg)
	{
		super(cfg, null);
	}
