...
import com.hybris.datahub.client.CsvImportClient;
 ...
 */
public class DynamicCsvImportClient extends CsvImportClient implements DynamicRestClient
{
	private static final Logger LOGGER = LoggerFactory.getLogger(DynamicCsvImportClient.class);
	...
	public DynamicCsvImportClient(final ClientConfiguration cfg)
	{
		super(cfg, null);
	}
	...
	{
		return getContextServer().getLocation();
	}

	private DataHubServer getContextServer()
	{
