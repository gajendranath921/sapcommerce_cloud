 ...
 */
public class DynamicTargetSystemClient extends TargetSystemClient
{
	private static final Logger LOGGER = LoggerFactory.getLogger(DynamicTargetSystemClient.class);
	...
	public DynamicTargetSystemClient(final ClientConfiguration cfg)
	{
		super(cfg, null);
	}
