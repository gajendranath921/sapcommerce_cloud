...
@UnitTest
class DefaultCsrfOutboundRequestDecoratorUnitTest extends JUnitPlatformSpecification {
    ...
    @Test
    def "decorator is applicable"() {
        expect:
        decorator.isApplicable(Stub(DecoratorContext));
    }
