...
class DefaultDecoratorContextFactoryUnitTest extends JUnitPlatformSpecification {
    ...
    @Test
    def "IllegalArgumentException is thrown when a null #cond is provided"() {
        when:
    ...
    @Test
    def "creates context with errors when neither integrationObjectModel nor integrationObjectCode were provided"() {
        given:
