...
class ODataReadEntityIntegrationTest extends ServicelayerSpockSpecification {
    private static final String TEST_NAME = 'ODataReadEntity'
    private static final String IO = "${TEST_NAME}_GetIntegrationTestGroup1_IO"

    private static final String PRODUCT_CODE_ENCODED = "${TEST_NAME}_testProduct001%7Cwith%7Cpipes"
    private static final String PRODUCT_CODE = "${TEST_NAME}_testProduct001|with|pipes"
    ...
    def "get entities navigation property when property is not defined"() {
        ...
        ODataAssertions.assertThat(oDataResponse)
                .hasStatus(HttpStatusCodes.NOT_FOUND)
                .jsonBody()
                .hasPathWithValue(ERROR_CODE, "missing_attribute")
