...
public class ODataFacadeTestUtils
{
	...
	public static ODataRequest oDataPostRequest(final String serviceName, final String entityType, final String content,
	                                            final String contentType)
	{
		return oDataPostRequest(serviceName, entityType, content, Locale.ENGLISH, contentType);
	}

	static ODataRequest oDataPostRequest(final String serviceName, final String entityType, final String content,
	                                     final Locale locale, final String contentType)
	{
		return oDataPostRequest(serviceName, entityType, content, locale, locale, contentType);
	}

	static ODataRequest oDataPostRequest(final String serviceName, final String entityType, final String content,
	                                     final Locale contentLanguage, final Locale acceptLanguage, final String contentType)
	{
	...
	public static ODataRequestBuilder postRequestBuilder(final String serviceName, final String entityType, final String contentType)
	{
	...
	static ODataRequest oDataGetRequest(final String serviceName, final String entityType, final String integrationKey,
	                                    final Locale locale)
	{
		return oDataGetRequest(serviceName, entityType, locale, StringUtils.EMPTY, integrationKey);
	}

	static ODataRequest oDataGetRequest(final String serviceName, final String entityType, final Locale locale,
	                                    final String navigationSegment, final String... integrationKeys)
	{
	...
	static ODataResponse handleRequest(final ODataFacade facade, final ODataRequest oDataRequest)
	{
		...
		return facade.handleRequest(context);
	}
	...
	{
		final ODataContextGenerator generator = Registry.getApplicationContext()
		                                                .getBean("oDataContextGenerator", ODataContextGenerator.class);
