...
@UnitTest
class SimplePropertyVisitingStrategyUnitTest extends JUnitPlatformSpecification {
    ...
    def "filter with '#left' left operand, '#right' right operand, and '#operator' operator produces where clause: #expected"()
    {
        ...
        null        | null              | null    | new SimplePropertyWhereClauseCondition('null', 'null', 'null').toWhereClauseConditions()
        "left"      | BinaryOperator.EQ | "right" | new SimplePropertyWhereClauseCondition('left', '=', 'right').toWhereClauseConditions()
    }
