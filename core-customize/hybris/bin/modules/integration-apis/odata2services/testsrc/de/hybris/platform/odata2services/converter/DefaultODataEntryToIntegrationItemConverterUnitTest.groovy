...
@UnitTest
class DefaultODataEntryToIntegrationItemConverterUnitTest extends JUnitPlatformSpecification {
    ...
    def 'correctly populates ConversionParameters for the attribute value conversion'() {
        ...
        then:
        1 * attributeValueConverter.convertAttributeValue(_) >> { List args ->
            def params = args[0] as ConversionParameters
