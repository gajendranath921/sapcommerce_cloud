...
@UnitTest
class ExpandedEntityReaderUnitTest extends JUnitPlatformSpecification {
    ...
    @Test
    def 'read throws IllegalArgumentException when TypeAttributeDescriptor is not found for navigation segment'() {
        given:
        def navPropertyName = 'product'
        def itemLookupRequest = Stub(ItemLookupRequest) {
            getNavigationSegments() >> [navigationSegment(navPropertyName)]
