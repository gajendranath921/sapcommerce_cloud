...
public class InboundRequestServiceParameter
{
	...
	private InboundRequestServiceParameter(final List<RequestBatchEntity> requests, final List<ResponseChangeSetEntity> responses,
	                                       ...
	                                       final String userId, final String sapPassport)
	{
		this.requests = requests != null ? Collections.unmodifiableList(new ArrayList<>(requests) ) : Collections.emptyList();
		this.responses = responses != null ? Collections.unmodifiableList(new ArrayList<>(responses)): Collections.emptyList();
		this.medias = medias != null ? Collections.unmodifiableList(new ArrayList<>(medias)): Collections.emptyList();
