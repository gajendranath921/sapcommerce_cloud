...
public abstract class AbstractRequest
{
	...
	AbstractRequest(final EdmEntitySet set) throws EdmException
	{
		Preconditions.checkArgument(set != null, "EdmEntitySet cannot be null");
		Preconditions.checkArgument(set.getEntityType() != null, "EdmEntityType cannot be null");
		entitySet = set;
