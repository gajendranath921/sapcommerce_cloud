...
public class DefaultItemLookupStrategy implements ItemLookupStrategy
{
	...
	{
		return lookupRequest.getIntegrationItem() != null;
	}
	...
	private FlexibleSearchQueryBuilder buildWhereForKeyNavProperties(final FlexibleSearchQueryBuilder queryBuilder, final ItemLookupRequest lookupRequest) throws EdmException
	{
