...
{
    private List<PropertyAnnotationGenerator> annotationGenerators = new ArrayList<>();
    ...
    {
        this.annotationGenerators = annotationGenerators != null ?
              List.copyOf(annotationGenerators) :
