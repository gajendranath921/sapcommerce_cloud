...
public final class SchemaUtils
{
	 ...
	 * @deprecated switch to use {@link TypeAttributeDescriptor} instead of the {@link IntegrationObjectItemAttributeModel} selecting
	 * localized attributes is trivial with TypeAttributeDescriptor through the usage of the {@link TypeAttributeDescriptor#isLocalized()}
	 * method.
	 */
	...
	{
		return DefaultDescriptorFactory.getContextFactory()
