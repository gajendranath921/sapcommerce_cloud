...
public final class EditorUtils
{
	...
	public static Treeitem renameTreeitem(final Treeitem treeitem, final AbstractListItemDTO dto)
	{
		if (treeitem != null)
		{
			...
			treeitem.setLabel(alias + " [" + treeNodeData.getMapKeyDTO().getCode() + " : " + treeNodeData.getMapKeyDTO().getType().getCode() + "]");
		}
		return treeitem;
	}
	...
	private static void updateOldDTO(final ListItemAttributeDTO newAttributeDTO, final ListItemAttributeDTO oldDTO)
	{
