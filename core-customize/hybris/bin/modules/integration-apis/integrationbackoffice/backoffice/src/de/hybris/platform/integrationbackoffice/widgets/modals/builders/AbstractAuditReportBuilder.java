...
public abstract class AbstractAuditReportBuilder implements AuditReportBuilder
{
	...
	public void setReportViewConverterStrategies(final List<ReportViewConverterStrategy> converterStrategies)
	{
		reportViewConverterStrategies = CollectionUtils.isNotEmpty(converterStrategies) ?
				new ArrayList<>(converterStrategies) : new ArrayList<>();
	}

	public List<ReportViewConverterStrategy> getReportViewConverterStrategies()
	{
		return CollectionUtils.isNotEmpty(reportViewConverterStrategies) ? List.copyOf(
				reportViewConverterStrategies) : Collections.emptyList();
	}
	...
	public abstract void traversePayload(Map<String, Object> map);
