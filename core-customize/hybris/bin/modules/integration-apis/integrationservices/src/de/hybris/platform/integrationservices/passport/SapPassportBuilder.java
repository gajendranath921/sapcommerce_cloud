...
public class SapPassportBuilder
{
	...
	{
		this.rootContextId = rootContextId != null ? Arrays.copyOf(rootContextId, rootContextId.length) : null;
		return this;
	}

	public SapPassportBuilder withConnectionId(final byte[] connectionId)
	{
		this.connectionId = connectionId != null ? Arrays.copyOf(connectionId, connectionId.length) : null;
		return this;
	}
