...
public class ValidatingItemSearchService implements ItemSearchService
{
	...
	{
		uniqueItemSearchValidators = List.copyOf(validators);
	}
	...
	{
		itemsSearchValidators = List.copyOf(validators);
	}
	...
	{
		countSearchValidators = List.copyOf(validators);
	}
	...
	{
		uniqueItemSearchEnrichers = List.copyOf(enrichers);
	}
	...
	{
		itemsSearchEnrichers = List.copyOf(enrichers);
	}
	...
	{
		countSearchEnrichers = List.copyOf(enrichers);
	}
}
