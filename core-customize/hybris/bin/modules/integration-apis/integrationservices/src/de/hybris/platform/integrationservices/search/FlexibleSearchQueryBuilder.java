...
public class FlexibleSearchQueryBuilder
{
	...
	private static final List<OrderExpression> DEFAULT_ORDER_EXPRESSIONS = Collections.emptyList();
	...
	private List<OrderExpression> orderByExpressions = DEFAULT_ORDER_EXPRESSIONS;
	...
	{
		this.orderByExpressions = orderExpressions != null ? List.copyOf(orderExpressions) : DEFAULT_ORDER_EXPRESSIONS;
		return this;
	}
