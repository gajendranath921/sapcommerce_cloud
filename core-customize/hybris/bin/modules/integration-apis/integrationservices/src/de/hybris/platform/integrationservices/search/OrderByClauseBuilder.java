...
{
	private static final List<OrderExpression> DEFAULT_EXPRESSIONS = Collections.emptyList();

	private List<OrderExpression> orderByExpressions = DEFAULT_EXPRESSIONS;
	...
	{
		this.orderByExpressions = orderByExpressions != null ? List.copyOf(orderByExpressions) : DEFAULT_EXPRESSIONS;
		return this;
	}
