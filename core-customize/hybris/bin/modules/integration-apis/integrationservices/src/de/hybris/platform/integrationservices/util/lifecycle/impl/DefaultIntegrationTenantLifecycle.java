 ...
 */
public class DefaultIntegrationTenantLifecycle extends AbstractEventListener<AbstractEvent>
		implements TenantLifecycle, TenantListener
{
	private static final Log LOGGER = Log.getLogger(DefaultIntegrationTenantLifecycle.class);
	 ...
	 */
	public DefaultIntegrationTenantLifecycle(@NotNull final Tenant tenant)
	{
	...
	public boolean hasTenant(final Tenant tenant)
	{
