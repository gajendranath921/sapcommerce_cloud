...
@UnitTest
class LogicExecutorContextUnitTest extends JUnitPlatformSpecification {

    @Shared
    def logicLocation = LogicLocation.from("model://script")
    @Shared
    ...
    def "two contexts are different when context2 #condition"() {
        ...
        condition               | context2
        'is null'               | null
        'has different content' | LogicExecutorContext.create(LogicLocation.from('model://different'), Stub(TypeAttributeDescriptor))
