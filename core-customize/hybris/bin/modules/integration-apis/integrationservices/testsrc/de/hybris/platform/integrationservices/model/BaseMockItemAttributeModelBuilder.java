...
public abstract class BaseMockItemAttributeModelBuilder<B extends BaseMockItemAttributeModelBuilder>
{
	...
	public IntegrationObjectItemAttributeModel build()
	{
		...
		lenient().when(attributeDefinition.getAttributeDescriptor()).thenReturn(attributeDescriptorModel);
		lenient().when(attributeDefinition.getIntegrationObjectItem()).thenReturn(integrationObjectItem);
		lenient().when(attributeDefinition.getReturnIntegrationObjectItem()).thenReturn(returnObjectModel);
		lenient().when(attributeDefinition.getAttributeName()).thenReturn(attributeName);
		lenient().when(attributeDefinition.getPartOf()).thenReturn(partOf);
		lenient().when(attributeDefinition.getAutoCreate()).thenReturn(autoCreate);
		lenient().when(attributeDefinition.getUnique()).thenReturn(unique);
