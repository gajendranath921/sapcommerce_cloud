...
@UnitTest
class CollectionClassificationAttributeValueHandlerUnitTest extends JUnitPlatformSpecification {
    ...
    def "isApplicable is #applicable when attribute is #condition value"() {
        ...
        'collection and localized' | false      | Stub(ClassificationTypeAttributeDescriptor) {
            isLocalized() >> true
            isCollection() >> true
        }
    }
