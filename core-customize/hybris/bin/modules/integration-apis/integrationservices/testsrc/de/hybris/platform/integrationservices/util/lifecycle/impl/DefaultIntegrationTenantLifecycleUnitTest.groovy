...
@UnitTest
class DefaultIntegrationTenantLifecycleUnitTest extends JUnitPlatformSpecification {

    def tenant = Stub Tenant
    def tenantLifecycle = new DefaultIntegrationTenantLifecycle(tenant)

    @Test
    def 'Instantiation fails if tenant is not provided'() {
        when:
        new DefaultIntegrationTenantLifecycle(null)
