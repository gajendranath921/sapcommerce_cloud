...
class LogUnitTest extends JUnitPlatformSpecification {
    ...
    @Test
    def "#method('message', Throwable) does not print stack trace when DEBUG is not enabled"() {
        given:
    ...
    @Test
    def "#method(Marker, 'message', Throwable) does not print stack trace when DEBUG is not enabled"() {
        given:
        def msg = 'message, Throwable'
    ...
    @Test
    def "#method('message', Throwable) prints stack trace when DEBUG is enabled"() {
        given:
        def msg = 'message, Throwable'

        when:
        logger(LogLevel.DEBUG)."$method" msg, EXCEPTION
    ...
    @Test
    def "#method(Marker, 'message', Throwable) prints stack trace when DEBUG is enabled"() {
        given:
        def msg = 'message, Throwable'

        when:
        logger(LogLevel.DEBUG)."$method" Stub(Marker), msg, EXCEPTION
    ...
    @Test
    def "#method('{}', Throwable) does not print stack trace even when all log levels are enabled"() {
        given:
        def msg = 'Message {}'
    ...
    @Test
    def "#method(Marker, '{}', Throwable) does not print stack trace even when all log levels are enabled"() {
        given:
        def msg = 'Message {}'
    ...
    @Test
    def "#method('{}', Object, Throwable) does not print stack trace when DEBUG is not enabled"() {
        given:
        def msg = 'Message {}'
    ...
    @Test
    def "#method(Marker, '{}', Object, Throwable) does not print stack trace when DEBUG is not enabled"() {
        given:
        def msg = 'Message {}'
    ...
    @Test
    def "#method('{}', Object, Throwable) prints stack trace when DEBUG is enabled"() {
        given:
        def msg = 'Message {}'

        when:
        logger(LogLevel.DEBUG)."$method" msg, OBJECT, EXCEPTION
    ...
    @Test
    def "#method(Marker, '{}', Object, Throwable) prints stack trace when DEBUG is enabled"() {
        given:
        def msg = 'Message {}'

        when:
        logger(LogLevel.DEBUG)."$method" Stub(Marker), msg, OBJECT, EXCEPTION
    ...
    @Test
    def "#method('{}{}', Throwable, Throwable) does not print stack trace even when all log levels are enabled"() {
        given:
    ...
    @Test
    def "#method(Marcker, '{}{}', Throwable, Throwable) does not print stack trace even when all log levels are enabled"() {
        given:
        def ex1 = new Throwable('Throwable 1')
        def ex2 = new Throwable('Throwable 2')
    ...
    @Test
    def "#method('{}{}', #vararr) does not print stack trace even when all log levels are enabled"() {
        when:
    ...
    @Test
    def "#method(Marker, '{}{}', #vararr) does not print stack trace even when all log levels are enabled"() {
        when:
    ...
    @Test
    def "#method('{}{}', #vararr) does not print stack trace when DEBUG is not enabled"() {
        when:
    ...
    @Test
    def "#method(Marker, '{}{}', #vararr) does not print stack trace when DEBUG is not enabled"() {
        when:
    ...
    @Test
    def "#method('{}{}', #vararr) prints stack trace when DEBUG is enabled"() {
        when:
        logger(LogLevel.DEBUG)."$method" '{}, {}, ...', params.toArray()
    ...
    @Test
    def "#method(Marker, '{}{}', #vararr) prints stack trace when DEBUG is enabled"() {
        when:
        logger(LogLevel.DEBUG)."$method" Stub(Marker), '{}, {}, ...', params.toArray()
