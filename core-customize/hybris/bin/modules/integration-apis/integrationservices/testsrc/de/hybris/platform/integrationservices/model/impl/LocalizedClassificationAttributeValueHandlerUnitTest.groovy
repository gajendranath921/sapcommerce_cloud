...
@UnitTest
class LocalizedClassificationAttributeValueHandlerUnitTest extends JUnitPlatformSpecification {
    ...
    def "isApplicable is #applicable when attribute is #condition value"() {
        ...
        'localized and primitive'     | true       | Stub(ClassificationTypeAttributeDescriptor) { isLocalized() >> true
            isPrimitive() >> true }
        ...
        'localized and collection'    | false      | Stub(ClassificationTypeAttributeDescriptor) { isLocalized() >> true
            isCollection() >> true }
        'localized and non-primitive' | false      | Stub(ClassificationTypeAttributeDescriptor) { isLocalized() >> true
            isPrimitive() >> false }
    }
