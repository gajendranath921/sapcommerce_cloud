...
public class DefaultSapPassportServiceUnitTest
{
	...
	public void setUp()
	{
		lenient().when(integrationServicesConfiguration.getSapPassportSystemId()).thenReturn("My SAP Commerce");
		lenient().when(integrationServicesConfiguration.getSapPassportServiceValue()).thenReturn(139);
		lenient().when(integrationServicesConfiguration.getSapPassportUser()).thenReturn("My SAP User");
	}
