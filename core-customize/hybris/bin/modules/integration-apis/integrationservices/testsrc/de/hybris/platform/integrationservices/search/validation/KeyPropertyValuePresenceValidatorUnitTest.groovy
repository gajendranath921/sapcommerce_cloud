...
@UnitTest
class KeyPropertyValuePresenceValidatorUnitTest extends JUnitPlatformSpecification {
    ...
    IntegrationItem integrationItem(Map<TypeAttributeDescriptor, ?> attributes) {
        Stub(IntegrationItem) {
            ...
            getAttribute(_ as TypeAttributeDescriptor) >> { List args ->
                attributes[args[0] as TypeAttributeDescriptor]
            }
            getReferencedItem(_ as TypeAttributeDescriptor) >> { List args ->
                attributes[args[0] as TypeAttributeDescriptor]
            }
        }
    }
