...
class IntegrationObjectServiceIntegrationTest extends ServicelayerSpockSpecification {
    ...
    private static final String TEST_NAME = "IntegrationObjectService"
    private static final String IO_2 = "${TEST_NAME}_OutboundProductIO"
    private static final String IO_1 = "${TEST_NAME}_InboundProductIO"
    ...
    @Test
    @Unroll
    def "exception is thrown when findItemAttributeName when #condition no does not exist"() {
        given:
        createBasicIntegrationObject()
        ...
        where:
        msg                                            | objectCode     | itemCode       | attrName             | condition
        'integrationObjectItem.integrationObject.code' | "NOT_EXISTING" | PRODUCT_ALIAS  | ATTRIBUTE_ALIAS_NAME | 'Integration Object'
        'integrationObjectItem.code'                   | IO_1           | "NOT_EXISTING" | ATTRIBUTE_ALIAS_NAME | 'Item Type'
        'name'                                         | IO_1           | PRODUCT_ALIAS  | "NOT_EXISTING"       | 'Attribute'
    }
