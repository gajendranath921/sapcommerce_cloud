...
@UnitTest
class DefaultTimeoutServiceUnitTest extends JUnitPlatformSpecification {

    private static final long TIMEOUT_MILLISEC = 10
    ...
    def "Execution completes within timeout limit"() {
        ...
        when:
        def value = timeoutService.execute callable, TIMEOUT_MILLISEC
