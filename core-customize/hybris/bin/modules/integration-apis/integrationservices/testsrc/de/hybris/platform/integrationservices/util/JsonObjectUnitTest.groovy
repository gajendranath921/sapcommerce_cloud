...
@UnitTest
class JsonObjectUnitTest extends JUnitPlatformSpecification {
    @Test
    @Unroll
    ...
    @Test
    @Unroll
    def "getCollectionOfObjects() returns #result for #path path in #str"() {
        given:
        JsonObject obj = JsonObject.createFrom str
    ...
    @Test
    @Unroll
    def "getCollection() returns #result for '#path' path in #str"() {
        given:
        JsonObject obj = JsonObject.createFrom str
