...
@UnitTest
class DefaultPersistenceContextUnitTest extends JUnitPlatformSpecification {
    ...
    def "new request instance can be built from another request using a different builder"() {
        ...
        with(copy) {
            ...
            prePersistHook == original.prePersistHook
            postPersistHook == original.postPersistHook
        }
    }
