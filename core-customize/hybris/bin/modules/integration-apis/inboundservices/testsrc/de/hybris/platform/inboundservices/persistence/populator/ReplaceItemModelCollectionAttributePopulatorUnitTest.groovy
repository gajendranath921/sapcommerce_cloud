...
@UnitTest
class ReplaceItemModelCollectionAttributePopulatorUnitTest extends JUnitPlatformSpecification {
    @Shared
    ...
    def attributePopulator = new ReplaceItemModelCollectionAttributePopulator(contextReferencedItemModelService: itemModelService)
