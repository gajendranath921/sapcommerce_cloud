...
public interface PersistenceContext
{
	...
	/**
	 * Returns name of the {@link de.hybris.platform.inboundservices.persistence.hook.PrePersistHook} to be executed before saving
	 * this context data.
	 *
	 * @return name of the hook to execute or {@code null}, if there is no need to execute a hook.
	 */
	@Nullable
	default String getPrePersistHook()
	{
		return null;
	}

	/**
	 * Returns name of the {@link de.hybris.platform.inboundservices.persistence.hook.PostPersistHook} to be executed after saving
	 * this context data.
	 *
	 * @return name of the hook to execute or {@code null}, if there is no need to execute a hook.
	 */
	@Nullable
	default String getPostPersistHook()
	{
		return null;
	}
