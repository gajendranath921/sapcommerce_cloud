...
public class DefaultContextItemModelService implements ContextItemModelService
{
	...
	private List<PersistenceContextValidator> persistenceContextValidators = new ArrayList<>();
	private List<ItemPersistRequestValidator> itemPersistRequestValidators = new ArrayList<>();
	...
	{
		this.persistenceContextValidators = persistenceContextValidators != null ?
				List.copyOf(persistenceContextValidators) :
				Collections.emptyList();
	}

	public void setItemPersistRequestValidators(final List<ItemPersistRequestValidator> itemPersistRequestValidators)
	{
		this.itemPersistRequestValidators = itemPersistRequestValidators != null ?
				List.copyOf(itemPersistRequestValidators) :
				Collections.emptyList();
	}
