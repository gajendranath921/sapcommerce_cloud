...
@IntegrationTest
class ODataFacadePatchLocalizedPersistenceIntegrationTest extends ServicelayerSpockSpecification {

    private static final def TEST_NAME = "ODataFacadePatchLocalizedPersistence"
	private static final def SERVICE_NAME = "${TEST_NAME}_IO"
	private static final def PRODUCTS = 'Products'
	private static final def PRODUCT_CODE = "exampleProduct"
	private static final def CATALOG_ID = "${TEST_NAME}_Default"
	private static final def CATALOG_VERSION_VERSION = "Staged"
	private static final def UNIT = "${TEST_NAME}_pieces"
	...
	private static final def PRODUCT_DESCRIPTION_UPDATED_ES = "y la descripci\u00F3n tambi\u00E1n!"
	private static final def INTEGRATION_KEY = "$CATALOG_VERSION_VERSION|$CATALOG_ID|$PRODUCT_CODE"
	...
	def 'non-existing localized value is created when content language header is sent, no localized attributes are present in the payload and a value is sent'() {
		...
		IntegrationTestUtil.importImpEx(
				...
				"; $PRODUCT_CODE ; $CATALOG_ID:Staged ;  ; ; ; "
		)
