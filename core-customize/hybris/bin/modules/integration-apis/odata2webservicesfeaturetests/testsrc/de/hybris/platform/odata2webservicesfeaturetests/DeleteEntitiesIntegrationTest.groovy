...
class DeleteEntitiesIntegrationTest extends ServicelayerSpockSpecification {
    ...
    private static final String USER = "${TEST_NAME.toLowerCase()}_user"
    private static final String PASSWORD = 'secret'
    private static final String IO_CODE = "${TEST_NAME}_IO"
    private static final String CUSTOMER1 = "${TEST_NAME.toLowerCase()}_john.doe"
    private static final String CUSTOMER2 = "${TEST_NAME.toLowerCase()}_scott.tiger"
