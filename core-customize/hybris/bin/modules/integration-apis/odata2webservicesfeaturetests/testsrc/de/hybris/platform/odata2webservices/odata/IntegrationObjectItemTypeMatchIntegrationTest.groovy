...
class IntegrationObjectItemTypeMatchIntegrationTest extends ServicelayerSpockSpecification {
    ...
    @Test
    @Unroll
    def "get entity with #msg integrationKey #itemKeyToSearch when IntegrationObjectItem.itemTypeMatch is set to #itemItemTypeMatch"() {
        given:
        givenTestItemType2WithItemTypeMatch(itemItemTypeMatch)
    ...
    @Test
    @Unroll
    def "get entity with #msg integrationKey #integrationKey when IntegrationObjectItem.itemTypeMatch is set to #itemItemTypeMatch"() {
        given:
        givenTestItemType2WithItemTypeMatch(itemItemTypeMatch)
