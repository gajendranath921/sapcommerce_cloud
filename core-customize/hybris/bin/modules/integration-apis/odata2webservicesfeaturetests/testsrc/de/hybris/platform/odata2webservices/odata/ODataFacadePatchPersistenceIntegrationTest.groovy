...
@IntegrationTest
class ODataFacadePatchPersistenceIntegrationTest extends ServicelayerSpockSpecification {

    private static final String TEST_NAME = "ODataFacadePatchPersistence"
    private static final String SERVICE_NAME = "${TEST_NAME}_IO"
    private static final String ENTITYSET = 'Customers'
    private static final String UID = "${TEST_NAME.toLowerCase()}_jdoe"
    private static final String ADDRESS1 = "${TEST_NAME}_Address"
    private static final String ADDRESS2 = "${TEST_NAME}_Address2"
    private static final String USER_PROFILE = "${TEST_NAME}_Profile"
    ...
    def 'replaces a nested item attribute'() {
        ...
        IntegrationTestUtil.importImpEx(
                ...
                "                     ; $ADDRESS1   ; $UID@customers.io   ; $UID               ; us")
    ...
    def 'replaces a nested item reference'() {
        ...
        IntegrationTestUtil.importImpEx(
                ...
                "                      ; $UID              ; $ADDRESS1",
                'INSERT_UPDATE Address; &addrId; email[unique = true]; owner(Customer.uid); country(isocode)',
                "                     ; $ADDRESS1  ; $UID@customers.io   ; $UID               ; de")
    ...
    def 'replaces a partOf item collection'() {
        ...
        IntegrationTestUtil.importImpEx(
                ...
                "                      ; $UID              ; $ADDRESS1,$ADDRESS2",
                'INSERT_UPDATE Address; &addrPk; email[unique = true]; owner(Customer.uid)',
                "                     ; $ADDRESS1              ; $UID@customers.de   ; $UID",
                "                     ; $ADDRESS2              ; $UID@customers.sp   ; $UID")
    ...
    def 'updates fields provided in payload when request body is missing key navigation property [Address.country]'() {
        ...
        final String email = "${TEST_NAME}@sap.com"
        IntegrationTestUtil.importImpEx(
                'INSERT_UPDATE Customer; uid[unique = true]; name   ; loginDisabled',
                "                      ; $UID              ; Stephen; false",
    ...
    def 'required non-key properties do not need to be provided for patch'() {
        ...
        cleanup:
        IntegrationTestUtil.remove TestIntegrationItem2Model, {it.code == itemKey}
    }
