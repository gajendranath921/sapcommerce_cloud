...
public class CustomersListCustomerPopulator implements Populator<CustomerModel, CustomerData>
{
	...
	public void populate(final CustomerModel source, final CustomerData target)
	{
		...
		target.setHasOrder(CollectionUtils.isNotEmpty(source.getOrders()) && source.getOrders().stream().anyMatch(
				orderModel -> getBaseSiteService().getCurrentBaseSite().getUid()
						.equals(orderModel.getSite() != null ? orderModel.getSite().getUid() : "")));
