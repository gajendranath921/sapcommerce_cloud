...
public final class SearchservicesConstants extends GeneratedSearchservicesConstants
{
	public static final String EXTENSIONNAME = "searchservices";

	public static final Double MIN_PROGRESS_VALUE = Double.valueOf(0D);
	public static final Double MAX_PROGRESS_VALUE = Double.valueOf(100D);
