...
public class SnIndexConfigurationPopulator implements Populator<SnIndexConfigurationModel, SnIndexConfiguration>
{
	...
	public void populate(final SnIndexConfigurationModel source, final SnIndexConfiguration target)
	{
		...
		target.setName(ModelUtils.extractLocalizedValue(source, SnIndexConfigurationModel.NAME, supportedLocales));
		...
		target.setSynonymDictionaryIds(ConverterUtils.convertAll(source.getSynonymDictionaries(), SnSynonymDictionaryModel::getId));
