...
public class DefaultAddCouponActionStrategyTest
{
	...
	public void setUp()
	{
		Mockito.lenient().when(addCouponRAO.getAppliedToObject()).thenReturn(cartRao);
		Mockito.lenient().when(promotionActionService.createPromotionResult(addCouponRAO)).thenReturn(promotionResult);
		Mockito.lenient().when(promotionResult.getOrder()).thenReturn(cart);
		Mockito.lenient().when(addCouponRAO.getCouponId()).thenReturn("testCouponId");
		Mockito.lenient().when(modelService.create(promotionAction)).thenReturn(new RuleBasedAddCouponActionModel());
	...
	{
		Mockito.lenient().when(addCouponRAO.getAppliedToObject()).thenReturn(new AbstractActionedRAO());
	...
	{
		Mockito.lenient().when(promotionActionService.createPromotionResult(addCouponRAO)).thenReturn(null);
