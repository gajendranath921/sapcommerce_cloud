...
public class DefaultCodeGenerationConfigurationWsFacadeTest
{
	...
	public void shouldProvideConvertedCodeGenerationConfigurations() throws Exception
	{
		...
		Mockito.lenient().when(codeGenerationConfigurationWsDTOConverter.convert(codeGenerationConfiguration)).thenReturn(codeConfigurationDTO);
		Mockito.lenient().when(codeGenerationConfigurationPaginatedGenericDao.find(anyObject())).thenReturn(searchPageData);
		//when
