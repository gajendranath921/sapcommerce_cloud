...
public class CouponCodeGenerationWebServicesTest extends ServicelayerTest
{
	...
	/**
	 * <p>test case for occ api of "/couponcodes​/{couponId}​/{mediaCode}"
	 * the api retrieves the generated coupon codes for a multi-code coupon given its media code.
	 * @param couponId
	 * @param mediaCode
	 * @return couponCodesResult status
	 */
	@Test
	 ...
	 *
	 * meanwhile
	 * the test also for occ api
	 * "/couponservices​/v2​/multicodecoupon​/get​/{couponId}"
	 * which retrieves a multi-code coupon for a given couponId
	 * @param couponId
	 */
	@Test
