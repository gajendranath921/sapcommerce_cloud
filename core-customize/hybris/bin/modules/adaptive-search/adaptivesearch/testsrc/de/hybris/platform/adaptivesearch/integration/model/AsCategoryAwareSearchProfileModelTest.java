...
public class AsCategoryAwareSearchProfileModelTest extends ServicelayerTransactionalTest
{
	...
	private static final String UID1 = "b413b620-a4b8-4b3c-9234-7fc88c6d3eb1";

	private static final String CODE1 = "searchProfile1";
	private static final String CODE2 = "searchProfile2";

	private static final String INDEX_TYPE1 = "testIndex1";
	private static final String INDEX_TYPE2 = "testIndex2";
	private static final String WRONG_INDEX_TYPE = "testIndexError";

	private static final String QUERY_CONTEXT_DEFAULT = "DEFAULT";
	private static final String WRONG_QUERY_CONTEXT = "UNKNOWN";

	private static final String CAT_10_CODE = "cat10";
	...
	{
		importCsv("/adaptivesearch/test/integration/model/asSearchProfileModelTest.impex", StandardCharsets.UTF_8.name());
	...
	public void createCategoryAwareSearchProfileWithQueryContext() throws Exception
	{
		...
		searchProfile.setCode(CODE1);
		searchProfile.setIndexType(INDEX_TYPE1);
		searchProfile.setQueryContext(QUERY_CONTEXT_DEFAULT);
		...
		assertEquals(onlineCatalogVersion, createdSearchProfile.getCatalogVersion());
		assertEquals(CODE1, createdSearchProfile.getCode());
		assertEquals(QUERY_CONTEXT_DEFAULT, createdSearchProfile.getQueryContext());
	}
	...
	public void failtTocreateCategoryAwareSearchProfileWithWrongQueryContext() throws Exception
	{
		...
		searchProfile.setCode(CODE1);
		searchProfile.setIndexType(INDEX_TYPE1);
		searchProfile.setQueryContext(WRONG_QUERY_CONTEXT);
