...
public class BoostItemRemovalTest extends ServicelayerTransactionalTest
{
	...
	public void calculateSearchProfile() throws Exception
	{
		...
		final AsSearchProfileContext searchProfileContext = DefaultAsSearchProfileContext.builder()
				.withIndexConfiguration(INDEX_CONFIGURATION).withIndexType(INDEX_TYPE).withCatalogVersions(List.of(catalogVersion))
				.withCategoryPath(List.of()).build();
