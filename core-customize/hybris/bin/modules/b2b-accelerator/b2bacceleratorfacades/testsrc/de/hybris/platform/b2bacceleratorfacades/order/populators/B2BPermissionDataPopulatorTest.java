...
public class B2BPermissionDataPopulatorTest
{
	...
	public void setUp() throws Exception
	{
		...
		BDDMockito.given(currencyConverter.convert(nullable(CurrencyModel.class))).willReturn(new CurrencyData());
		BDDMockito.given(b2bPermissionTypeConverter.convert(nullable(B2BPermissionTypeEnum.class))).willReturn(
