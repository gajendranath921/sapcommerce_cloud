...
public class DefaultAddOnCMSComponentRenderer<C extends AbstractCMSComponentModel> implements CMSComponentRenderer<C>
{
	...
	protected Map<String, Object> exposeVariables(final PageContext pageContext, final C component) 
	{
	...
	protected int getScopeForVariableName(final String variableName) 
	{
	...
	protected void unExposeVariables(final PageContext pageContext, final C component,
