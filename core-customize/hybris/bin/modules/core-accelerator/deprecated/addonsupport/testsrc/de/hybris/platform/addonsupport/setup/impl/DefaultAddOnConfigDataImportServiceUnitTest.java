...
public class DefaultAddOnConfigDataImportServiceUnitTest
{
	...
	private static final String SEARCHSERVICESTRIGGER_IMPEX_FILENAME = "/import/searchservices/template/searchservicestrigger.impex";
	private static final String SEARCHSERVICES_IMPEX_FILENAME = "/import/searchservices/template/searchservices.impex";
	...
	public void testExecuteImportForSearchServicesWithSearchServicesImpexFile()
	{
		...
		verify(setupImpexService).importImpexFile("/" + EXTENSION_NAME + SEARCHSERVICES_IMPEX_FILENAME, impexMacroParameterData, false, false);
		verify(setupImpexService).importImpexFile("/" + EXTENSION_NAME + SEARCHSERVICESTRIGGER_IMPEX_FILENAME, impexMacroParameterData, false, false);
