...
{
	private static final long serialVersionUID = 2305172061950251807L;
	private Long sequenceId;
	private File file;
	private LinkedList<File> transformedFiles = new LinkedList<>();
	...
	public void setTransformedFiles(final List<File> transformedFiles)
	{
		...
		if(transformedFiles != null)
		{
			this.transformedFiles.addAll(transformedFiles);
		}
	}
