...
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultExportDataHistoryService.class);
	...
	public void handleError(final Throwable payload)
	{
		...
		if (payload instanceof MessagingException)
		{
			...
			if(failedMessage == null) {
				LOG.info("failedMessage is null for MessagingException", handlingException);
				return;
			}
