...
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultSavedCartFileUploadStrategy.class);
			...
			throws CommerceCartModificationException
	{
		...
		final long qty = Long.parseLong(StringUtils.trim(cartAttributes[getQtyIndex().intValue() - 1]));
		final CommerceCartParameter commerceCartParameter = createCommerceCartParam(productCode, qty, cartModel);
