...
public final class SpringHelper
{
	...
	static void logDebugInfo(final Exception ex, final String message)
	{
	...
	static <T> Collection<T> getSpringBeans(final ServletRequest request, final Class<T> beanClass,
