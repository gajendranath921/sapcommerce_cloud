...
public class PageTitleResolverTest
{
	...
	public void setUp() throws Exception
	{
		...
		resolver.setProductAndCategoryHelper(productAndCategoryHelper);
	...
	public void testResolveProductPageTitle()
	{
		...
		BDDMockito.given(productAndCategoryHelper.getBaseProduct(product)).willReturn(product);
		...
		BDDMockito.given(productAndCategoryHelper.isValidProductCategory(categoryModel)).willReturn(true);
