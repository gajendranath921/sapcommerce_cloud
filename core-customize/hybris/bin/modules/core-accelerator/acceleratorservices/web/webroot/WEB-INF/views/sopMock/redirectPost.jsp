		...
		<div id="mockpage">
			...
			<div id="item_container_holder">
				<div class="item_container">
					<div id="debugWelcome">
						<h3>
							<img src="${fn:escapeXml(imgSpinnerPath)}" alt="image spinner"/>&nbsp;
				...
				<div class="item_container">
					<form:form id="silentOrderPostForm" name="silentOrderPostForm" action="${fn:escapeXml(postUrl)}" method="post">
