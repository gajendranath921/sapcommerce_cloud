...
import de.hybris.platform.acceleratorservices.web.payment.validation.HopMockUrlValidator;
...
public class HostedOrderPageMockController
{
	...
	@Resource(name = "hopMockUrlValidator")
			...
			final HttpServletRequest request, final Model model)
	{
		...
		if (params != null)
		{
			...
			if (getHopMockUrlValidator().validatePaymentResponseUrl(postUrl))
			{
	 ...
	 */
	public static class CountryComparator extends AbstractComparator<SelectOption> implements Serializable
	{
		private static final long serialVersionUID = -6449057735718400709L;
	...
	{
		return hopMockUrlValidator;
	}

	public void setHopMockUrlValidator(final HopMockUrlValidator hopMockUrlValidator)
	{
		this.hopMockUrlValidator = hopMockUrlValidator;
	}
}
