...
public class MediaContainerDataToAttributeAttributeContentConverterTest
{
	...
	private Map<String, Object> mediasSrc;
	...
	public void setup()
	{
		...
		mediasSrc = new HashMap<>();
		mediasSrc.put(MEDIA_FORMAT_2, MEDIA_CODE_2);
		mediasSrc.put(MEDIA_FORMAT_1, MEDIA_CODE_1);

		source = new HashMap<String, Object>();
		source.put(MediaContainerModel.MEDIAS, mediasSrc);
		...
		when(mediaContainerFacade.createMediaContainer(any())).thenReturn(new MediaContainerModel());
	...
	{
		mediasSrc.put(MEDIA_FORMAT_2, UNKNOWN_MEDIA_CODE);
