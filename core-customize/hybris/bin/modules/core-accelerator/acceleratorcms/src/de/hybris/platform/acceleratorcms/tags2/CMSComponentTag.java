...
public class CMSComponentTag extends TagSupport implements DynamicAttributes
{
	...
	protected HashMap<String, String> dynamicAttributes;

	// Services
	protected transient HtmlElementHelper htmlElementHelper;
	protected transient CMSPageContextService cmsPageContextService;
	protected transient CMSPageSlotComponentService cmsPageSlotComponentService;
	protected transient Collection<CMSDynamicAttributeService> cmsDynamicAttributeServices;

	// State
	protected CmsPageRequestContextData currentCmsPageRequestContextData;
	protected transient List<AbstractCMSComponentModel> currentCmsComponents;
