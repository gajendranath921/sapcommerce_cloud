	...
	public void createSyncSearchRestrictions()
	{
		getCmsSyncSearchRestrictionService()
				.createCmsSyncSearchRestriction("Sync_Only_Approved_Media_Container_Restriction", MediaContainerModel.class,
						// Get only media containers that are used by approved AbstractMediaContainerComponent and approved VideoComponent
						// (search restrictions for AbstractCMSComponent type is implicitly applied)
