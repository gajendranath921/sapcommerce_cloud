...
public class DefaultPaymentServiceImplTest
{
	...
	public void testCodeGeneration()
	{
		...
		Mockito.lenient().when(modelService.create(PaymentTransactionModel.class)).thenReturn(paymentTransactionModel);
		...
		Mockito.lenient().when(cardPaymentService.capture((CaptureRequest) Mockito.anyObject())).thenReturn(captureResult);

		Mockito.lenient().when(modelService.create(PaymentTransactionEntryModel.class)).thenReturn(new PaymentTransactionEntryModel());
		...
		Mockito.lenient().when(cardPaymentService.authorize((AuthorizationRequest) Mockito.anyObject())).thenReturn(result);
