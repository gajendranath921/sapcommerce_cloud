...
public class DefaultReturnActionRequestExecutorTest
{
	...
	public void setup()
	{
		...
		Mockito.lenient().when(returnEntryModel1.getPk()).thenReturn(PK.fromLong(1L));
		Mockito.lenient().when(returnEntryModel1.getReturnRequest()).thenReturn(returnRequest);
