...
public class GeocodingTest extends AbstractGeocodingTest
{
	...
	public void testGetMapFromManagerPOIs() throws Exception
	{
		...
		assertEquals(3, map.getRadius(), 0);
		...
		assertEquals("Two POIs expected on the map", 2, map.getPointsOfInterest().size());
	...
	public void testGetDistanceAndRoute1() throws Exception
	{
		...
		double double0 = 0;
		assertNotEquals("Road distance between two known test points should be determined", double0, result.getRoadDistance());
		assertNotEquals("'Eagle flies' distance between two known test points should be determined",
				double0, result.getEagleFliesDistance());
	}
	...
	public void testGetDistanceAndRoute2() throws Exception
	{
		...
		double double0 = 0;
		assertNotEquals("Road distance between two known test points should be determined", double0, result.getRoadDistance());
		assertNotEquals("'Eagle flies' distance between two known test points should be determined", double0,
				result.getEagleFliesDistance());
	}
