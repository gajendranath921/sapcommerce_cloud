...
public class GeocodingJobIT extends BaseCommerceBaseTest
{
	...
	protected void createTestPosEntries() throws Exception
	{
		...
		assertThat(posToGeocode).as("Initially, we expect all entries to be submitted for geocoding")
	...
	public void shouldPerformGeocodingInBatches() throws Exception
	{
		...
		assertThat(recentlyGeocodedPos).as("Geocoded entries amount must be equal to job's batch size")
