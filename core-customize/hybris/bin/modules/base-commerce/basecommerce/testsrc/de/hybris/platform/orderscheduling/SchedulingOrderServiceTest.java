...
public class SchedulingOrderServiceTest
{
	...
	{
		Mockito.lenient().when(cronJobService.getCronJob("cartToOrderJob")).thenReturn(new CronJobModel());

		Mockito.lenient().when(modelService.create(CartToOrderCronJobModel.class)).thenReturn(new CartToOrderCronJobModel());
	...
	{
		Mockito.lenient().when(cronJobService.getCronJob("orderTemplateToOrderJob")).thenReturn(new CronJobModel());

		Mockito.lenient().when(modelService.create(OrderTemplateToOrderCronJobModel.class))
	...
	{
		Mockito.lenient().when(cronJobService.getCronJob("orderScheduleJob")).thenReturn(new CronJobModel());
		Mockito.lenient().when(modelService.create(OrderScheduleCronJobModel.class)).thenReturn(new OrderScheduleCronJobModel());
