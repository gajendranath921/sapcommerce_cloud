...
public class ReturnsServiceTest extends ServicelayerTest
{
	...
	public void testReplacementOrderCreation()
	{
		...
		assertEquals("Wrong reason assigned", ReplacementReason.LATEDELIVERY, replacementEntry.getReason());
		assertEquals("Wrong reason assigned", ReturnAction.IMMEDIATE, replacementEntry.getAction());
	...
	public void testRefundEntryCreation()
	{
		...
		assertEquals("Wrong reason assigned", RefundReason.LATEDELIVERY, refundEntry.getReason());
		assertEquals("Wrong reason assigned", ReturnAction.IMMEDIATE, refundEntry.getAction());
