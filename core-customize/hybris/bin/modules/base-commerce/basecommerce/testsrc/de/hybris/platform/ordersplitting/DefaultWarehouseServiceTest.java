...
public class DefaultWarehouseServiceTest
{
	...
	public void testGetWarehouses()
	{
		...
		Mockito.lenient().when(warehouseDao.getWarehouses(product1.getCode())).thenReturn(Arrays.asList(warehouse1, warehouse2));
		Mockito.lenient().when(warehouseDao.getWarehouses(product2.getCode())).thenReturn(Arrays.asList(warehouse2));
	...
	public void testGetWarehousesDefault()
	{
		...
		Mockito.lenient().when(warehouseDao.getWarehouses(product1.getCode())).thenReturn(Arrays.asList(warehouse1));
		Mockito.lenient().when(warehouseDao.getWarehouses(product2.getCode())).thenReturn(Collections.EMPTY_LIST);
		Mockito.lenient().when(warehouseDao.getDefWarehouse()).thenReturn(Arrays.asList(warehouse1, warehouse2));
	...
	public void testGetWarehousesWithProductsInStock()
	{
		...
		Mockito.lenient().when(warehouseDao.getWarehousesWithProductsInStock(entry.getProduct().getCode(), entry.getQuantity().longValue(),
	...
	public void testGetWarehousesWithProductsInStockDefault()
	{
		...
		Mockito.lenient().when(warehouseDao.getWarehousesWithProductsInStock(product1.getCode(), entry.getQuantity().longValue(),
	...
	public void testGetWarehouseForId()
	{
		...
		Mockito.lenient().when(warehouseDao.getWarehouseForCode(code)).thenReturn(Arrays.asList(warehouse1));
	...
	public void testGetWarehouseForIdMoreThen1()
	{
		...
		Mockito.lenient().when(warehouseDao.getWarehouseForCode(code)).thenReturn(Arrays.asList(warehouse1, warehouse2));
