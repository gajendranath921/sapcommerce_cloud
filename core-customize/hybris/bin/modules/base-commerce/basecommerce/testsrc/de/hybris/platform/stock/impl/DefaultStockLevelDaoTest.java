...
public class DefaultStockLevelDaoTest
{
	...
	public void testShouldFilterOutDuplicateWarehouseInQuery()
	{
		...
		Mockito.lenient().when(searchResult.getResult()).thenReturn(new ArrayList<Object>());
		Mockito.lenient().when(mockService.search(nullable(FlexibleSearchQuery.class))).thenReturn(searchResult);
