...
public class PointOfServiceTest
{
	...
	{
		Mockito.lenient().when(pointOfServiceDao.getPosByName("notExistingPOS")).thenThrow(new PointOfServiceDaoException());
	...
	public void testGetPointOfServiceForName() throws PointOfServiceDaoException
	{
		...
		Mockito.lenient().when(pointOfServiceDao.getPosByName("existingPOS")).thenReturn(pointOfServiceModel);
