...
public class DefaultBaseStoreServiceTest
{
	...
	public void setUp() throws Exception
	{
		...
		baseStoreService.setBaseStoreSelectorStrategies(Collections.singletonList(baseStoreSelectorStrategy));
	}
	...
	public void shouldThrowAmbiguousIdentifierExceptionWhenHasBeenFoundMoreThanOneStoreForUid()
	{
		...
		catch (final AmbiguousIdentifierException e)
		{
			...
			assertThat(e.getMessage())
					.contains("Base store uid '" + BASE_STORE_UID + "' is not unique, " + stores.size() + " base stores found!");
		}
	}
