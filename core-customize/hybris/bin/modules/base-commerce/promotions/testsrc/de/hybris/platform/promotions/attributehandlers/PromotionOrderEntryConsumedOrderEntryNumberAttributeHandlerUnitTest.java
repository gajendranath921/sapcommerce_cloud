...
public class PromotionOrderEntryConsumedOrderEntryNumberAttributeHandlerUnitTest
{
	...
	public void setUp()
	{
		Mockito.lenient().when(orderEntry.getEntryNumber()).thenReturn(Integer.valueOf(1));
	}
	...
	{
		Mockito.lenient().when(promotionOrderEntryConsumed.getOrderEntry()).thenReturn(orderEntry);
	...
	{
		Mockito.lenient().when(promotionOrderEntryConsumed.getOrderEntry()).thenReturn(null);
		Mockito.lenient().when(promotionOrderEntryConsumed.getOrderEntryNumber()).thenReturn(Integer.valueOf(1));
